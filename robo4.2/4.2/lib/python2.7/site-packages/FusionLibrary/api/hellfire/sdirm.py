...
class StoreVirtualVsaCluster(object):
    ...
    def create(self, body, api=None, headers=None):
        ...
        uri = 'https://%s/rest/sdi-system-profiles' % (self.fusion_client._host)
    ...
    def delete(self, name=None, uri=None, api=None, headers=None):
        ...
        if uri:
            ...
            if response['count'] == 0:
                logger._log('Sdi-system-profiles %s does not exist' % (name), level='WARN')
                return
    ...
    def get(self, uri=None, api=None, headers=None, param=''):
        ...
        if uri:
            ...
            uri = 'https://%s/rest/sdi-system-profiles/%s' % (self.fusion_client._host, param)
