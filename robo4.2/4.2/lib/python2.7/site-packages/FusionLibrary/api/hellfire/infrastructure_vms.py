...
class InfrastructureVms(object):
    ...
    def create(self, body, api=None, headers=None):
        ...
        uri = 'https://%s/rest/infrastructure-vms' % (self.fusion_client._host)
    ...
    def delete(self, name=None, uri=None, api=None, headers=None):
        ...
        if uri:
            ...
            if response['count'] == 0:
                logger._log('Infrastructure vm %s does not exist' % (name), level='WARN')
                return
    ...
    def get(self, uri=None, api=None, headers=None, param=''):
        ...
        if uri:
            ...
            uri = 'https://%s/rest/infrastructure-vms/%s' % (self.fusion_client._host, param)
