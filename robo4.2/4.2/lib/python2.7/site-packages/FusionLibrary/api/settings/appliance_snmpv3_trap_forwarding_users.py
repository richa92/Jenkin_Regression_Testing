...
class ApplianceSnmpv3TrapForwardingUser(object):

    def __init__(self, fusion_client):
        self.fusion_client = fusion_client

    def create(self, body, api=None, headers=None):
        ''' Adds SNMPv3 USM user.
        '''
        if api:
            headers = self.fusion_client._set_req_api_version(api=api)
        elif not headers:
            headers = self.fusion_client._headers
        uri = 'https://%s/rest/appliance/snmpv3-trap-forwarding/users' % (self.fusion_client._host)
    ...
    def put(self, body=None, id=None, api=None, headers=None):
        if api:
            ...
            headers = self.fusion_client._headers
        uri = 'https://%s/rest/appliance/snmpv3-trap-forwarding/users/%s' % (self.fusion_client._host, id)
    ...
    def get(self, id=None, api=None, headers=None, param=''):
        ...
        if id:
            ...
            uri = 'https://%s/rest/appliance/snmpv3-trap-forwarding/users%s' % (self.fusion_client._host, param)
