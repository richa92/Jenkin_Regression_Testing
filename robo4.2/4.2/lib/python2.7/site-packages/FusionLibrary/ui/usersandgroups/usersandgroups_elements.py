...
class FusionUserandGroupsPage(object):
    ...
    ID_ELEMENT_ROLE = "xpath=//*[@id='fs-change-permissions-main-table']//td[contains(text(),'%s')]"
    ID_USER_EDIT_CANCEL = "xpath=//*[@id='fs-usersettings-edit-cancel']"
    ID_ELEMENT_USER_NAME = "xpath=//*[@id='hp-session-user' and text()='%s']"
    ID_ELEMENT_USER_ROLE_LABEL = "xpath=//*[@id='fs-change-permissions-main-table_wrapper']//th [contains(text(),'Role')]"
    ...
    ID_ELEMENT_USER_NAME_AD_ADDED = "xpath=//*[@id='hp-session-user' and text()='%s\\%s']"
