...
from RoboGalaxyLibrary.netconf.ncclient.capabilities import Capabilities

from RoboGalaxyLibrary.netconf.ncclient.transport.errors import TransportError
        ...
        for child in root.getchildren():
            if child.tag == qualify("session-id") or child.tag == "session-id":
                ...
                for cap in child.getchildren():
                    if cap.tag == qualify(
                            "capability") or cap.tag == "capability":
