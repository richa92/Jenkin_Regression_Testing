...
Create Scope
   ...
   Verify Resources for List  ${expected_scopes}
...
Add Active Directory Groups with Scope
    ...
    Run Keyword If  ${adgroup_withscope} is not ${null}     Add Active Directory Group And Assign Role  ${adgroup_withscope}    ${VERIFY}  ${expected_adgroup_withscope}