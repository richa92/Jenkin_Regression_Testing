...
Upgrade OneView
    ...
    Wait Until Keyword Succeeds    120m   ${interval}   Appliance Upgrade Status Should Be Successful
...
Active And StandBy EM Appliance Should Be Successfully Upgraded
     ...
     Wait Until Keyword Succeeds    40m    50s    Active And StandBy EMs Should Be Upgraded To  ${ov_build_version[0]}
