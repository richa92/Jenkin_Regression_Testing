*** Settings ***
Documentation                 CDP integration test for rack servers
...
*** Variables ***
${APPLIANCE_IP}     16.83.15.93

*** Test Cases ***
Test case1 Import server
    [Documentation]     This testcase imports a server
    [Tags]         Import
...
Import the server
    ...
    #\    ${resps}=    Add Server hardware from variable    ${Serverr}
    #\    Append To List    ${responses}    ${resps}
