...
rack_fusion_ip = ''  # OneView IP Address
rack_fusion_admin_credentials_username = ''  # Example 'Administrator'
rack_fusion_admin_credentials_password = ''
rack_fusion_ssh_credentials_username = ''  # example 'root'
rack_fusion_ssh_credentials_password = ''  # example 'hpvse1'
rack_server_genration = 'Gen10'  # Example1 "Gen9" #Example2 "Gen8"
rack_server_ip = ''  # Example "16.83.13.200"
rack_server_ilo_hostname = ''  # Example 'ILOCN7642000Y.lr.eml.lab'
rack_server_credentials_username = ''  # Example 'Administrator'
rack_server_credentials_password = ''  # Example 'password'
rack_firmware_iso_uploaded_into_OneView = ''  # Example 'SPPGen10Snap4_2018_1016_38.iso'
...
bl_api_version = '1000'
bl_fusion_ip = ''  # OneView IP Address
bl_fusion_admin_credentials_username = ''  # Example 'Administrator'
bl_fusion_admin_credentials_password = ''
bl_fusion_ssh_credentials_username = ''  # example 'root'
bl_fusion_ssh_credentials_password = ''  # example 'hpvse1'
bl_eg_name = ''  # Enclosure Group Name Example: 'EG1'
bl_server_genration = 'Gen10'  # Example1 "Gen9" #Example2 "Gen8"
bl_server_ip = ''  # Example "16.83.13.200"
bl_server_ilo_hostname = ''  # Example 'USE146KPNS, bay 13'
bl_server_credentials_username = ''  # Example 'Administrator'
bl_server_credentials_password = ''  # Example 'password'
bl_firmware_iso_uploaded_into_OneView = ''  # Example 'SPPGen10Snap4_2018_1016_38.iso'
...
syn_frame_ip = ''  # Synergy Frame IP
syn_fusion_ip = syn_frame_ip  # Usually the Frame IP and Fusion IP will be same, if changed please change it here
syn_fusion_admin_credentials_username = ''  # Example 'Administrator'
syn_fusion_admin_credentials_password = ''
syn_fusion_ssh_credentials_username = ''  # example 'root'
syn_fusion_ssh_credentials_password = ''  # example 'hpvse1'
syn_eg_name = ''  # Enclosure Group Name Exampel 'EG1'
syn_server_genration = 'Gen10'  # Example1 "Gen9" #Example2 "Gen8" # Example3 "Gen10"
syn_server_ip = ''  # Example "16.83.13.200"
syn_server_ilo_hostname = ''  # Example 'CN744502CH, bay 1'
syn_server_credentials_username = ''  # Example 'Administrator'
syn_server_credentials_password = ''  # Example 'password'
syn_firmware_iso_uploaded_into_OneView = ''  # Example 'SPPGen10Snap4_2018_1106_44.iso'
