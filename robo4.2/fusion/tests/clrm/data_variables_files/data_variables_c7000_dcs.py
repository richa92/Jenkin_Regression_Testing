...
cluster_30 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_30', 'path': 'DC1', 'vcenter': '172.18.13.11',
               'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'deployment_manager_type': 'ICSP',
               'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
               'server_hardware': ['Encl1, bay 8', 'Encl1, bay 11'],
...
cluster_113_v4 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v4', 'path': 'DC1', 'vcenter': '172.18.13.11',
                   'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'deployment_manager_type': 'ICSP',
                   'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
                   'server_hardware': ['Encl1, bay 16'],
                   'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Distributed', 'multi_nic_vmotion': 'true',
                                        'distributed_switch_usage': 'GeneralNetworks', 'distributed_switch_version': '5.1.0'}}]

cluster_113_v4_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v4', 'server_hardware': ['Encl1, bay 12']}]
...
Cluster_113_v1 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v1', 'path': 'DC1', 'vcenter': '172.18.13.11',
                   'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'server_hardware': ['Encl1, bay 3', 'Encl1, bay 4'],
                   'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help', 'deployment_manager_type': 'ICSP',
                   'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Distributed', 'multi_nic_vmotion': 'true',
                                        'distributed_switch_usage': 'GeneralNetworks', 'distributed_switch_version': '5.1.0'}}]

Cluster_113_v1_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v1', 'HostProfileUris': ['Encl1, bay 3']}]

Cluster_113_v2 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v2', 'path': 'DC1', 'vcenter': '172.18.13.11',
                   'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'deployment_manager_type': 'ICSP',
                   'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
                   'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'],
                   'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Distributed', 'multi_nic_vmotion': 'true',
                                        'distributed_switch_usage': 'AllNetworks', 'distributed_switch_version': '5.1.0'}}]

Cluster_113_v2_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v2', 'HostProfileUris': ['Encl1, bay 5']}]

Cluster_113_v3 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v3', 'path': 'DC1', 'vcenter': '172.18.13.11',
                   'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'deployment_manager_type': 'ICSP',
                   'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
                   'server_hardware': ['Encl1, bay 7', 'Encl1, bay 8'],
                   'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Standard', 'multi_nic_vmotion': 'true'}}]

Cluster_113_v3_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_113_v3', 'HostProfileUris': ['Encl1, bay 7']}]
...
Cluster_22 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_22', 'path': 'DC1', 'vcenter': '172.18.13.11',
               'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware', 'deployment_manager_type': 'ICSP',
               'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
               'hostConfigPolicy_settings': {'leaveHostInMaintenance': 'true'}, 'server_hardware': ['Encl1, bay 4'],
               'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Distributed', 'multi_nic_vmotion': 'true',
                                    'distributed_switch_usage': 'GeneralNetworks', 'distributed_switch_version': '5.1.0'}}]
...
cluster_31_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_31', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6']}]
...
Cluster_177_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_177', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'], 'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_178_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_178', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'], 'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_179_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_179', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'],
                       'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_180_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_180', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'],
                       'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_181_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_181', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'],
                       'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_182_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_182', 'server_hardware': ['Encl1, bay 5', 'Encl1, bay 6'],
                       'HostProfileUris': ['Encl1, bay 3']}]
...
cluster_183_update1 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_183', 'server_hardware': ['Encl1, bay 4']}]
...
Cluster_34 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_34', 'path': 'DC1', 'vcenter': '172.18.13.11',
               'hypervisor_type': 'Vmware', 'server_hardware': ['Encl1, bay 8'], 'deployment_manager_type': 'ICSP',
               'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Standard', 'multi_nic_vmotion': 'true'}}]
...
Cluster_37_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_37', 'profile_name': 'Non-existingProfile', 'server_hardware': ['Encl1, bay 11']}]
...
Cluster_38_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_38', 'server_hardware': ['Encl1, bay 11'], 'deployment_uri': '/rest/os-deployment-build-plans/80000123456'}]
...
Cluster_50 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_50', 'path': 'DC1', 'vcenter': '172.18.13.11',
               ...
               'deployment_uri': '/rest/os-deployment-build-plans/800001_11', 'server_password': 'iso*help', 'deployment_manager_type': 'ICSP'}]
...
cluster_103 = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_103', 'path': 'DC1', 'vcenter': '172.18.13.11',
                'profile_name': 'profile_template_gen8_1', 'hypervisor_type': 'Vmware',
                'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
                'server_hardware': ['Encl2, bay 8'], 'deployment_manager_type': 'ICSP',
                'virtualSwitchConfigPolicy': {'customVirtualSwitches': 'false', 'configurePortGroups': 'false', 'manageVirtualSwitches': 'true'},
                'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Standard', 'multi_nic_vmotion': 'true'},
...
vSwitch_08_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'vSwitch_08', 'server_hardware': ['Encl2, bay 7']}]
...
vSwitch_09_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'vSwitch_09', 'server_hardware': ['Encl2, bay 8']}]
...
dvSwitch_05_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'vSwitch_05', 'server_hardware': ['Encl2, bay 4']}]
...
dvSwitch_06_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'vSwitch_06', 'server_hardware': ['Encl2, bay 4']}]
...
vSwitch_02_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'vSwitch_02', 'server_hardware': ['Encl2, bay 5']}]
...
dvSwitch_02_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'dvSwitch_02', 'server_hardware': ['Encl2, bay 6']}]
...
dvSwitch_07_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'dvSwitch_07', 'server_hardware': ['Encl2, bay 11']}]
...
Cluster_49_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'Cluster_49', 'server_hardware': ['Encl1, bay 6']}]
...
iSCSI_Vol_2_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'iSCSI_Vol_2', 'server_hardware': ['Encl1, bay 4']}]
...
iSCSI_Vol_7_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'iSCSI_Vol_7', 'HostProfileUris': ['Encl1, bay 3']}]
...
iSCSI_Vol_8_update = [{'type': 'HypervisorClusterProfileV2', 'name': 'iSCSI_Vol_8', 'HostProfileUris': ['Encl1, bay 3', 'Encl1, bay 4']}]
...
iSCSI_Vol_21 = [{'type': 'HypervisorClusterProfileV2', 'name': 'iSCSI_Vol_21', 'path': 'DC1', 'vcenter': '172.18.13.11',
                 ...
                 'deployment_uri': '/rest/os-deployment-build-plans/800001', 'server_password': 'iso*help',
                 'server_hardware': ['Encl1, bay 3'], 'deployment_manager_type': 'ICSP',
                 'cluster_settings': {'cluster_settings_type': 'Vmware', 'virtual_switch_type': 'Distributed', 'multi_nic_vmotion': 'true',
                                      'distributed_switch_usage': 'GeneralNetworks', 'distributed_switch_version': '5.1.0'},
                 'shared_volume': [{'name': 'vsa1', 'volumeFileSystemType': 'VMFS'}]
                 }]
