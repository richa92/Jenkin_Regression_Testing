...
*** Test Cases ***
F607APIp005 update all servers by LE bigbang SharedInfrastructureAdnProfiles orchestrated

    Log to console and logfile    \n Starting update LE firmware
    Update LE Firmware       ${LE_fw_update_SharedProfile_orchestrated}  ${LE_NAME}
