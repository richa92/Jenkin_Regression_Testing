...
*** Test Cases ***
F607APIp006 update all servers by LE bigbang SharedInfrastructureAdnProfiles orchestrated force

    Log to console and logfile    \n Starting update LE firmware
    Update LE Firmware       ${LE_fw_update_SharedProfile_orchestrated_force}  ${LE_NAME}
