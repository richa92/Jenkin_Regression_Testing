...
*** Test Cases ***
IA can create SPT from SP and using SPP which is in selected scope to do firmware online update
    ...
    ${resp} =    Create Server Profile Template from Profile    ${server_profile}    ${SPT_name}    ${ia_user_scopes}
    Wait For Task2    ${resp}
