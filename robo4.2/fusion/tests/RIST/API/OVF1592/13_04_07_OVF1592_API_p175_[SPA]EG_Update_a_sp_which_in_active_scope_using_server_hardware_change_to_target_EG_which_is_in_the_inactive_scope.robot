...
*** Test Cases ***
[SPA] - Server Profiles Associated with EG_Update a server profile which in active scope using server hardware, change to target EG which is in the inactive scope
