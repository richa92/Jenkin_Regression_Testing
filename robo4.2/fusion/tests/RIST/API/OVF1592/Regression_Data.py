...
scope_resources = {"Test": ["SPOOL:FVT_Tbird_reg1_r1",
                   ...
                   "Production": ["SPOOL:FVT_Tbird_reg1_r1",
...
Patch_add_Scope0 = [{"op": "add",
                     "path": "/scopeUris/-",
                     "value": "Scope:%s" % Scope_List[0]}]
Patch_add_Scope1 = [{"op": "add",
                     "path": "/scopeUris/-",
                     "value": "Scope:%s" % Scope_List[1]}]
Patch_add_Scope2 = [{"op": "add",
                     "path": "/scopeUris/-",
                     "value": "Scope:%s" % Scope_List[2]}]
Patch_add_Scope3 = [{"op": "add",
                     "path": "/scopeUris/-",
                     "value": "Scope:%s" % Scope_List[3]}]
Patch_add_Scope5 = [{"op": "add",
                     "path": "/scopeUris/-",
                     "value": "Scope:%s" % Scope_List[5]}]

Patch_remove_Scope0 = [{"op": "remove",
                        "path": "/scopeUris/0"}]
Patch_remove_Scope1 = [{"op": "remove",
                        "path": "/scopeUris/1"}]

Patch_replace_Scope1 = [{"op": "replace",
                         "path": "/refreshState",
...
Update_Ethernet = {"name": eth_list[0],
                   "new_name": "eth6",
                   "type": ETHERNET_NETWORK_TYPE}
Update_Ethernet2 = {"name": "eth6",
                    "new_name": eth_list[0],
                    "type": ETHERNET_NETWORK_TYPE}
...
create_fcoe_network = [{"name": new_fcoe_name,
                        ...
                        "type": FCOE_NETWORK_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[1]]}]
create_fcoe_network2 = [{"name": "fcoe6",
                         "vlanId": "105",
                         "connectionTemplateUri": None,
                         "managedSanUri": None,
                         "type": FCOE_NETWORK_TYPE,
                         "initialScopeUris": ["Scope:%s" % Scope_List[2]]}]
create_fcoe_network3 = [{"name": "fcoe7",
                         "vlanId": "105",
                         "connectionTemplateUri": None,
                         "managedSanUri": None,
                         "type": FCOE_NETWORK_TYPE,
...
create_network_set = [{"name": new_NS_name,
                       "networkUris": [],
                       "type": NETWORK_SET_TYPE,
                       "initialScopeUris": ["Scope:%s" % Scope_List[1]],
                       "nativeNetworkUri": None}]  # create ns5 test
create_network_set2 = [{"name": new_NS_name2,
                        "networkUris": [],
                        "type": NETWORK_SET_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[2]],
                        "nativeNetworkUri": None}]   # create ns6 stage
create_network_set3 = [{"name": new_NS_name2,
                        "networkUris": [],
                        "type": NETWORK_SET_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[1], "Scope:%s" % Scope_List[2]],
                        "nativeNetworkUri": None}]   # create ns6 stage test
create_network_set4 = [{"name": new_NS_name,
                        "networkUris": [eth_list[1]],
                        "type": NETWORK_SET_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[1]],
                        "nativeNetworkUri": None}]   # create ns5 test eth2
create_network_set5 = [{"name": new_NS_name2,
                        "networkUris": [eth_list[1], eth_list[2]],
                        "type": NETWORK_SET_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[1]],
                        "nativeNetworkUri": None}]   # create ns6 test eth2 eth3
create_network_set6 = [{"name": new_NS_name2,
                        "networkUris": [eth_list[3]],
                        "type": NETWORK_SET_TYPE,
                        "initialScopeUris": ["Scope:%s" % Scope_List[1]],
                        "nativeNetworkUri": None}]   # create ns6 test eth4
update_network_set = [{"name": network_set_list[0],
                       "networkUris": [],
                       "add_networkUris": [eth_list[0]],
                       "connectionTemplateUri": "",
                       "type": NETWORK_SET_TYPE,
                       "nativeNetworkUri": None,
                       "uri": ''}]  # update ns1 add eth1
update_network_set2 = [{"name": network_set_list[1],
                        "networkUris": [],
                        "add_networkUris": [eth_list[1]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]  # update ns2 add eth2
update_network_set3 = [{"name": network_set_list[1],
                        "networkUris": [],
                        "add_networkUris": [eth_list[1]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": eth_list[1],
                        "uri": ''}]  # update ns2 add native eth2
update_network_set4 = [{"name": network_set_list[1],
                        "networkUris": [],
                        "delete_networkUris": [eth_list[1]],
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]    # update ns2 delete eth2
update_network_set5 = [{"name": network_set_list[0],
                        "networkUris": [],
                        "add_networkUris": [eth_list[3]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]  # update ns1 add eth4
update_network_set6 = [{"name": network_set_list[0],
                        "networkUris": [],
                        "add_networkUris": [eth_list[3]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": eth_list[3],
                        "uri": ''}]  # update ns1 add eth4 native
update_network_set7 = [{"name": network_set_list[0],
                        "networkUris": [],
                        "delete_networkUris": [eth_list[3]],
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]    # update ns1 delete eth4
update_network_set8 = [{"name": network_set_list[3],
                        "networkUris": [],
                        "add_networkUris": [eth_list[1]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]  # update ns4 add eth2
update_network_set9 = [{"name": network_set_list[1],
                        "networkUris": [],
                        "add_networkUris": [eth_list[2]],
                        "connectionTemplateUri": "",
                        "type": NETWORK_SET_TYPE,
                        "nativeNetworkUri": None,
                        "uri": ''}]  # update ns2 add eth3
update_network_set10 = [{"name": network_set_list[1],
                         "networkUris": [],
                         "add_networkUris": [eth_list[3]],
                         "connectionTemplateUri": "",
                         "type": NETWORK_SET_TYPE,
                         "nativeNetworkUri": None,
                         "uri": ''}]  # update ns2 add eth4
...
create_EG1 = {"name": new_EG_name,
              ...
              "initialScopeUris": ["Scope:%s" % Scope_List[0],
                                   "Scope:%s" % Scope_List[1]]}  # Test Production EG5
...
create_EG4 = {"name": new_EG_name,
              ...
              "powerMode": "RedundantPowerFeed",
              "ambientTemperatureMode": "Standard",
              "initialScopeUris": ["Scope:%s" % Scope_List[1]]}   # create EG5 with LIG2 Test

create_EG5 = {"name": new_EG_name2,
              "interconnectBayMappings": [{"interconnectBay": 3,
              ...
              "powerMode": "RedundantPowerFeed",
              "ambientTemperatureMode": "Standard",
              "initialScopeUris": ["Scope:%s" % Scope_List[1]]}   # create EG6 with LIG4 Test

create_EG6 = {"name": new_EG_name2,
              "interconnectBayMappings": [{"interconnectBay": 3,
              ...
              "powerMode": "RedundantPowerFeed",
              "ambientTemperatureMode": "Standard",
              "initialScopeUris": ["Scope:%s" % Scope_List[1]]}   # create EG6 with LIG3 Test

create_EG7 = {"name": new_EG_name2,
              "interconnectBayMappings": [],
              "ipAddressingMode": "DHCP",
              "ipRangeUris": [],
              "enclosureCount": 3,
              ...
              "powerMode": "RedundantPowerFeed",
              "ambientTemperatureMode": "Standard",
              "initialScopeUris": ["Scope:%s" % Scope_List[2]]}  # Test Production EG1

create_EG8 = {"name": new_EG_name2,
              "interconnectBayMappings": [],
              "ipAddressingMode": "DHCP",
              "ipRangeUris": [],
              "enclosureCount": 3,
              ...
              "powerMode": "RedundantPowerFeed",
              "ambientTemperatureMode": "Standard",
              "initialScopeUris": ["Scope:%s" % Scope_List[2]]}  # Test EG2

Edit_scope_EG = {"type": SCOPE_TYPE,
                 "name": Scope_List[0],
                 "category": "scopes",
                 "uri": "",
                 "addedResourceUris": [],
                 "removedResourceUris": []}  # add EG5 to scope of production

Edit_EG = {"type": ENCLOSURE_GROUP_TYPE,
           "uri": "",
           ...
           "enclosureType": "TClass"}     # Edit EG5

Edit_EG1 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": EG_list[0],
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # add lig4 to EG1

Edit_EG2 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": EG_list[3],
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # Edit EG4

Edit_EG3 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": EG_list[0],
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # remove lig4 from EG1

Edit_EG5 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": new_EG_name,
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # ADD lig2 to EG2

Edit_EG6 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": new_EG_name,
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # change EG2 to lig1

Edit_EG7 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": new_EG_name,
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # remove all lig from EG2

Edit_EG8 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": new_EG_name,
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # add lig3 to EG2

Edit_EG9 = {"type": ENCLOSURE_GROUP_TYPE,
            "uri": "",
            "category": "enclosure-groups",
            "name": new_EG_name,
            "stackingMode": "Enclosure",
            ...
            "enclosureCount": 3,
            "associatedLogicalInterconnectGroups": [],
            "enclosureType": "TClass"}   # add lig4 to EG5

create_EG_Network1 = {"name": new_EG_name,
                      "interconnectBayMappings": [
                          {
                              "interconnectBay": 3,
                              "logicalInterconnectGroupUri": "LIG:" + LIG[1],
                      ...
                      "osDeploymentSettings": {"manageOSDeployment": True,
                                               "deploymentModeSettings": {"deploymentMode": "External",
                                                                          "deploymentNetworkUri": eth_list[1]}},
                      "powerMode": "RedundantPowerFeed",
                      "ambientTemperatureMode": "Standard",
                      "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # add EG5 eth2

create_EG_Network2 = {"name": new_EG_name2,
                      "interconnectBayMappings": [
                          {
                              "interconnectBay": 3,
                              "logicalInterconnectGroupUri": "LIG:" + LIG[1],
                      ...
                      "powerMode": "RedundantPowerFeed",
                      "ambientTemperatureMode": "Standard",
                      "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # add EG6 eth3

create_EG_Network3 = {"name": new_EG_name2,
                      "interconnectBayMappings": [
                          {
                              "interconnectBay": 3,
                              "logicalInterconnectGroupUri": "LIG:" + LIG[1],
                      ...
                      "powerMode": "RedundantPowerFeed",
                      "ambientTemperatureMode": "Standard",
                      "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # add EG6 eth4

Edit_network_EG1 = {"type": ENCLOSURE_GROUP_TYPE,
                    "uri": "",
                    "category": "enclosure-groups",
                    "name": new_EG_name,
                    "stackingMode": "Enclosure",
                    ...
                    "enclosureCount": 3,
                    "associatedLogicalInterconnectGroups": [],
                    "enclosureType": "TClass"}   # add eth2 to EG2

Edit_network_EG2 = {"type": ENCLOSURE_GROUP_TYPE,
                    "uri": "",
                    "category": "enclosure-groups",
                    "name": new_EG_name,
                    "stackingMode": "Enclosure",
                    ...
                    "enclosureCount": 3,
                    "associatedLogicalInterconnectGroups": [],
                    "enclosureType": "TClass"}   # add eth3 to EG2

Edit_network_EG3 = {"type": ENCLOSURE_GROUP_TYPE,
                    "uri": "",
                    "category": "enclosure-groups",
                    "name": new_EG_name,
                    "stackingMode": "Enclosure",
                    ...
                    "enclosureCount": 3,
                    "associatedLogicalInterconnectGroups": [],
                    "enclosureType": "TClass"}   # add eth4 to EG2
...
create_LIG1 = {'name': new_LIG_name,
               ...
               'uplinkSets': [],
               "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # ADD LIG5 Test
create_LIG2 = {'name': new_LIG_name2,
               'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
               'enclosureType': 'SY12000',
               'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
                                           {'bay': 6, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1}],
               ...
               'redundancyType': 'Redundant',
               'uplinkSets': [],
               "initialScopeUris": ["Scope:%s" % Scope_List[2]]}  # ADD LIG6  Stage

create_LIG3 = {'name': new_LIG_name2,
               'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
               'enclosureType': 'SY12000',
               'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
                                           {'bay': 6, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1}],
...
create_LIG_network1 = {'name': new_LIG_name,
                       'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                       'enclosureType': 'SY12000',
                       'internalNetworkUris': [],
                       'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
                       ...
                       'interconnectBaySet': 3,
                       'redundancyType': 'Redundant',
                       'uplinkSets': [{"networkUris": [eth_list[1]],
                                       "mode": "Auto",
                                       "lacpTimer": "Short",
                                       "primaryPort": None,
                       ...
                       "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # ADD LIG6 ETH3

create_LIG_network2 = {'name': new_LIG_name2,
                       'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                       'enclosureType': 'SY12000',
                       'internalNetworkUris': [],
                       'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
                       ...
                       'interconnectBaySet': 3,
                       'redundancyType': 'Redundant',
                       'uplinkSets': [{"networkUris": [eth_list[2]],
                                       "mode": "Auto",
                                       "lacpTimer": "Short",
                                       "primaryPort": None,
                                       "logicalPortConfigInfos": [],
...
create_LIG_network3 = {'name': new_LIG_name2,
                       'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                       'enclosureType': 'SY12000',
                       'internalNetworkUris': [],
                       'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
                       ...
                       'interconnectBaySet': 3,
                       'redundancyType': 'Redundant',
                       'uplinkSets': [{"networkUris": [eth_list[3]],
                                       "mode": "Auto",
                                       "lacpTimer": "Short",
                                       "primaryPort": None,
                                       "logicalPortConfigInfos": [],
                                       ...
                                       "nativeNetworkUri": None,
                                       "name": LIG_network_name1}],
                       "initialScopeUris": ["Scope:%s" % Scope_List[1]]}  # ADD LIG6 ETH4

uplinks_data = [{'name': 'net_path1', 'networkType': 'Ethernet', 'ethernetNetworkType': 'Tagged', 'networkUris': [eth_list[1]], 'mode': 'Auto',
                 'logicalPortConfigInfos': [{'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]},
                {'name': 'net_path1', 'networkType': 'Ethernet', 'nativeNetworkUri': eth_list[1], 'ethernetNetworkType': 'Tagged', 'networkUris': [eth_list[1]], 'mode': 'Auto',
                 'logicalPortConfigInfos': [{'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]},
                {'name': 'net_path2', 'networkType': 'Ethernet', 'networkUris': [eth_list[2]], 'ethernetNetworkType': 'Tagged', 'mode': 'Auto',
                 'logicalPortConfigInfos': [{'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]},
                {'name': 'net_path3', 'networkType': 'Ethernet', 'networkUris': [eth_list[3]], 'ethernetNetworkType': 'Tagged', 'mode': 'Auto',
                 'logicalPortConfigInfos': [{'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]},
                {'name': 'net_path4', 'networkType': 'Ethernet', 'nativeNetworkUri': eth_list[3], 'ethernetNetworkType': 'Tagged', 'networkUris': [eth_list[3]], 'mode': 'Auto',
                 'logicalPortConfigInfos': [{'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]}]

update_lig1 = [{'name': new_LIG_name,
                'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                'enclosureType': 'SY12000',
                ...
                'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                     ...
                                     'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]  # Edit LIG5
update_lig2 = [{'name': LIG[3], 'type': LOGICAL_INTERCONNECT_GROUP_TYPE, 'enclosureType': 'SY12000',
                'ethernetSettings': None, 'description': None,
                'uplinkSets': [],
                'interconnectMapTemplate': [{'type': 'Virtual Connect SE 40Gb F8 Module for Synergy',
                                             'bay': 3, 'enclosure': 1, 'enclosureIndex': 1},
                ...
                'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                     ...
                                     'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                     'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                     'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]  # Edit LIG4
Edit_lig_network1 = [{'name': new_LIG_name,
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'ethernetSettings': None, 'description': None,
                      ...
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                           ...
                                           'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                           'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                           'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]   # add eth2 to LIG5
Edit_lig_network2 = [{'name': new_LIG_name,
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'ethernetSettings': None, 'description': None,
                      ...
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                           ...
                                           'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                           'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                           'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]   # add eth2 native to LIG5
Edit_lig_network3 = [{'name': new_LIG_name,
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'ethernetSettings': None, 'description': None,
                      'uplinkSets': [],
                      ...
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                           ...
                                           'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                           'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                           'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]   # delete eth2 from LIG5
Edit_lig_network4 = [{'name': new_LIG_name,
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'ethernetSettings': None, 'description': None,
                      ...
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                           ...
                                           'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                           'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                           'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]   # add eth3 to LIG5
Edit_lig_network5 = [{'name': new_LIG_name,
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'ethernetSettings': None, 'description': None,
                      ...
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration', 'configType': 'Passthrough',
                                           ...
                                           'inactiveFCoEQosConfig': None, 'inactiveNonFCoEQosConfig': None,
                                           'type': 'qos-aggregated-configuration', 'name': None, 'state': None, 'status': None,
                                           'eTag': None, 'modified': None, 'created': None, 'category': 'qos-aggregated-configuration', 'uri': None}}]   # add eth4 to LIG5
Edit_lig_network6 = [{'name': LIG[0],
                      'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                      'enclosureType': 'SY12000',
                      'enclosureIndexes': [1, 2, 3],
                      'ethernetSettings': None,
                      ...
                      'interconnectBaySet': 3,
                      'redundancyType': 'HighlyAvailable',
                      'qosConfiguration': {'activeQosConfig': {'type': 'QosConfiguration',
...
update_IC = {"associatedUplinkSetUri": None,
             ...
             "portName": "d1",
             "portStatus": "Unlinked",
             "type": "portV5"}  # Edit IC3

update_IC2 = {"associatedUplinkSetUri": None,
...
create_scope1 = {"name": new_scope_name,
                 "type": SCOPE_TYPE,
                 "addedResourceUris": [],
                 "removedResourceUris": [],
                 "initialScopeUris": ["Scope:%s" % Scope_List[1]]}
create_scope2 = {"name": new_scope_name2,
                 "type": SCOPE_TYPE,
                 "addedResourceUris": [],
                 "removedResourceUris": [],
                 "initialScopeUris": ["Scope:%s" % Scope_List[1]]}
create_scope3 = {"name": new_scope_name3,
                 "type": SCOPE_TYPE,
                 "addedResourceUris": [],
                 "removedResourceUris": [],
                 "initialScopeUris": ["Scope:%s" % Scope_List[2]]}
create_scope4 = {"name": new_scope_name3,
                 "type": SCOPE_TYPE,
                 "addedResourceUris": [],
                 "removedResourceUris": [],
                 "initialScopeUris": ["Scope:%s" % Scope_List[2], "Scope:%s" % Scope_List[1]]}
...
add_Uplinksets = {"type": UPLINK_SET_TYPE,
                  "name": uplink_name,
                  "networkUris": [],
                  "portConfigInfos": [],
                  "networkType": "Ethernet",
                  ...
                  "fcNetworkUris": [],
                  "fcoeNetworkUris": [],
                  "ethernetNetworkType": "Tagged"}    # add an empty uplink to LI

add_Uplinksets1 = {"type": UPLINK_SET_TYPE,
                   "name": uplink_name,
                   "networkUris": ["ETH:%s" % eth_list[1]],
                   "portConfigInfos": [{"desiredSpeed": "Auto",
                                        "location": {"locationEntries": [{"value": "Q1", "type": "Port"},
                                                                         {"value": 3, "type": "Bay"},
                   ...
                   "fcNetworkUris": [],
                   "fcoeNetworkUris": [],
                   "ethernetNetworkType": "Tagged"}    # add eth2 uplink to LI

add_Uplinksets2 = {"type": UPLINK_SET_TYPE,
                   "name": uplink_name,
                   "networkUris": ["ETH:%s" % eth_list[2]],
                   "portConfigInfos": [{"desiredSpeed": "Auto",
                                        "location": {"locationEntries": [{"value": "Q2", "type": "Port"},
                                                                         {"value": 3, "type": "Bay"},
                                                                         {"value": "Enclosure:%s" % enclosure[0],
                                                                          "type": "Enclosure"}]}}],
                   "networkType": "Ethernet",
                   ...
                   "fcNetworkUris": [],
                   "fcoeNetworkUris": [],
                   "ethernetNetworkType": "Tagged"}    # add eth3 uplink2 to LI

add_Uplinksets3 = {"type": UPLINK_SET_TYPE,
                   "name": uplink_name,
                   "networkUris": ["ETH:%s" % eth_list[3]],
                   "portConfigInfos": [{"desiredSpeed": "Auto",
                                        "location": {"locationEntries": [{"value": "Q3", "type": "Port"},
                                                                         {"value": 3, "type": "Bay"},
                                                                         {"value": "Enclosure:%s" % enclosure[0],
                                                                          "type": "Enclosure"}]}}],
                   "networkType": "Ethernet",
...
update_Uplinksets = {"type": UPLINK_SET_TYPE,
                     "name": uplink_name,
                     "networkUris": [],
                     "portConfigInfos": [],
                     "networkType": "Ethernet",
...
update_Uplinksets1 = {"type": UPLINK_SET_TYPE,
                      "name": uplink_name,
                      "networkUris": [eth_list[1]],
                      "portConfigInfos": [{'enclosure': enclosure[0],
                                           'bay': '3',
                                           'port': 'Q1',
                                           'desiredSpeed': 'Auto'}],
                      "networkType": "Ethernet",
...
update_Uplinksets2 = {"type": UPLINK_SET_TYPE,
                      "name": uplink_name,
...
update_Uplinksets3 = {"type": UPLINK_SET_TYPE,
                      "name": uplink_name,
                      "networkUris": [eth_list[3]],
                      "portConfigInfos": [{'enclosure': enclosure[0],
                                           'bay': '3',
                      ...
                      "fcNetworkUris": [],
                      "fcoeNetworkUris": [],
                      "ethernetNetworkType": "Tagged"}    # add eth4 uplink2 to LI

update_Uplinksets4 = {"type": UPLINK_SET_TYPE,
                      "name": uplink_name,
                      "networkUris": [eth_list[1]],
                      "portConfigInfos": [{'enclosure': enclosure[0],
                                           'bay': '3',
                      ...
                      "fcNetworkUris": [],
                      "fcoeNetworkUris": [],
                      "ethernetNetworkType": "Tagged"}    # edit eth2's "native" on LI

update_Uplinksets5 = {"type": UPLINK_SET_TYPE,
                      "name": uplink_name,
                      "networkUris": [eth_list[3]],
                      "portConfigInfos": [{'enclosure': enclosure[0],
                                           'bay': '3',
                      ...
                      "fcNetworkUris": [],
                      "fcoeNetworkUris": [],
                      "ethernetNetworkType": "Tagged"}    # edit eth4's "native" on LI
...
create_sp_neg_1 = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware5,
                   "enclosureGroupUri": "EG:%s" % EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_neg_2 = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware5,
                   "enclosureGroupUri": "EG:%s" % EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_server_profile_base = {"type": SERVER_PROFILE_TYPE,
                            "serverHardwareUri": None,
...
create_server_profile_EG1 = {"type": SERVER_PROFILE_TYPE,
                             "serverHardwareUri": None,
                             "serverHardwareTypeUri": serverHardwaretype,
...
create_server_profile_EG2 = {"type": SERVER_PROFILE_TYPE,
                             "serverHardwareUri": None,
                             "serverHardwareTypeUri": serverHardwaretype,
...
create_server_profile_EG3 = {"type": SERVER_PROFILE_TYPE,
                             "serverHardwareUri": serverHardware5,
...
create_server_profile_EG4 = {"type": SERVER_PROFILE_TYPE,
                             "serverHardwareTypeUri": serverHardwaretype,
                             "enclosureGroupUri": EG_list[4],
                             "serialNumberType": "Virtual",
                             "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_server_profile_EG1 = {"type": SERVER_PROFILE_TYPE,
                           "serverHardwareTypeUri": serverHardwaretype,
                           "enclosureGroupUri": EG_list[4],
                           "serialNumberType": "Virtual",
                           "iscsiInitiatorNameType": "AutoGenerated",
                           ...
                           "localStorage": {"sasLogicalJBODs": [],
                                            "controllers": []},
                           "sanStorage": None}    # Edit sp2 to EG-Synergy

Edit_server_profile_EG2 = {"type": SERVER_PROFILE_TYPE,
                           "serverHardwareUri": serverHardware2,
                           "enclosureGroupUri": EG_list[4],
                           "serialNumberType": "Virtual",
                           "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_server_profile_EG3 = {"type": SERVER_PROFILE_TYPE,
                           "serverHardwareTypeUri": serverHardwaretype,
                           "enclosureGroupUri": EG_list[4],
                           "serialNumberType": "Virtual",
                           "iscsiInitiatorNameType": "AutoGenerated",
...
create_server_profile_SH1 = {"type": SERVER_PROFILE_TYPE,
...
eth_uplink_sets = [{"name": "eth-path1",
...
create_sp_network1 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware5,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_network_base = {"type": SERVER_PROFILE_TYPE,
                        "serverHardwareUri": serverHardware2,
                        "enclosureGroupUri": EG_list[4],
                        "serialNumberType": "Virtual",
                        "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_fc1 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware5,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_fc2 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware5,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_fc3 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware5,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc_base = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware2,
                   "enclosureGroupUri": EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc1 = {"type": SERVER_PROFILE_TYPE,
               "serverHardwareUri": serverHardware2,
               "enclosureGroupUri": EG_list[4],
               "serialNumberType": "Virtual",
               "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc2 = {"type": SERVER_PROFILE_TYPE,
               "serverHardwareUri": serverHardware2,
               "enclosureGroupUri": EG_list[4],
               "serialNumberType": "Virtual",
               "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc3 = {"type": SERVER_PROFILE_TYPE,
               "serverHardwareUri": serverHardware3,
               "enclosureGroupUri": EG_list[4],
               "serialNumberType": "Virtual",
               "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc4 = {"type": SERVER_PROFILE_TYPE,
               "serverHardwareUri": serverHardware2,
               "enclosureGroupUri": EG_list[4],
               "serialNumberType": "Virtual",
               "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc_port1 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware2,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fc_port2 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware2,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
# 2. FCoE
fcoe_uplink_sets = [{"name": "fcoe-path1",
...
lig_fcoe_path = [{'name': 'LIG-Synergy',
                  'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
                  'enclosureType': 'SY12000',
                  'interconnectMapTemplate': icmap['LIG_POTASH'],
                  'enclosureIndexes': [1, 2, 3],
...
create_sp_fcoe1 = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware5,
                   "enclosureGroupUri": EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_fcoe2 = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware5,
                   "enclosureGroupUri": EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_fcoe3 = {"type": SERVER_PROFILE_TYPE,
                   "serverHardwareUri": serverHardware5,
                   "enclosureGroupUri": EG_list[4],
                   "serialNumberType": "Virtual",
                   "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe_base = {"type": SERVER_PROFILE_TYPE,
                     "serverHardwareUri": serverHardware2,
                     "enclosureGroupUri": EG_list[4],
                     "serialNumberType": "Virtual",
                     "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe1 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware2,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe2 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware2,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe3 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware3,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe4 = {"type": SERVER_PROFILE_TYPE,
                 "serverHardwareUri": serverHardware2,
                 "enclosureGroupUri": EG_list[4],
                 "serialNumberType": "Virtual",
                 "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe_port1 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware2,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_fcoe_port2 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware2,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
# 3.network-sets.
network_sets_for_sp = [{"name": network_set_list[0],
                        "networkUris": [],
                        "add_networkUris": [eth_list[0]],
                        "delete_networkUris": [eth_list[3]],
                        "connectionTemplateUri": "",
...
create_sp_netsets1 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware5,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_netsets2 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware5,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
create_sp_netsets3 = {"type": SERVER_PROFILE_TYPE,
                      "serverHardwareUri": serverHardware5,
                      "enclosureGroupUri": EG_list[4],
                      "serialNumberType": "Virtual",
                      "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets_base = {"type": SERVER_PROFILE_TYPE,
                        "serverHardwareUri": serverHardware2,
                        "enclosureGroupUri": EG_list[4],
                        "serialNumberType": "Virtual",
                        "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets1 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware2,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets2 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware2,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets3 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware3,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets4 = {"type": SERVER_PROFILE_TYPE,
                    "serverHardwareUri": serverHardware2,
                    "enclosureGroupUri": EG_list[4],
                    "serialNumberType": "Virtual",
                    "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets_port1 = {"type": SERVER_PROFILE_TYPE,
                         "serverHardwareUri": serverHardware2,
                         "enclosureGroupUri": EG_list[4],
                         "serialNumberType": "Virtual",
                         "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_sp_netsets_port2 = {"type": SERVER_PROFILE_TYPE,
                         "serverHardwareUri": serverHardware2,
                         "enclosureGroupUri": EG_list[4],
                         "serialNumberType": "Virtual",
                         "iscsiInitiatorNameType": "AutoGenerated",
...
create_server_profile_pool4 = {"type": SERVER_PROFILE_TYPE,
                               "serverHardwareUri": serverHardware5,
                               "enclosureGroupUri": EG_list[4],
                               "serialNumberType": "Virtual",
                               "iscsiInitiatorNameType": "AutoGenerated",
...
create_server_profile_pool5 = {"type": SERVER_PROFILE_TYPE,
                               "serverHardwareUri": serverHardware5,
                               "enclosureGroupUri": EG_list[4],
                               "serialNumberType": "Virtual",
                               "iscsiInitiatorNameType": "AutoGenerated",
...
create_server_profile_pool6 = {"type": SERVER_PROFILE_TYPE,
                               "serverHardwareUri": serverHardware5,
                               "enclosureGroupUri": EG_list[4],
                               "serialNumberType": "Virtual",
                               "iscsiInitiatorNameType": "AutoGenerated",
...
create_server_profile_de1 = {"type": SERVER_PROFILE_TYPE,
                             "serverHardwareUri": serverHardware5,
                             "enclosureGroupUri": EG_list[4],
                             "serialNumberType": "Virtual",
                             "iscsiInitiatorNameType": "AutoGenerated",
...
Edit_server_profile_de1 = {"type": SERVER_PROFILE_TYPE,
                           "serverHardwareUri": serverHardware2,
                           "enclosureGroupUri": EG_list[4],
                           "serialNumberType": "Virtual",
                           "iscsiInitiatorNameType": "AutoGenerated",
