...
*** Test Cases ***
Logical Interconnects support SBAC_Try to "update from group" for LI which in the active scope and LIG in inactive scope
  [Documentation]  OVF1592_API_p053 Logical Interconnects support SBAC_Try to "update from group" for LI which in the inactive scope
  ...
  Update Scope With Resources    scope_name=${Scope_List[2]}    resources_list=${resources_list}    add_flag=${TRUE}
  ...
  log    Successfully! Test Case : OVF1592_API_p053 Logical Interconnects support SBAC_Try to "update from group" for LI which in the inactive scope    console=true
