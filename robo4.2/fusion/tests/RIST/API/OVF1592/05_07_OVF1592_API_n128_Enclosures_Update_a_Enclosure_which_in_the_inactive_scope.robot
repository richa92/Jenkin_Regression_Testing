...
*** Test Cases ***
Enclosures supports SBAC_Update a Enclosure scope which in the inactive scope
  [Documentation]  Enclosures supports SBAC_Update a Enclosure which in the inactive scope
  Log    \nEnclosures supports SBAC_Update a Enclosure which in the inactive scope    console=true
