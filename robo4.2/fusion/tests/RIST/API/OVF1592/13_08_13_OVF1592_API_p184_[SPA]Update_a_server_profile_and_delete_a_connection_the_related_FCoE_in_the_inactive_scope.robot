...
Suite Teardown        Revert SP Environment After Test    ${Edit_sp_fcoe_base}
...
*** Test Cases ***
[SPA] - Server Profiles Associated with FCOE Update a server profile and delete a connection, the related FCOE in the inactive scope
