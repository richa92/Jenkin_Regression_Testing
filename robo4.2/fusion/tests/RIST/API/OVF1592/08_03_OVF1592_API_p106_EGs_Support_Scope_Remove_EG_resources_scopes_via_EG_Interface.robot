...
*** Test Cases ***
Enclosure Groups Support Scope Remove EG resources scopes via EG Interface
    [Documentation]  OVF1592 API p106 Enclosure Groups Support Scope Remove EG resources scopes via EG Interface
    Log    Set the patch body based on the location of scope1    console=True
    ${scopes}=    Get Assigned Scope URIs By Resource Name    EG:${new_EG_name}
    ...
    ${resp}=  Patch Resources Scopes   EG:${new_EG_name}  ${body}
