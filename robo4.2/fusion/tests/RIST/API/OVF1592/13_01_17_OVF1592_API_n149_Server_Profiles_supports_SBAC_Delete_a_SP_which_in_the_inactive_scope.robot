...
*** Test Cases ***
Server Profiles supports SBAC Delete a SP which in the inactive scope
    [Documentation]  OVF1592 API n149 Server Profiles supports SBAC Delete a SP which in the inactive scope
