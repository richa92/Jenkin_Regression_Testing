...
*** Test Cases ***
[SPO] - Server Profiles Associated with Ethernet Update a server profile and edit the existing connection using ethernet, select a new ethernet which is in same scope with SP
