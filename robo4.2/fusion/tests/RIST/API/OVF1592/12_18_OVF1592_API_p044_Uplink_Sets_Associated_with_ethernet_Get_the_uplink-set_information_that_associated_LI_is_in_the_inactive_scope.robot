...
*** Test Cases ***
Uplink Sets Associated with ethernet_Get the uplink-set information that associated LI is in the inactive scope
    Log    \Get the uplinkset information from LI    console=True
    ${uri}=    Get Uplinkset URI    ${update_Uplinksets1["name"]}
