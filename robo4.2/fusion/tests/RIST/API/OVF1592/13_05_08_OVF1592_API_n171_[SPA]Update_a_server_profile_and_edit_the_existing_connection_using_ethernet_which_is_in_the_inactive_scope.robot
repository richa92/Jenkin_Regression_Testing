...
*** Test Cases ***
[SPA] - Server Profiles Associated with Ethernet Update a server profile and edit the existing connection using ethernet, select a new ethernet which is in the inactive scope
