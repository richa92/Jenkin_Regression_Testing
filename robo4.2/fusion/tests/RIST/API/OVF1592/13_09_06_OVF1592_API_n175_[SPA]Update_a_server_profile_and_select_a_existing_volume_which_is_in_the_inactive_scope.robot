...
*** Test Cases ***
[SPA] - Update a server profile and select a existing volume which is in the inactive scope
    [Documentation]  OVF1592 API n175 [Server Profile Administrator] Update a server profile and select a existing volume which is in the inactive scope
