...
*** Test Cases ***
[SPO] - Server Profiles Associated with network-Sets Update a server profile and add a new connection using an network-Sets, the network-Sets is in same scope with SP
