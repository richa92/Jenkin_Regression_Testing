...
*** Test Cases ***
[SPO] - Server Profiles Associated with FCOE Update a server profile and edit the existing connection using FCOE, select a new FCOE which is in the inactive scope
