*** Settings ***
Documentation        Server Profiles supports SBAC Update a SP scope which is the active scope to delete an active scope
...
*** Test Cases ***
Server Profiles supports SBAC Update a SP scope which is the active scope to delete an active scope
    [Documentation]  OVF1592 API n145 Server Profiles supports SBAC Update a SP scope which is the active scope to delete an active scope
    ...
    Log   Remove SP2 scope: Test     console=True
