...
[Server Profile Administrator] Server Hardware support SBAC_Update an Server which is the active scope to delete a scope resource
  [Documentation]  OVF1592_API_n138-4 [Server Profile Administrator] Server Hardware support SBAC_Update an Server which is the active scope to delete a scope resource
  ...
  ${resp} =    Patch Resources Scopes  SH:${sh_name}   ${Patch_remove_Scope0}
