...
*** Test Cases ***
[SPA] - Server Profiles Associated with FCOE Update a server profile and delete a connection, the related FCOE in the active scope
    ...
    Log     Edit server profiles sp2 remove fcoe1     console=True
