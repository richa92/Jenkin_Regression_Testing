...
*** Test Cases ***
Uplink Sets Associated with ethernet_Update a uplink-set for LI which in the active scope with add an ethernet which in another active scope
    Log    \nEdit the uplinkset to add another active network eth3    console=True
    ${resp}=    Edit uplinkset    ${update_Uplinksets2["name"]}    ${update_Uplinksets2}    ${LI1}
