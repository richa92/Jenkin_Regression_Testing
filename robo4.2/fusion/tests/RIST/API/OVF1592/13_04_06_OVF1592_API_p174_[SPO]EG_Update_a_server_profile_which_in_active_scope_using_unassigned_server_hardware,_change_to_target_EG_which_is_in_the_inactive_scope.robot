...
*** Test Cases ***
[SPO] - Server Profiles Associated with EG_Update a server profile which in active scope using unassigned server hardware, change to target EG which is in the inactive scope
