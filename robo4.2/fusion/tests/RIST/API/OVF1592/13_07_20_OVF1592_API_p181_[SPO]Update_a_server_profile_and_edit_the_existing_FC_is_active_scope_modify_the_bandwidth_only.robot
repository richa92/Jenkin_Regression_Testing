...
*** Test Cases ***
[SPO] - Server Profiles Associated with FC Update a server profile and edit the existing connection which related FC is in the active scope, modify the bandwidth only
