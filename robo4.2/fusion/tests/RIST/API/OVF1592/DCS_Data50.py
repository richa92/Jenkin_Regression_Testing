"""
OVF1592 SBAC changes for DCS VM
"""
...
enclosure = ['0000A66101', '0000A66102', '0000A66103']
...
icmap = {
    ...
    'LIG_SAS': [
        {
            'bay': 1, 'enclosure': 1,
            'type': 'Synergy 12Gb SAS Connection Module', 'enclosureIndex': 1
        },
        {
            'bay': 4, 'enclosure': 1,
            'type': 'Synergy 12Gb SAS Connection Module', 'enclosureIndex': 1
...
EG_BASE = [
    {
        ...
        'interconnectBayMappings':
            [
                {
                    "interconnectBay": 3,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[0]["name"]
                },
                {
                    "interconnectBay": 6,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[0]["name"]
    ...
    },
    {
        ...
        'interconnectBayMappings':
            [
                {
                    "interconnectBay": 3,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[1]["name"]
                },
                {
                    "interconnectBay": 6,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[1]["name"]
    ...
    },
    {
        ...
        'interconnectBayMappings':
            [
                {
                    "interconnectBay": 3,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[2]["name"]
                },
                {
                    "interconnectBay": 6,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[2]["name"]
    ...
    },
    {
        ...
        'interconnectBayMappings':
            [
                {
                    "interconnectBay": 3,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[3]["name"]
                },
                {
                    "interconnectBay": 6,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[3]["name"]
    ...
    },
    {
        ...
        'interconnectBayMappings':
            [
                {
                    "interconnectBay": 3,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[4]["name"]
                },
                {
                    "interconnectBay": 6,
                    "logicalInterconnectGroupUri": "LIG:" + LIG_BASE[4]["name"]
                },
                {
                    ...
                    "logicalInterconnectGroupUri": "SASLIG:" + SAS_LIG[0][
                        "name"]
                },
                {
...
StoragePools = [
    {
        'storageSystemUri': 'wpst3par-7200-7-srv', "name": "FVT_Tbird_reg1_r1",
        "isManaged": True,
    },
    {
        'storageSystemUri': 'wpst3par-7200-7-srv', "name": "FVT_Tbird_reg1_r5",
        "isManaged": True,
    },
    {
        'storageSystemUri': 'wpst3par-7200-7-srv', "name": "FVT_Tbird_reg1_r6",
        "isManaged": True,
    },
    {
        'storageSystemUri': 'fvt3par-8400-1-srv', "name": "FC_r1",
        "isManaged": True,
    },
    {
        'storageSystemUri': 'fvt3par-8400-1-srv', "name": "FC_r5",
        "isManaged": True,
    },
]
...
scope_resources = {
    "Test": [
        ...
        "IC:0000A66102, interconnect 1",
        "IC:0000A66101, interconnect 3",
        "SH:0000A66101, bay 5",
        "SH:0000A66101, bay 7",
        "DE:0000A66101, bay 1",
    ],
    "Production": [
        ...
        "IC:0000A66102, interconnect 1",
        "IC:0000A66102, interconnect 4",
        "SH:0000A66101, bay 7",
        "SH:0000A66102, bay 5",
    ],
    "Stage": [
        "SPOOL:FC_r1",
        "IC:0000A66102, interconnect 6",
        "SH:0000A66102, bay 1",
    ]
}
...
# Enclosure SBAC DTO
new_enc_name = '0000A66101'
enc_name_list = [new_enc_name, '0000A66102', '0000A66103']
...
uplinks_data = [
    {
        'name': 'net_path1', 'networkType': 'Ethernet',
        'ethernetNetworkType': 'Tagged',
    ...
    },
    {
        'name': 'net_path1', 'networkType': 'Ethernet',
        'nativeNetworkUri': eth_list[1],
        'ethernetNetworkType': 'Tagged', 'networkUris': [eth_list[1]],
        'mode': 'Auto',
        'logicalPortConfigInfos': [
            {'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]
    },
    {
        'name': 'net_path2', 'networkType': 'Ethernet',
        'networkUris': [eth_list[2]],
    ...
    {
        'name': 'net_path3', 'networkType': 'Ethernet',
        'networkUris': [eth_list[3]],
        'ethernetNetworkType': 'Tagged', 'mode': 'Auto',
        'logicalPortConfigInfos': [
            {'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]
    ...
    {
        'name': 'net_path4', 'networkType': 'Ethernet',
        'nativeNetworkUri': eth_list[3],
        'ethernetNetworkType': 'Tagged', 'networkUris': [eth_list[3]],
        'mode': 'Auto',
        'logicalPortConfigInfos': [
            {'enclosure': '1', 'bay': '3', 'port': 'Q1.1', 'speed': 'Auto'}]
    }
...
update_lig1 = [
    {
        ...
        'internalNetworkUris': [], 'interconnectBaySet': 3,
        'redundancyType': 'Redundant',
        'enclosureIndexes': [1],
        'qosConfiguration': {
            'activeQosConfig': {
                ...
                'qosTrafficClassifiers': None, 'description': None,
                'status': None,
            ...
            'type': 'qos-aggregated-configuration', 'name': None, 'state': None,
            'status': None,
...
update_lig2 = [
    {
        'name': LIG[3], 'type': LOGICAL_INTERCONNECT_GROUP_TYPE,
        'enclosureType': 'SY12000',
        'ethernetSettings': None, 'description': None,
        'uplinkSets': [],
        'interconnectMapTemplate': [
...
# Interconnects DTO
Patch_inter_power = [
    {"op": "replace", "path": "/powerState", "value": "Off"}]  # power off
Patch_inter_reset = [
    {"op": "replace", "path": "/deviceResetState", "value": "Reset"}]  # reset
...
pool_list = ["FVT_Tbird_reg1_r1", "FVT_Tbird_reg1_r5", "FVT_Tbird_reg1_r6",
             "FC_r1"]
new_vol_name = "VOL5"
# new_vol_name2 = "VOL6"
