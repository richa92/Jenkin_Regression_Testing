...
*** Test Cases ***
Enclosure Groups supports SBAC_Create new EG which cross the scope between active and inactive
  [Documentation]  OVF1592 API n102 Enclosure Groups supports SBAC_Create new EG which cross the scope between active and inactive

  Log   Create new Enclosure Groups EG6 with inactive scope    console=True
  ${resp}=  Add Enclosure Group From Variable  ${create_EG3}
