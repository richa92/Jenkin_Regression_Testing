...
*** Test Cases ***
[SPO] - Server Profiles Associated with network-Sets Update a server profile and edit the existing connection using network-Sets, select a new network-Sets which is in different scope with SP
