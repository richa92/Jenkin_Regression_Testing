...
*** Test Cases ***
[SPA] - Server Profiles Associated with FC Update a server profile and edit the existing connection using FC, select a new FC which is in different scope with SP
