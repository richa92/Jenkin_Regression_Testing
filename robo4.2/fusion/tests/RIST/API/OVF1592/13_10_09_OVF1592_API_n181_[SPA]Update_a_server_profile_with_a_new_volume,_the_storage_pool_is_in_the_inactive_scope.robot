...
*** Test Cases ***
[SPA] - Update a server profile with a new volume, the storage pool is in the inactive scope
    [Documentation]  OVF1592_UI_n181 [Server Profile Administrator] Update a server profile with a new volume, the storage pool is in the inactive scope
