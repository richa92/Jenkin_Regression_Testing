...
*** Test Cases ***
[SPA] - Update a server profile with a new volume, the storage pool is in the different active scope with SP
    [Documentation]  OVF1592_UI_n180 [Server Profile Administrator] Update a server profile with a new volume, the storage pool is in the different active scope with SP
