...
licenses = {
    ...
    'license': [
        {
            'key': 'AA9C DQAA H9PA GHX3 U7B5 HWW5 Y9JL KMPL SR6C MHJU DXAU 2CSM GHTG L762 9AVY WXJY KJVT D5KM '
                   'EFVW DT5J TFQ9 74C8 SPS9 YG66 Z99R MWSN 6Z84 46XT WZJT HH4Q L975 SNJT ZWWC AADW NJ79 CEJC '
...
DL_gen10_profile_templates = [
    {
        ...
        "firmware": {
            "manageFirmware": False, "firmwareBaselineUri": "", "forceInstallFirmware": False,
            "firmwareInstallType": None, "firmwareActivationType": "Immediate"
        },
        "bios": {
            "manageBios": True, "overriddenSettings": [{"id": "CustomPostMessage", "value": "DL380 Gen10 1 - SPT"}]
        },
