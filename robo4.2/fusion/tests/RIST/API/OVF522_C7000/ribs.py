...
# Enclosures
ENC1 = "ribs"
ENC1_OA1 = "16.125.72.172"

# Uplink Sets
LIG01_UPS01 = "ups01_eth"
LIG01_UPS02 = "ups02_fcoe"
LIG01_UPS03 = "ups03_FC"
LIG02_UPS01 = "ups01_eth"
LIG02_UPS02 = "ups02_fcoe"
LIG02_UPS03 = "ups03_FC"
...
# Server Hardware Types and Ports
SHT01 = "BL460c Gen9:Flb1:HP FlexFabric 10Gb 2-port 536FLB Adapter:" \
        "2:QLogic QMH2572 8Gb FC HBA for HP BladeSystem c-Class"
SHT01_HBA_PORT01 = "Mezz 2:1"
SHT01_HBA_PORT02 = "Mezz 2:2"
SHT01_FLB_PORT01 = "Flb 1:1"
SHT01_FLB_PORT01A = "Flb 1:1-a"
SHT01_FLB_PORT01B = "Flb 1:1-b"
SHT01_FLB_PORT02 = "Flb 1:2"

# Server Hardware
BOOTSERVER = "%s, bay 3" % ENC1

# 3par Storage
STORESERV01_NAME = "pmsan3par2-srv"
STORESERV01_HOSTNAME = "pmsan3par2-srv.vse.rdlabs.hpecorp.net"
STORESERV01_STORAGE_POOL = "FC_r1"
STORESERV01_USER = "3paradm"
STORESERV01_PWD = "3pardata"

# Volumes
SHARED_VOLUME = "ovf522_shared_volume"
PRIVATE_VOLUME = "ovf522_private_volume"
...
lig01_uplink_sets = {
    LIG01_UPS01: {
        ...
        "logicalPortConfigInfos": [
            {"enclosure": "1", "bay": "1", "port": "X5", "speed": "Auto"},
        ]
    },
    LIG01_UPS02: {
        "name": LIG01_UPS02,
        ...
        "networkUris": [NWFCOE01],
        "mode": "Auto",
        "nativeNetworkUri": None,
        "logicalPortConfigInfos": [
            {"enclosure": "1", "bay": "2", "port": "X1", "speed": "Auto"},
        ]
    },
    LIG01_UPS03: {
        "name": LIG01_UPS03,
        ...
        "networkUris": [NWUMFCFA01],
        "mode": "Auto",
        "nativeNetworkUri": None,
        "logicalPortConfigInfos": [
            {"enclosure": "1", "bay": "3", "port": "1", "speed": "Auto"},
        ]
    },
}
...
lig02_uplink_sets = {
    ...
    LIG02_UPS03: {
        ...
        "networkType": "FibreChannel",
        "ethernetNetworkType": "NotApplicable",
        "networkUris": [NWUMFCFA02],
        "mode": "Auto",
        "nativeNetworkUri": None,
        "logicalPortConfigInfos": [
            {"enclosure": "1", "bay": "5", "port": "1", "speed": "Auto"},
        ]
    },
}
...
egs = {
    EG01: {
        ...
        "interconnectBayMappings": [
            {"interconnectBay": 1, "logicalInterconnectGroupUri": "LIG:" + LIG01},
            {"interconnectBay": 2, "logicalInterconnectGroupUri": "LIG:" + LIG01},
            {"interconnectBay": 3, "logicalInterconnectGroupUri": "LIG:" + LIG01},
        ],
    ...
    EG02: {
        ...
        "enclosureCount": 1,
        "interconnectBayMappings": [
            {"interconnectBay": 1, "logicalInterconnectGroupUri": "LIG:" + LIG02},
            {"interconnectBay": 2, "logicalInterconnectGroupUri": "LIG:" + LIG02},
            {"interconnectBay": 5, "logicalInterconnectGroupUri": "LIG:" + LIG02},
        ],
        "configurationScript": None,
        "ipAddressingMode": "External",
        "ipRangeUris": [],
...
storage_systems = [
    {
        ...
        "ports": [
            {"name": "0:1:1",
             "expectedNetworkUri": "FC:" + NWUMFCFA01,
             "expectedNetworkName": NWUMFCFA01,
             "mode": "Managed",
             "protocolType": "FC"
             },
            {"name": "0:1:2",
            ...
            {"name": "0:2:1",
             "expectedNetworkUri": "FC:" + NWUMFCFA02,
             "expectedNetworkName": NWUMFCFA02,
             "mode": "Managed",
             "protocolType": "FC"
             },
            {"name": "0:2:2",
            ...
            {"name": "0:2:3",
             "expectedNetworkUri": "FCOE:" + NWFCOE01,
             "expectedNetworkName": NWFCOE01,
             "mode": "Managed",
             "protocolType": "FC"
             },
            {"name": "0:2:4",
            ...
            {"name": "1:1:1",
             "expectedNetworkUri": "FCOE:" + NWFCOE02,
             "expectedNetworkName": NWFCOE02,
             "mode": "Managed",
             "protocolType": "FC"
             },
            {"name": "1:1:2",
...
enclosures = [
    {'hostname': ENC1_OA1, 'username': oa_credentials['username'], 'password': oa_credentials['password'],
     'enclosureGroupUri': 'EG:' + EG01, 'force': True, 'licensingIntent': 'OneView', "firmwareBaselineUri": None, },
]
...
nonvc_invalid_portid_empty = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_portid_empty",
...
nonvc_invalid_portid_none = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_portid_none",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_invalid_portid_auto = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_portid_auto",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_invalid_portid_mapped = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_portid_mapped",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
...
# Invalid profile - non-VC connection with a fibre channel network that is direct attach
nonvc_invalid_fc_network = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_fc_network",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_invalid_port_type = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_port_type",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_invalid_boot_not_null = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_boot_not_null",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_invalid_requestedmbps_not_null = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_invalid_requestedmbps_not_null",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_valid_profile = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_valid_profile",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
nonvc_valid_profile_with_volume_attachments = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_valid_profile_with_volume_attachments",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
    ...
    "sanStorage": {
        ...
        "volumeAttachments": [
            {"id": 1, "isBootVolume": False, "lunType": "Auto",
             ...
             "storagePaths": [
                 {"connectionId": 1, "targets": [], "targetSelector": "Auto", "isEnabled": True}
             ]
             }
        ]
    }
...
nonvc_valid_assigned_profile_with_volume_attachments = {
    "type": SP_TYPE,
    "name": "ovf522-nonvc_valid_assigned_profile_with_volume_attachments",
    "iscsiInitiatorNameType": "AutoGenerated",
...
template_nonvc_invalid_portid_empty = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_portid_empty",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_invalid_portid_auto = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_portid_auto",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_invalid_portid_mapped = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_portid_mapped",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG02,
    "affinity": "Bay",
...
# Invalid template - non-VC connection with a fibre channel network that is direct attach
template_nonvc_invalid_fc_network = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_fc_network",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_invalid_port_type = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_port_type",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_invalid_boot_not_null = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_boot_not_null",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_invalid_requestedmbps_not_null = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_invalid_requestedmbps_not_null",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_valid_profile = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_valid_profile",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
template_nonvc_valid_profile_with_volume_attachments = {
    "type": SPT_TYPE,
    "name": "ovf522-template_nonvc_valid_profile_with_volume_attachments",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
        ...
        "volumeAttachments": [
            {"id": 1, "isBootVolume": False, "lunType": "Auto",
                ...
                "volume": {
                    ...
                    "properties": {
                                "name": "volume-ovf522-template_nonvc_valid_profile_with_volume_attachments",
...
template_for_profile_creation = {
    "type": SPT_TYPE,
    "name": "ovf522-template_for_profile_creation",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
        ...
        "volumeAttachments": [
            {"id": 1, "isBootVolume": False, "lunType": "Auto",
                ...
                "volume": {
                    ...
                    "templateUri": "ROOT:" + STORESERV01_STORAGE_POOL,
                    "properties": {
                                "name": "volume-ovf522-template_for_profile_creation",
                                "storagePool": "SP:" + STORESERV01_STORAGE_POOL,
                                "size": ONEGB,
                                "provisioningType": "Thin",
                                "isShareable": False}
...
create_profile = [{
    "name": "ovf522-template_for_profile_creation-profile",
    "serverProfileTemplateUri": "SPT:" + "ovf522-template_for_profile_creation"
}]
...
profile_with_nonvc_connection = {
    "type": SP_TYPE,
    "name": "ovf522-profile_with_nonvc_connection",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
# Edit the profile by adding a volume, VC and non-VC connections, and storage paths to both connections
    ...
    "connectionSettings": {
        "connections": [
            ...
            {"id": 2, "name": "cnx02 VC", "functionType": "FibreChannel",
             "networkUri": "FCOE:" + NWFCOE01,
             "portId": SHT01_FLB_PORT01B}
        ]
    },
    "sanStorage": {
        "manageSanStorage": True,
        ...
        "volumeAttachments": [
            {"id": 1, "isBootVolume": False, "lunType": "Auto",
             ...
             "storagePaths": [
                 {"connectionId": 1, "targets": [], "targetSelector": "Auto", "isEnabled": True},
                 {"connectionId": 2, "targets": [], "targetSelector": "Auto", "isEnabled": True}
             ]
             }
        ]
    },
...
template_with_nonvc_connection = {
    "type": SPT_TYPE,
    "name": "ovf522-template_with_nonvc_connection",
    "iscsiInitiatorNameType": "AutoGenerated",
    "serverHardwareTypeUri": "SHT:" + SHT01,
    "enclosureGroupUri": "EG:" + EG01,
    "affinity": "Bay",
...
# Edit the template by adding a volume, VC and non-VC connections, and storage paths to both connections
        ...
        "volumeAttachments": [
            {"id": 1, "isBootVolume": False, "lunType": "Auto",
                ...
                "volume": {
                    ...
                    "templateUri": "ROOT:" + STORESERV01_STORAGE_POOL,
                    "properties": {
                                "name": "volume-ovf522-template_with_nonvc_connection",
                                "storagePool": "SP:" + STORESERV01_STORAGE_POOL,
                                "size": ONEGB,
                                "provisioningType": "Thin",
                                "isShareable": False}
...
profile_from_template_with_nonvc_connection = [{
    "name": "ovf522-template_with_nonvc_connection-profile",
    "serverProfileTemplateUri": "SPT:" + "ovf522-template_with_nonvc_connection"
}]
...
profile_from_template_with_nonvc_connection_edit_non_compliance = {
    ...
    "compliance-preview": {
        ...
        "automaticUpdates": ["Change port of connection with id 1 on Mezzanine (Mezz) 2:2 to Mezzanine (Mezz) 2:1.", ],
        "manualUpdates": []
    }
}
