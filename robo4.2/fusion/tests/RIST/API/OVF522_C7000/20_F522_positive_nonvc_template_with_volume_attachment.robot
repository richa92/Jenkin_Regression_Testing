*** Settings ***
Documentation   Positive tests: Create a template with a non-VC volume attachment.
...
TS0 Create the Template
    ${resp} = 	Add Server Profile Template	${template_nonvc_valid_profile_with_volume_attachments}
    log to console  ${resp}
