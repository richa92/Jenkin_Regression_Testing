*** Settings ***
Documentation   Negative tests: Attempt to create a template with a non-VC connection with a
...             port that does not support non-VC.
...
TS0 Attempt to Create the Template
    Run Negative Task  ${negative_template_invalid_port_type_task}
