*** Settings ***
Documentation   Negative tests: Attempt to create a profile with a non-VC connection and a
...             requestedMbps value that is not null.
...
TS0 Attempt to Create the Profile
    Run Negative Task  ${negative_profile_invalid_requestedmbps_not_null}
