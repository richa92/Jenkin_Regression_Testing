*** Settings ***
Documentation
...                   Description:  Q2 tests for missing boot entry alerts on Synergy. OVF5290 enables the capability to
...
...                           SY * gen 9 blade with FC mezz card (2830C,3830C) in appropriate slot
...                           SY * gen 10 blade with FC mezz card (2830C,3830C) in appropriate slot
...
...                   Interconnects
...
...                       Storage Volumes:
...                           Existing:  None
...                           Created:  StoreServ: OVF5290_vol1 (Gen9), OVF5290_vol2 (Gen9),
...                                                OVF5290_vol1 (Gen10), OVF5290_vol2 (Gen10)
...
...
Reconfigure Downlink Port Enablement
    ...
    ${downlink_port}=    downlink_dto    ${server_gen}    ${side}    ${state}
    Update IC Port  ${downlink_port["interconnectName"]}  ${downlink_port["portName"]}  ${downlink_port}
