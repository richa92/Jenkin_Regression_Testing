...
firebird_server_profile_templates = [{'type': 'ServerProfileTemplateV6',
                                      ...
                                      'localStorage': {'sasLogicalJBODs': [{'id': 1,
                                                       ...
                                                       'controllers': [{'logicalDrives': [{'name': ENC1 + ', bay 3-rd1',
                                                                                           'raidLevel': 'RAID1',
                                                                                           'bootable': False,
                                                                                           'numPhysicalDrives': 2,
                                                                                           'driveTechnology': 'SasHdd',
                                     ...
                                     {'type': 'ServerProfileTemplateV6',
                                      ...
                                      'localStorage': {'sasLogicalJBODs': [],
                                                       'controllers': [{'logicalDrives': [{'name': 'test',
                                                                                           'raidLevel': 'RAID0',
                                                                                           'bootable': False,
                                                                                           'numPhysicalDrives': 1,
                                                                                           'driveTechnology': 'SasHdd',
...
firebird_server_profiles = [{'type': 'ServerProfileV10',
