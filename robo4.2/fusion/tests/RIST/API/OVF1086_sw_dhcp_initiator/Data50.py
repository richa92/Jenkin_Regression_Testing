...
users = [{'userName': 'Serveradmin', 'password': 'wpsthpvse1', 'fullName': 'Serveradmin', 'roles': ['Server administrator'], 'emailAddress': 'sarah@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003', 'type': USER_AND_PERMISSION_TYPE},
         {'userName': 'Networkadmin', 'password': 'wpsthpvse1', 'fullName': 'Networkadmin', 'roles': ['Network administrator'], 'emailAddress': 'nat@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003', 'type': USER_AND_PERMISSION_TYPE},
         {'userName': 'Backupadmin', 'password': 'wpsthpvse1', 'fullName': 'Backupadmin', 'roles': ['Backup administrator'], 'emailAddress': 'backup@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003', 'type': USER_AND_PERMISSION_TYPE},
         {'userName': 'Noprivledge', 'password': 'wpsthpvse1', 'fullName': 'Noprivledge', 'roles': ['Read only'], 'emailAddress': 'rheid@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003', 'type': USER_AND_PERMISSION_TYPE}]
...
# PROFILE1 SETTINGS
PROFILE1_TEMPLATE_NAME = 'tbird15-bay7-DHCP-profile1-sw-iSCSI-simplified-boot'
...
# PROFILE2 SETTINGS
PROFILE2_TEMPLATE_NAME = 'tbird16-bay5-DHCP-uefi-sw-iSCSI-simplified-boot'
...
# PROFILE3 SETTINGS
PROFILE3_TEMPLATE_NAME = 'tbird16-bay1-DHCP-uefi-optimized-sw-iSCSI-simplified-boot'
...
# UEFI
spt_sw_iscsi_managed_volume_uefi = {
...
# UEFI optimized
spt_sw_iscsi_managed_volume_uefi_optimized = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
...
# PROFILE1
spt_sw_iscsi_managed_volume_profile1 = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
...
edit_spt_sw_iscsi_managed_volume_uefi = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE2_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE2_TEMPLATE_NAME,
...
edit_spt_sw_iscsi_managed_volume_uefi_optimized = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE3_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE3_TEMPLATE_NAME,
...
# edit PROFILE1 to disable simplified boot
edit_spt_sw_iscsi_managed_volume_profile1 = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE1_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE1_TEMPLATE_NAME,
...
edit2_spt_sw_iscsi_managed_volume_uefi = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE2_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE2_TEMPLATE_NAME,
...
edit2_spt_sw_iscsi_managed_volume_uefi_optimized = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE3_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE3_TEMPLATE_NAME,
...
# PROFILE1 back to original
edit2_spt_sw_iscsi_managed_volume_profile1 = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE1_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE1_TEMPLATE_NAME,
...
sp_from_spt_sw_uefi_defined_volume = {
...
verify_sp_from_spt_sw_uefi_defined_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC2SHBAY5,
    "serverProfileTemplateUri": 'SPT:' + PROFILE2_TEMPLATE_NAME,
    "iscsiInitiatorName": PROFILE2_INITIATOR_NAME,
...
sp_from_spt_sw_iscsi_uefi_optimized_defined_volume = {
    "type": SERVER_PROFILE_TYPE,
...
verify_sp_from_spt_sw_iscsi_uefi_optimized_defined_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC2SHBAY1,
    "serverProfileTemplateUri": 'SPT:' + PROFILE3_TEMPLATE_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
# Create template with HW iSCSI boot from StoreVirtual managed volume using defined volume and PROFILE1
sp_from_spt_sw_profile1_defined_volume = {
    "type": SERVER_PROFILE_TYPE,
...
# Verify DTO for Create template with HW iSCSI boot from StoreVirtual managed volume using defined volume and PROFILE1
verify_sp_from_spt_sw_profile1_defined_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC1SHBAY7,
    "serverProfileTemplateUri": 'SPT:' + PROFILE1_TEMPLATE_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
sp_from_spt_sw_uefi_existing_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC2SHBAY5,
    "serverProfileTemplateUri": 'SPT:' + PROFILE2_TEMPLATE_NAME,
    "iscsiInitiatorName": PROFILE2_INITIATOR_NAME,
...
sp_from_spt_sw_iscsi_uefi_optimized_existing_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC2SHBAY1,
    "serverProfileTemplateUri": 'SPT:' + PROFILE3_TEMPLATE_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
# Create template with HW iSCSI boot from StoreVirtual managed volume using existing volume and PROFILE1
sp_from_spt_sw_profile1_existing_volume = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC1SHBAY7,
    "serverProfileTemplateUri": 'SPT:' + PROFILE1_TEMPLATE_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
sp_from_spt_sw_iscsi_uefi_compliant = {
    "name": PROFILE2_TEMPLATE_NAME,
    "compliance-preview": {
...
sp_from_spt_sw_iscsi_uefi_optimized_compliant = {
    "name": PROFILE3_TEMPLATE_NAME,
    "compliance-preview": {
        "type": SERVER_PROFILE_COMPLIANCE_PREVIEW_TYPE,
        "automaticUpdates": [],
...
sp_from_spt_sw_iscsi_profile1_compliant = {
    "name": PROFILE1_TEMPLATE_NAME,
    "compliance-preview": {
        "type": SERVER_PROFILE_COMPLIANCE_PREVIEW_TYPE,
        "automaticUpdates": [],
...
sp_from_spt_sw_iscsi_uefi_non_compliant = {
    "name": PROFILE2_TEMPLATE_NAME,
    "compliance-preview": {
        "automaticUpdates": [
            ...
            "REGEX:Add a storage path using connection \"\d\" to attachment for volume \"" + NEW_PRIVATE_VOLUME1 + "\"\.",
        ],
        "manualUpdates": [
            "REGEX:Change boot source of connection \d on port Mezzanine \(Mezz\) \d:\d-a to Managed volume\.",
...
sp_from_spt_sw_iscsi_profile1_non_compliant = {
    "name": PROFILE1_TEMPLATE_NAME,
    "compliance-preview": {
        "automaticUpdates": [
            "REGEX:Change storage path using connection \"2\" in volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to enabled\.",
            "REGEX:Change storage path using connection \"1\" in volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to enabled\.",
        ],
        "manualUpdates": [
            "REGEX:Change boot setting of volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to primary\.",
        ],
        "type": SERVER_PROFILE_COMPLIANCE_PREVIEW_TYPE
...
sp_from_spt_sw_iscsi_profile1_non_compliant2 = {
    "name": PROFILE1_TEMPLATE_NAME,
    "compliance-preview": {
        "automaticUpdates": [
            "REGEX:Create an attachment to a new volume \"" + NEW_PRIVATE_VOLUME4 + "\"\.",
            "REGEX:Add a storage path using connection \"1\" to attachment for volume \"" + NEW_PRIVATE_VOLUME4 + "\"\.",
            "REGEX:Add a storage path using connection \"2\" to attachment for volume \"" + NEW_PRIVATE_VOLUME4 + "\"\.",
        ],
        "manualUpdates": [
            "REGEX:Change boot setting of volume attachment for volume \"" + NEW_PRIVATE_VOLUME4 + "\" to primary\.",
            "REGEX:Change boot setting of volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to not bootable\.",
            "REGEX:Change storage path using connection \"2\" in volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to disabled\.",
            "REGEX:Change storage path using connection \"1\" in volume attachment id \d for volume {\"name\":\".*\", \"uri\":\".*\"} to disabled\.",
        ],
        "type": SERVER_PROFILE_COMPLIANCE_PREVIEW_TYPE
...
sp_from_spt_sw_iscsi_uefi_optimized_non_compliant = {
    "name": PROFILE3_TEMPLATE_NAME,
    "compliance-preview": {
        "automaticUpdates": [],
        "manualUpdates": [
...
compliance_profile1_non_associated_atai = {
    "type": SERVER_PROFILE_TYPE,
    'serverHardwareUri': 'SH:' + ENC1SHBAY7,
    "serverProfileTemplateUri": 'SPT:' + PROFILE1_TEMPLATE_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
compliance_profile1_non_associated_atai_template = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    "serverHardwareTypeUri": 'SHT:' + PROFILE1_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE1_TEMPLATE_NAME,
...
# PROFILE1 back to original
edit_compliance_profile1_return_to_compliant_template = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE1_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": PROFILE1_TEMPLATE_NAME,
...
# SW iSCSI with Legacy Bios
negative_spt_4 = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE2_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
    "name": 'wpst10-negative-4',
    "affinity": "Bay",
    "bios": {
        "manageBios": False
    },
...
# edit to disable isBootVolume for managed volume
negative_spt_14 = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE,
    'serverHardwareTypeUri': 'SHT:' + PROFILE2_SHT_NAME,
    "enclosureGroupUri": "EG:" + EG_NAME,
...
create_templates = [
    spt_sw_iscsi_managed_volume_profile1.copy(),
    spt_sw_iscsi_managed_volume_uefi.copy(),
    spt_sw_iscsi_managed_volume_uefi_optimized.copy(),
]

edit_templates1 = [
    edit_spt_sw_iscsi_managed_volume_uefi.copy(),
    edit_spt_sw_iscsi_managed_volume_uefi_optimized.copy(),
    edit_spt_sw_iscsi_managed_volume_profile1.copy(),
]

edit_templates2 = [
    edit2_spt_sw_iscsi_managed_volume_profile1.copy(),
    edit2_spt_sw_iscsi_managed_volume_uefi.copy(),
    edit2_spt_sw_iscsi_managed_volume_uefi_optimized.copy(),
]
...
negative_spt_tasks = [
        ...
        'errorMessage': 'Multiple_secondary_boot'},
    {
        ...
        'taskState': 'Error',
        'errorMessage': 'Legacy_Bios_Not_Supported_for_SW_iSCSI'},
    {
        'keyword': 'Add Server Profile Template',
...
create_sp_from_spt = [
    sp_from_spt_sw_uefi_defined_volume.copy(),
    sp_from_spt_sw_iscsi_uefi_optimized_defined_volume.copy(),
    sp_from_spt_sw_profile1_defined_volume.copy(),
]

verify_create_sp_from_spt = [
    verify_sp_from_spt_sw_uefi_defined_volume.copy(),
    verify_sp_from_spt_sw_iscsi_uefi_optimized_defined_volume.copy(),
    verify_sp_from_spt_sw_profile1_defined_volume.copy(),
]

edit_sp_from_spt = [
    sp_from_spt_sw_uefi_existing_volume.copy(),
    sp_from_spt_sw_iscsi_uefi_optimized_existing_volume.copy(),
    sp_from_spt_sw_profile1_existing_volume.copy(),
]

edit_compliance1_sp_from_spt = [
    compliance_profile1_non_associated_atai.copy(),
    comliance_uefi_no_bootable_volume.copy(),
]

edit_compliance2_template = [
    compliance_profile1_non_associated_atai_template.copy(),
...
edit_compliance3_template = [
    edit_compliance_profile1_return_to_compliant_template.copy(),
    edit_compliance_uefi_return_to_compliant_template.copy(),
    edit2_spt_sw_iscsi_managed_volume_uefi_optimized.copy(),
]

sp_compliance = [
    sp_from_spt_sw_iscsi_uefi_compliant.copy(),
    sp_from_spt_sw_iscsi_uefi_optimized_compliant.copy(),
    sp_from_spt_sw_iscsi_profile1_compliant.copy(),
]

verify_non_compliance_sp_from_spt = [
    sp_from_spt_sw_iscsi_uefi_non_compliant.copy(),
    sp_from_spt_sw_iscsi_profile1_non_compliant.copy(),
]

verify_non_compliance_sp_from_spt2 = [
    # sp_from_spt_sw_iscsi_uefi_non_compliant.copy(),
    sp_from_spt_sw_iscsi_profile1_non_compliant2.copy(),
    sp_from_spt_sw_iscsi_uefi_optimized_non_compliant.copy(),
]
