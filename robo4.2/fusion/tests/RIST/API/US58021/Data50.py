...
BR_lig = [
    {
        ...
        "ethernetSettings": {
            ...
            "type": ETHERNET_INTERCONNECT_SETTINGS_TYPE,
            "lldpIpv6Address": "",
...
Post_backup_profile = {
    ...
    "iscsiInitiatorNameType": "AutoGenerated",
    "macType": "Virtual",
    "serverHardwareUri": "SH:" + Post_backup_SH,
    "bios": {
        "overriddenSettings": [],
        "manageBios": False
    },
    ...
    "type": SERVER_PROFILE_TYPE,
    "enclosureUri": "ENC:" + Post_backup_ENC,
    "associatedServer": None,
    "description": "",
    "templateCompliance": "Unknown",
    "enclosureBay": Bay,
    "name": Post_backup_SP_NAME,
    "enclosureGroupUri": "EG:" + EG_Exist,
    "sanStorage": {
        "manageSanStorage": False,
        "volumeAttachments": []
...
ljbs = [
    {
        "name": ljb1_name, "type": SAS_LOGICAL_JBOD_TYPE, "description": "",
