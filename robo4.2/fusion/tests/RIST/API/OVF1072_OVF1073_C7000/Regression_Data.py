...
storage_volumes = [
    ...
    {"properties": {"name": VOLUME_PROFILE2_3PAR1_PRIV, "description": "", "storagePool": STORESERV1_POOL1, "size": 1073741824, "provisioningType": "Thin", "isShareable": False, "snapshotPool": STORESERV1_POOL1},
     "templateUri": 'ROOT', "isPermanent": True,
     },
    {"properties": {"name": VOLUME_3PAR1_SHARED, "description": "", "storagePool": STORESERV1_POOL1, "size": 1073741824, "provisioningType": "Thin", "isShareable": True, "snapshotPool": STORESERV1_POOL1},
     "templateUri": 'ROOT', "isPermanent": True,
     },
    {"properties": {"name": VOLUME_PROFILE1_VSA1_PRIV, "description": "", "storagePool": STOREVIRTUAL1_POOL,
    ...
    {"properties": {"name": VOLUME_PROFILE2_VSA1_PRIV, "description": "", "storagePool": STOREVIRTUAL1_POOL,
                    "size": 1073741824, "dataProtectionLevel": "NetworkRaid5SingleParity", "provisioningType": "Thin",
                    "isShareable": False, "isAdaptiveOptimizationEnabled": True},
     "templateUri": VOLUME_TEMPLATE_VSA1_RAID5_PRIVATE, "isPermanent": True,
     },
    ...
    {"properties": {"name": VOLUME_PROFILE1_VSA2_PRIV, "description": "", "storagePool": STOREVIRTUAL2_POOL,
    ...
    {"properties": {"name": VOLUME_PROFILE2_VSA2_PRIV, "description": "", "storagePool": STOREVIRTUAL2_POOL,
                    "size": 1073741824, "dataProtectionLevel": "NetworkRaid0None", "provisioningType": "Thin",
                    "isShareable": False, "isAdaptiveOptimizationEnabled": True},
     "templateUri": 'ROOT', "isPermanent": True,
     },
    {"properties": {"name": VOLUME_VSA2_SHARED, "description": "", "storagePool": STOREVIRTUAL2_POOL,
                    "size": 1073741824, "dataProtectionLevel": "NetworkRaid0None", "provisioningType": "Thin",
                    "isShareable": True, "isAdaptiveOptimizationEnabled": True},
     "templateUri": 'ROOT', "isPermanent": True,
     },
...
VOLUME_PROFILE1_3PAR1_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile1-3par1-perm-priv'
VOLUME_PROFILE1_3PAR1_EPH_PRIV = PROFILE_NAME_PREFIX + \
    'profile1-3par1-eph-priv'
VOLUME_PROFILE1_VSA1_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile1-vsa1-perm-priv'
VOLUME_PROFILE1_VSA1_EPH_PRIV = PROFILE_NAME_PREFIX + 'profile1-vsa1-eph-priv'
VOLUME_PROFILE1_VSA2_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile1-vsa2-perm-priv'
...
VOLUME_PROFILE2_3PAR1_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile2-3par1-perm-priv'
VOLUME_PROFILE2_3PAR1_EPH_PRIV = PROFILE_NAME_PREFIX + \
    'profile2-3par1-eph-priv'
VOLUME_PROFILE2_VSA1_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile2-vsa1-perm-priv'
VOLUME_PROFILE2_VSA1_EPH_PRIV = PROFILE_NAME_PREFIX + 'profile2-vsa1-eph-priv'
VOLUME_PROFILE2_VSA2_PERM_PRIV = PROFILE_NAME_PREFIX + \
    'profile2-vsa2-perm-priv'
...
nts1_profile1 = {
    ...
    "connectionSettings": {"connections": [
        {"id": 5, "name": "", "functionType": "Ethernet", "portId": "Mezz 1:1", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 6, "name": "", "functionType": "Ethernet", "portId": "Mezz 1:2", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}}
    ]},
...
nts1_profile2 = {
    ...
    "connectionSettings": {"connections": [
        {"id": 1, "name": "", "functionType": "iSCSI", "portId": "Auto", "requestedMbps": "2500",
         ...
         "ipv4": {"ipAddressSource": "UserDefined", "subnetMask": INITIATOR_SUBNET_MASK, "gateway": "", "ipAddress": INITIATOR_IP_1},
...
nts1_profile6 = {
    ...
    "hideUnusedFlexNics": True,
    "connectionSettings": {"connections": [
        {"id": 3, "name": "", "functionType": "Ethernet", "portId": "Flb 1:1", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 4, "name": "", "functionType": "Ethernet", "portId": "Flb 1:2", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}}
    ]},
...
nts3_profile_create = {
    ...
    "serverHardwareUri": 'SH:' + NTS3_PROFILE_SERVER, "enclosureGroupUri": 'EG:' + NTS3_PROFILE_EG, "enclosureUri": 'ENC:' + NTS3_PROFILE_ENC,
...
nts4_profile_create = {
    ...
    "serverHardwareUri": 'SH:' + NTS4_PROFILE_SERVER, "enclosureGroupUri": 'EG:' + NTS4_PROFILE_EG, "enclosureUri": 'ENC:' + NTS4_PROFILE_ENC,
    ...
    "connectionSettings": {"connections": [
        ...
        {"id": 4, "name": "", "functionType": "iSCSI", "portId": "Flb 1:2-b", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 5, "name": "", "functionType": "iSCSI", "portId": "Mezz 1:1-b", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {"ipAddressSource": "UserDefined", "subnetMask": INITIATOR_SUBNET_MASK, "gateway": "", "ipAddress": INITIATOR_IP_1},
         "boot": {"priority": "Primary", "bootVolumeSource": "ManagedVolume", "iscsi": None}},
        {"id": 6, "name": "", "functionType": "iSCSI", "portId": "Mezz 1:2-b", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}}
    ]},
    "boot": {"manageBoot": True, "order": ["HardDisk", "CD", "Floppy", "USB", "PXE"]}, "bootMode": None,
    "firmware": {"manageFirmware": False, "firmwareBaselineUri": "", "forceInstallFirmware": False, "firmwareInstallType": None},
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": ESXI, "manageSanStorage": True,
                   "volumeAttachments": [{
                       "id": 1,
                       "isBootVolume": False,
                       "lunType": "Auto",
    ...
    "connectionSettings": {"connections": [
        ...
        {"id": 5, "name": "", "functionType": "iSCSI", "portId": "Mezz 1:1-b", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         ...
         "boot": {"priority": "Primary", "bootVolumeSource": "ManagedVolume",
                  "iscsi": {'mutualChapName': NTS4_PROFILE_IQN, 'chapName': NTS4_PROFILE_IQN, 'initiatorName': NTS4_PROFILE_IQN,
...
nts4_profile_edit2 = {
    ...
    "connectionSettings": {"connections": [
        ...
        {"id": 5, "name": "", "functionType": "iSCSI", "portId": "Mezz 1:1-b", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "ipv4": {"ipAddressSource": "UserDefined", "subnetMask": INITIATOR_SUBNET_MASK, "gateway": "", "ipAddress": INITIATOR_IP_2},
         "boot": {"priority": "Primary", "bootVolumeSource": "ManagedVolume", "iscsi": None}, },
        {"id": 6,
         "name": "",
         "functionType": "iSCSI",
...
profile1_create = {
    ...
    "serverHardwareUri": 'SH:' + PROFILE1_SERVER, "enclosureGroupUri": 'EG:' + PROFILE1_EG, "enclosureUri": 'ENC:' + PROFILE1_ENC,
    ...
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": OLD_RHE, "manageSanStorage": True,
                   "volumeAttachments": [{
                       "id": 1,
                       "isBootVolume": False,
                       "lun": 1,
...
profile1_edit = {
    ...
    "connectionSettings": {"connections": [
        ...
        {"id": 2, "name": "", "functionType": "FibreChannel", "portId": "Mezz 2:2", "requestedMbps": "Auto", "networkUri": 'FC:fa-b',
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 3, "name": "", "functionType": "iSCSI", "portId": "Flb 1:1", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 4, "name": "", "functionType": "iSCSI", "portId": "Flb 1:2", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 5, "name": "", "functionType": "Ethernet", "portId": "Mezz 1:1", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 6, "name": "", "functionType": "Ethernet", "portId": "Mezz 1:2", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
...
profile1_move = {
    "type": SERVER_PROFILE_TYPE, "name": PROFILE1_NAME, "description": "",
    "serverHardwareUri": 'SH:' + PROFILE1_MOVE_SERVER, "enclosureGroupUri": 'EG:' + PROFILE1_MOVE_EG, "enclosureUri": 'ENC:' + PROFILE1_MOVE_ENC,
    "iscsiInitiatorNameType": "UserDefined", "iscsiInitiatorName": PROFILE1_IQN_EDIT,
    "serialNumberType": "Virtual", "macType": "Virtual", "wwnType": "Virtual", "affinity": "Bay",
    "hideUnusedFlexNics": True,
    "connectionSettings": {"connections": [
        ...
        {"id": 4, "name": "", "functionType": "iSCSI", "portId": "Flb 1:2", "requestedMbps": "2500", "networkUri": "ETH:network-untagged",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 5, "name": "", "functionType": "Ethernet", "portId": "Flb 2:1", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}},
        {"id": 6, "name": "", "functionType": "Ethernet", "portId": "Flb 2:2", "requestedMbps": "2500", "networkUri": "ETH:network-tunnel",
         "mac": None, "wwpn": None, "wwnn": None, "ipv4": {}}
    ]},
    "boot": {"manageBoot": False, "order": ["HardDisk"]}, "bootMode": {"manageMode": True, "mode": "UEFI", "pxeBootPolicy": "Auto"},
    "firmware": {"manageFirmware": False, "firmwareBaselineUri": None, "forceInstallFirmware": False, "firmwareInstallType": None},
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": NEW_RHE, "manageSanStorage": True,
                   "volumeAttachments": [{
                       "id": 11,
                       "isBootVolume": False,
                       "lunType": "Auto",
...
profile1_move_expected = {
    ...
    "boot": {"manageBoot": False, "order": []}, "bootMode": {"manageMode": True, "mode": "UEFI", "pxeBootPolicy": "Auto"},
    "firmware": {"manageFirmware": False, "firmwareBaselineUri": None, "forceInstallFirmware": False, "firmwareInstallType": None},
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": NEW_RHE, "manageSanStorage": True,
...
profile2_create = {
    ...
    "serverHardwareUri": 'SH:' + PROFILE2_SERVER, "enclosureGroupUri": 'EG:' + PROFILE2_EG, "enclosureUri": 'ENC:' + PROFILE2_ENC,
    ...
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": NEW_SUSE, "manageSanStorage": True,
                   "volumeAttachments": [{
                       "id": 1,
                       "isBootVolume": False,
                       "lun": 1,
...
profile2_move = {
    "type": SERVER_PROFILE_TYPE, "name": PROFILE2_NAME, "description": "",
    "serverHardwareUri": 'SH:' + PROFILE2_MOVE_SERVER, "enclosureGroupUri": 'EG:' + PROFILE2_MOVE_EG, "enclosureUri": 'ENC:' + PROFILE2_MOVE_ENC,
    "iscsiInitiatorNameType": "UserDefined", "iscsiInitiatorName": PROFILE2_IQN,
    "serialNumberType": "Virtual", "macType": "Virtual", "wwnType": "Virtual", "affinity": "Bay",
    "hideUnusedFlexNics": True,
    "connectionSettings": {"connections": [
    ...
    "bios": {"manageBios": False, "overriddenSettings": []},
    "localStorage": {"sasLogicalJBODs": [], "controllers": []},
    "sanStorage": {"hostOSType": OLD_SUSE, "manageSanStorage": True,
                   "volumeAttachments": [{
                       "id": 1,
                       "isBootVolume": False,
                       "lun": 1,
