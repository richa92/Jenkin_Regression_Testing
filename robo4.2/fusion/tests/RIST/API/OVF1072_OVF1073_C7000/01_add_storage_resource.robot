*** Settings ***
Documentation       OVF1072 OVF1073 C7000 Add Storage Resources - volumes templates and volumes
Suite Setup         OVF1072 OVF1073 C7000 ASR Setup
...
*** Test Cases ***
OVF1072 OVF1073 C7000 ASR Initialize the Variables
    Set Log Level	TRACE
    log variables
    Fusion Api Login Appliance 		${APPLIANCE_IP}  ${admin_credentials}

OVF1072 OVF1073 C7000 ASR Create the Storage Volume Templates
    ${resplist} =  Add Storage Volume Templates Async  ${storage_volume_templates}

OVF1072 OVF1073 C7000 ASR Create the Storage Volumes
	${resplist} =  Add Storage Volumes Async  ${storage_volumes}
	Wait for task2  ${resplist}  timeout=300  interval=10

OVF1072 OVF1073 C7000 ASR Import Existing Storage Volumes
	${resplist} =  Add Existing Storage Volumes Async  ${existing_storage_volumes}
	wait for task2  ${resplist}  timeout=300  interval=10

*** Keywords ***
OVF1072 OVF1073 C7000 ASR Setup
    [Documentation]    OVF1072 OVF1073 C7000 Add Storage Resource Setup
    Set Log Level	TRACE
    ${feature} =  set variable  OVF1072 OVF1073 C7000 ASR
