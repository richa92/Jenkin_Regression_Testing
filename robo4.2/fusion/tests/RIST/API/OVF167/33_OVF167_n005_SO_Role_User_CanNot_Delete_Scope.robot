*** Settings ***
Documentation        OVF167 - n005_SO_Role_User_CanNot_Delete_Scope
...
*** Test Cases ***
OVF167_n005_SO_Role_User_CanNot_Delete_Scope
    [Documentation]    n005_SO_Role_User_CanNot_Delete_Scope
    Log To Console    \n- Test Case: n005_SO_Role_User_CanNot_Delete_Scope
    ...
    Log To Console    \n- Test Case: Successfully: n005_SO_Role_User_CanNot_Delete_Scope
