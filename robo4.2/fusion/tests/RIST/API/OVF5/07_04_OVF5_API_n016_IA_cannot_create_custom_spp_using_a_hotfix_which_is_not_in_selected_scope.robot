...
*** Test Cases ***
IA cannot create custom spp using a hotfix which is not in selected scope
    Log    \n IA cannot create custom spp using a hotfix which is not in selected scope    console=true
