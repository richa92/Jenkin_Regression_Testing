...
*** Test Cases ***
Scope should remained after IA remove internal firmware bundle when it also in external repo
    Log    \n Scope should remained after IA remove internal firmware bundle when it also in external repo    console=true
    ${resp} =   Remove Firmware Bundle By Version    ${SPPVersion}
    Wait For Task2    ${resp}
