...
*** Test Cases ***
IA cannot create custom spp and assign scope which is not a member of its scope
    Log    \n IA cannot create custom spp and assign scope which is not a member of its scope    console=true
