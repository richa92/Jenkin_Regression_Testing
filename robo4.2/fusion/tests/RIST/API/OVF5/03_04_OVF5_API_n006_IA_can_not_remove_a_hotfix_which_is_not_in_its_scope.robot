...
*** Test Cases ***
IA can not remove a hotfix which is not in its scope
    Log    \n IA can not remove a hotfix which is not in its scope    console=true
    ...
    ${resp} =    Remove Firmware Bundle By Version    ${Upload_HotFix_Version}
