...
*** Test Cases ***
IA with scope cannot create custom spp using a firmware bundle with no scope
    Log    \n IA with scope cannot create custom spp using a firmware bundle with no scope    console=true
