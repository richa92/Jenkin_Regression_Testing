...
Test Teardown   Clear Firmware Bundle
...
*** Test Cases ***
Scope should remained after IA remove internal hotfix when it also in external repo
    Log    \n Scope should remained after IA remove internal hotfix when it also in external repo    console=true
    ${resp} =   Remove Firmware Bundle By Version    ${HotFixVersion}
    Wait For Task2    ${resp}
