...
*** Test Cases ***
IA cannot add Hotfix with scope not assign to him
    Log    \n IA cannot add Hotfix with scope not assign to him    console=true
    ${scopes} =  Create List
    ...
    ${resp} =    Upload Firmware Bundle With Scopes    ${Upload_HotFix_Path}    ${scopes}
