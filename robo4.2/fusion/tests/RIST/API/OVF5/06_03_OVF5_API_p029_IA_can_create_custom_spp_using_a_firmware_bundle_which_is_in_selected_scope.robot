...
*** Test Cases ***
IA can create custom spp using a firmware bundle which is in selected scope
    Log    \n IA can create custom spp using a firmware bundle which is in selected scope    console=true
