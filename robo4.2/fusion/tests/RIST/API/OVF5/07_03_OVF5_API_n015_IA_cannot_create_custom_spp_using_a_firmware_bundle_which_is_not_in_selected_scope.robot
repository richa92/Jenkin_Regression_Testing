...
*** Test Cases ***
IA cannot create custom spp using a firmware bundle which is not in selected scope
    Log    \n IA cannot create custom spp using a firmware bundle which is not in selected scope    console=true
