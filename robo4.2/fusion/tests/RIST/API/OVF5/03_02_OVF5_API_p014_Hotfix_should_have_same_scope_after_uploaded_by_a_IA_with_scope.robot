...
*** Test Cases ***
Hotfix should have same scope after uploaded by a IA with scope
    ...
    Log    Uploading firmware bundle ${Upload_HotFix_Path} with ${scopes}    console=true
    Upload Firmware Bundle With Scopes Async    ${Upload_HotFix_Path}    ${scopes}
    ${firmware} =    Get Firmware Bundle By Version  ${Upload_HotFix_Version}
    :FOR    ${scope_name}    IN    @{ia_user_scopes}
    \    ${scope} =    Get Scope URI By Name    ${scope_name}
