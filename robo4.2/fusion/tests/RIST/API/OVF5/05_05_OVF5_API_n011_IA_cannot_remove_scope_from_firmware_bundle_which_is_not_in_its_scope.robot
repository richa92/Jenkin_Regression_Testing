...
*** Test Cases ***
IA cannot remove scope from firmware bundle which is not in its scope
    Log    \n IA cannot remove scope from firmware bundle which is not in its scope    console=true
