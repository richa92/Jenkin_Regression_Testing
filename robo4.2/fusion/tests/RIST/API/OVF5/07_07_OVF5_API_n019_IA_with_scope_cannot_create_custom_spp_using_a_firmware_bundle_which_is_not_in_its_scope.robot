...
*** Test Cases ***
IA with scope cannot create custom spp using a firmware bundle which is not in its scope
    Log    \n IA with scope cannot create custom spp using a firmware bundle which is not in its scope    console=true
