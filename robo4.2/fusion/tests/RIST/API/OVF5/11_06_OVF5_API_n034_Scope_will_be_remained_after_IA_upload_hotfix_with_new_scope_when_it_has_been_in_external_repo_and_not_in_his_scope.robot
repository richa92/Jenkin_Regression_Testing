...
*** Test Cases ***
Scope will be remained after IA upload hotfix with new scope when it has been in external repo and not in his scope
    Log    \n Scope will be remained after IA upload hotfix with new scope when it has been in external repo and not in his scope    console=true
    ${scopes} =  Create List
