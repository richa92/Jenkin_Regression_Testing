...
*** Test Cases ***
Scope should remained after IA remove extrenal repo inculde hotfix when it also in internal repo
    Log    \n Scope should remained after IA remove extrenal repo inculde hotfix when it also in internal repo    console=true
