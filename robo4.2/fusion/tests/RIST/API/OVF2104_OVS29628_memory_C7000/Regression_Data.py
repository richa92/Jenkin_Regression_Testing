...
Gen10_servers = [ENC1SHBAY14, ENC1SHBAY16, ENC2SHBAY16]

ris_node1 = {"server": ENC1SHBAY14,
             "username": "Administrator",
             "password": "hpvse123",
             "path": "/redfish/v1/Systems/1/Memory/", }
ris_node2 = {"server": ENC1SHBAY16,
             "username": "Administrator",
             "password": "hpvse123",
             "path": "/redfish/v1/Systems/1/Memory/", }
ris_node3 = {"server": ENC2SHBAY16,
             "username": "Administrator",
             "password": "hpvse123",
             "path": "/redfish/v1/Systems/1/Memory/", }
ris_nodes = [ris_node2, ris_node3]
...
verify_gen9_servers = [
    {"type": SERVER_HARDWARE_TYPE,
     ...
     "intelligentProvisioningVersion": "2.61.2",
     "licensingIntent": "OneViewNoiLO",
     "memoryMb": 16384,
     "migrationState": "NotApplicable",
     "model": "ProLiant BL460c Gen9",
     "mpHostInfo": {"mpHostName": "ILO2M25300G32",
                    "mpIpAddresses": [
                        {"address": "16.125.75.249",
                         "type": "Undefined"
                         }
                    ]
                    },
     ...
     "uri": "SH:" + ENC1SHBAY5,
     "uuid": "30373237-3132-4D32-3235-333030473332",
...
gen10_server_profiles = [{
    ...
    "serialNumberType": "Virtual",
    "iscsiInitiatorNameType": "AutoGenerated",
    "name": "enc2 bay16 Gen10 BL460c profile with LS",
    "description": "",
    "affinity": "Bay",
    "connectionSettings": {
        "connections": [{
