...
*** Test Cases ***
F722APIp004 Edit SP, update firmware by Gen 9 snap 6 with force install
    ...
    Update server firmware when edit profile  ${SNAP6SPP}    ${True}
    Validate Profile Firmware Version   ${editProfiles}   ${SNAP6SPP}
