...
*** Test Cases ***
F722APIn002 Edit SP, update firmware older than Gen 9 snap 6
    [Tags]    Performance    server profiles-condition-gen9_firmware
    Create empty server profile    ${editProfiles}
    Update server firmware when edit profile  ${SNAP5SPP}     ${True}    ${IP}
    Validate Profile Firmware Version   ${editProfiles}   ${SNAP5SPP}
