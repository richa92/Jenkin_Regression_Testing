...
server_credentials = deepcopy(SERVER_CREDENTIALS_COMMON)
network_credentials = deepcopy(NETWORK_CREDENTIALS_COMMON)
hpmctp_credentials = deepcopy(HPMCTP_CREDENTIALS_COMMON)

VOLUME_TEMPLATE_VERSION = '1.1'

cliq_credentials_173 = deepcopy(STOREVIRTUAL_SLPT_STATIC_CLIQ_CREDENTIALS)
cliq_credentials_116 = deepcopy(STOREVIRTUAL_SLPT_DHCP_CLIQ_CREDENTIALS)

# Potash interconnects
ENC1ICBAY3 = '%s, interconnect 3' % ENC1  # pylint: disable=E0601
ENC2ICBAY6 = '%s, interconnect 6' % ENC2  # pylint: disable=E0601
...
ENC3SHBAY1 = '%s, bay 1' % ENC3  # pylint: disable=E0601
...
PROFILE1_BOOT_TARGET_NAME = 'iqn.2003-10.com.lefthandnetworks:vsa-mg-116:3434:tbird14-bay7-dhcp'
...
PROFILE1_ISCSI_BOOT_ATTEMPT_1 = "iqn.2003-10.com.lefthandnetworks:vsa-mg-116:3434:tbird14-bay7-dhcp_attempt_1"
PROFILE1_ISCSI_BOOT_ATTEMPT_2 = "iqn.2003-10.com.lefthandnetworks:vsa-mg-116:3434:tbird14-bay7-dhcp_attempt_2"
...
PROFILE2_BOOT_TARGET_NAME = "iqn.2003-10.com.lefthandnetworks:vsa-mg-116:4503:tbird17-bay1-dhcp-2"
PROFILE2_INITIATOR_NAME = "iqn.2015-02.com.hpe:oneview-vcgero4009"
PROFILE2_INITIATOR_IP_1 = "192.168.22.52"
PROFILE2_INITIATOR_IP_2 = "192.168.22.57"
PROFILE2_ISCSI_BOOT_ATTEMPT_1 = "iqn.2003-10.com.lefthandnetworks:vsa-mg-116:4503:tbird17-bay1-dhcp-2_attempt_1"
PROFILE2_ISCSI_BOOT_ATTEMPT_2 = "iqn.2003-10.com.lefthandnetworks:vsa-mg-116:3464:tbird17-bay1-bootvol_attempt_2"
...
# profile3 = 'tbird18-bay1-SP-hw-iscsi-SpecifyBootTarget-UserSpecified'
            ...
            "volumeAttachments": [
                {
                    ...
                    "volume": None,
                    "volumeUri": "StorageVolumeV3:" + PROFILE4_Existing_vol,
                },
                {
                    "id": 2,
                    "bootVolumePriority": "Primary",
...
server_profiles = [
    ...
    },
    {
        ...
        "serverHardwareTypeUri": "SHT:SY 480 Gen9:1:Synergy 3530C 16G HBA:3:HP Synergy 3820C 10/20Gb CNA",
        "enclosureGroupUri": "EG:EG1",
        "serialNumberType": "Virtual",
        "iscsiInitiatorNameType": "UserDefined",
        "macType": "Virtual",
                ...
                [
                    {
                        "StructuredBootString": "NIC.Slot.3.1.iSCSI",
                        "iSCSIAuthenticationMethod": "Chap",
                        "iSCSIBootAttemptName": "REGEX:(iqn\.2003-10\.com\.lefthandnetworks:vsa-mg-116:["
                                                "0-9]+\:tbird17-bay1-dhcp-2_attempt_1)",
                        "iSCSIBootEnable": "Enabled",
                        "iSCSIBootLUN": "0",
                        "iSCSIChapSecret": None,
                        ...
                        "iSCSITargetInfoViaDHCP": False,
                        "iSCSITargetIpAddress": VSA_116_BOOT_TARGET_IP,
                        "iSCSITargetName": "REGEX:(iqn\.2003-10\.com\.lefthandnetworks:vsa-mg-116:["
                                           "0-9]+\:tbird17-bay1-dhcp-2)",
                        "iSCSITargetTcpPort": 3260
                    },
                    {
                        "StructuredBootString": None,
        ...
        "validatePrimary":
           ...
           <active-cfg-cats-RO>
               <config-nextDLR-type>
                   ...
                   <iscsi-target-params>
                       <iscsi-target-name>iqn.2003-10.com.lefthandnetworks:vsa-mg-173-2:613:tbird8-bay3-sles<nul
                       /></iscsi-target-name>
        ...
        "validatePrimary":
           ...
           <active-cfg-cats-RO>
               <config-nextDLR-type>
                   ...
                   <iscsi-target-params>
                       <iscsi-target-name>iqn.2003-10.com.lefthandnetworks:vsa-mg-116:521:spt-hw-iscsi-managedvol
                       -dhcp-newvol<nul/></iscsi-target-name>
                       <iscsi-LUN>0</iscsi-LUN>
        ...
        "volumeAttachments": [
            {
                ...
                "storagePaths": [
                    {
                        "storageTargets": [
                            "tcpPort: 3260, ipAddress: " + VSA_116_BOOT_TARGET_IP + ", name: " +
...
profileTemplate300_verify = {
    "type": SERVER_PROFILE_TEMPLATE_TYPE_300,
    "name": "SPT-sw-iscsi-ManagedVol-DHCP",
    "description": "SPT-sw-iscsi-ManagedVol-DHCP",
    "serverProfileDescription": "SPT-sw-iscsi-ManagedVol-DHCP",
    "enclosureGroupUri": "EG:EG1",
