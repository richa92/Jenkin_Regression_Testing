...
cliq_credentials = {'mgmt_ip': '16.71.149.173',
                    'username': 'admin',
                    'password': 'admin'
                    }
...
NEW_PRIVATE_VOLUME1 = 'ovs3803-private-volume1-tbird'
NEW_PRIVATE_VOLUME2 = 'ovs3803-private-volume2-tbird'
NEW_PRIVATE_VOLUME3 = 'ovs3803-private-volume3-tbird'
NEW_PRIVATE_VOLUME4 = 'ovs3803-private-volume4-tbird'
...
# PROFILE1 SETTINGS
PROFILE1_TEMPLATE_NAME = 'tbird9-bay1-profile1-sw-iSCSI-simplified-boot'
PROFILE1_EXISTING_VOLUME = 'tbird9-bay1-managed-volume'
PROFILE1_SHT_NAME = 'SY 480 Gen9:3:HP Synergy 3820C 10/20Gb CNA'
PROFILE1_INITIATOR_IP1 = '192.168.22.51'
PROFILE1_INITIATOR_IP2 = '192.168.22.56'
PROFILE1_INITIATOR_NAME = 'iqn.2015-02.com.hpe:oneview-tbird9-bay1-managed-volume'

# PROFILE2 SETTINGS
PROFILE2_TEMPLATE_NAME = 'tbird9-bay6-uefi-sw-iSCSI-simplified-boot'
PROFILE2_EXISTING_VOLUME = 'tbird9-bay6-managed-volume'
PROFILE2_SHT_NAME = 'SY 660 Gen9:3:HP Synergy 3820C 10/20Gb CNA'
PROFILE2_INITIATOR_IP1 = '192.168.22.52'
PROFILE2_INITIATOR_IP2 = '192.168.22.57'
PROFILE2_INITIATOR_NAME = 'iqn.2015-02.com.hpe:oneview-tbird9-bay6-managed-volume'
...
# PROFILE3 SETTINGS
PROFILE3_TEMPLATE_NAME = 'tbird9-bay2-uefi-optimized-sw-iSCSI-simplified-boot'
PROFILE3_EXISTING_VOLUME = 'tbird9-bay2-managed-volume'
PROFILE3_SHT_NAME = 'SY 480 Gen9:3:HP Synergy 3820C 10/20Gb CNA'
PROFILE3_INITIATOR_IP1 = '192.168.22.61'
PROFILE3_INITIATOR_IP2 = '192.168.22.62'
PROFILE3_INITIATOR_NAME = 'iqn.2015-02.com.hpe:oneview-tbird9-bay2-managed-volume'
    ...
    "connectionSettings": {
        "connections": [{
            ...
            "ipv4": {
                ...
                "ipAddress": PROFILE2_INITIATOR_IP1,
                "subnetMask": INITIATOR_SUBNET_MASK,
                "gateway": INITIATOR_GATEWAY,
            },
            "name": "Connection 1",
...
sp_from_spt_sw_iscsi_uefi_optimized_defined_volume = {
    ...
    "connectionSettings": {
        "connections": [{
            ...
            "ipv4": {
                "ipAddressSource": "UserDefined",
                "ipAddress": PROFILE3_INITIATOR_IP1,
                "subnetMask": INITIATOR_SUBNET_MASK,
                "gateway": INITIATOR_GATEWAY,
            },
            "name": "Connection 1",
...
sp_from_spt_sw_profile1_defined_volume = {
    ...
    "connectionSettings": {
        "connections": [{
            ...
            "ipv4": {
                "ipAddressSource": "UserDefined",
                "ipAddress": PROFILE1_INITIATOR_IP1,
                "subnetMask": INITIATOR_SUBNET_MASK,
                "gateway": INITIATOR_GATEWAY,
            },
            "name": "Connection 1",
            ...
            "ipv4": {
                "ipAddressSource": "UserDefined",
                "ipAddress": PROFILE1_INITIATOR_IP2,
                "subnetMask": INITIATOR_SUBNET_MASK,
                "gateway": INITIATOR_GATEWAY,
            },
            "name": "Connection 2",
...
sp_from_spt_sw_iscsi_uefi_non_compliant = {
    ...
    "compliance-preview": {
        "automaticUpdates": [
            ...
            "REGEX:Change SAN storage to managed by profile\.",
...
sp_from_spt_sw_iscsi_profile1_non_compliant2 = {
    ...
    "compliance-preview": {
        ...
        "manualUpdates": [
            "REGEX:The boot setting for attachment id \"\d\" for volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the associated template setting\. Change either the profile or the template setting accordingly\."
        ],
        "type": "ServerProfileCompliancePreviewV1"
...
negative_spt_tasks = [
        ...
        'errorMessage': 'SPT_attach_exist_private_volume'},
    {
        ...
        'taskState': 'Error',
        'errorMessage': 'UNABLE_TO_CREATE_VOLUME'},
    {
        'keyword': 'Add Server Profile Template',
