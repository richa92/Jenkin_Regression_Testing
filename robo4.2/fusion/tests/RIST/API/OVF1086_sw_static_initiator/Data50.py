...
users = \
    [
        ...
        },
        {
            ...
            'roles': ['Backup administrator'], 'emailAddress': 'backup@hp.com', 'officePhone': '970-555-0003',
            'mobilePhone': '970-500-0003', 'type': USER_AND_PERMISSION_TYPE
        },
        {
...
# PROFILE1 SETTINGS
PROFILE1_TEMPLATE_NAME = 'tbird15-bay7-sw-iSCSI-simplified-boot'
PROFILE1_EXISTING_VOLUME = 'tbird15-bay7-rhel-managed-volume'
PROFILE1_SHT_NAME = 'SY 480 Gen9:1:Smart Array P542D Controller:3:HP Synergy 3820C 10/20Gb CNA'
PROFILE1_INITIATOR_IP1 = '192.168.22.187'
PROFILE1_INITIATOR_IP2 = '192.168.22.188'
PROFILE1_INITIATOR_NAME = 'iqn.2015-02.com.hpe:oneview-tbird15-bay7-managed-volume'

# PROFILE2 SETTINGS
PROFILE2_TEMPLATE_NAME = 'tbird16-bay5-uefi-sw-iSCSI-simplified-boot'
PROFILE2_EXISTING_VOLUME = 'tbird16-bay5-rhel-managed-volume'
PROFILE2_SHT_NAME = 'SY 660 Gen9:1:Synergy 3830C 16G FC HBA:3:HP Synergy 3820C 10/20Gb CNA'
PROFILE2_INITIATOR_IP1 = '192.168.22.191'
PROFILE2_INITIATOR_IP2 = '192.168.22.192'
PROFILE2_INITIATOR_NAME = 'iqn.2015-02.com.hpe:oneview-tbird16-bay5-managed-volume'
...
# PROFILE3 SETTINGS
PROFILE3_TEMPLATE_NAME = 'tbird16-bay1-uefi-optimized-sw-iSCSI-simplified-boot'
PROFILE3_EXISTING_VOLUME = 'tbird16-bay1-rhel-managed-volume'
...
sp_from_spt_sw_iscsi_profile1_non_compliant2 = {
    ...
    "compliance-preview": {
        "automaticUpdates": [
            ...
            "REGEX:Add a storage path using connection \"\d\" to attachment for volume \"" + NEW_PRIVATE_VOLUME4 + "\"\.",
            "REGEX:Add a storage path using connection \"\d\" to attachment for volume \"" + NEW_PRIVATE_VOLUME4 + "\"\."
        ],
        "manualUpdates": [
