from dto import *   # pylint: disable=import-error
from env_variables import *     # pylint: disable=import-error

# The web proxy is a OneView instance used as a web proxy.  Created on wpstwork.vse.rdlabs.hpecorp.net
# as cic_ronsoto_OV_as_web-proxy_NO_REMOVE.  From time to time, may lose IPv4 address and a power cycle is then
# required.  New DHCP address will be obtained and must be updated here
WEB_PROXY = [
    {"type": "ProxyServerV2",
     "server": "16.114.220.133",
     "port": "443",
     "username": None,
     "password": None,
     "credUri": None,
