...
users = [
    {
        'userName': 'Serveradmin_f1222', 'password': 'wpsthpvse1', 'fullName': 'Serveradmin_f1222',
    ...
    {
        'userName': 'Networkadmin_f1222', 'password': 'wpsthpvse1', 'fullName': 'Networkadmin_f1222',
        'permissions': [{'roleName': 'Network administrator'}],
        'emailAddress': 'nat@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003',
        'type': USER_AND_PERMISSION_TYPE
    },
    {
        'userName': 'Backupadmin_f1222', 'password': 'wpsthpvse1', 'fullName': 'Backupadmin_f1222',
        'permissions': [{'roleName': 'Backup administrator'}],
        'emailAddress': 'backup@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003',
        'type': USER_AND_PERMISSION_TYPE
    },
    {
        'userName': 'storage_f1222', 'password': 'wpsthpvse1', 'fullName': 'storage_f1222',
        'permissions': [{'roleName': 'Storage administrator'}],
        'emailAddress': 'rheid@hp.com', 'officePhone': '970-555-0003', 'mobilePhone': '970-500-0003',
        'type': USER_AND_PERMISSION_TYPE
    },
    {
        'userName': 'Noprivledge_f1222', 'password': 'wpsthpvse1', 'fullName': 'Noprivledge_f1222',
...
sasligs = [
    {
        'name': 'SASLIG2',  # Single SAS switch
