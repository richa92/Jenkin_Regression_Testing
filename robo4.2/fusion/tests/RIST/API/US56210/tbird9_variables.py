...
ligs = [
    {'name': LIG_NAME,
     ...
     'uplinkSets': [uplink_sets['us_network-untagged'].copy(), uplink_sets['us_network-tunnel'].copy(), uplink_sets['us_tagged'].copy(), uplink_sets['fa-a'].copy(), uplink_sets['fa-b'].copy()]
     },
]
