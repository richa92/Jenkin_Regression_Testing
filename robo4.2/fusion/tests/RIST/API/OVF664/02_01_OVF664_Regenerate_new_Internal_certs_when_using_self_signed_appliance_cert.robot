...
Regenerate new internal certs when using self signed appliance cert
    ...
    Log    \n-Regenerate new internal root ca cert , internal ca signed rabbitmq client cert and rabbitmq server cert via Delete /rest/certificates/ca/default    console=yes
