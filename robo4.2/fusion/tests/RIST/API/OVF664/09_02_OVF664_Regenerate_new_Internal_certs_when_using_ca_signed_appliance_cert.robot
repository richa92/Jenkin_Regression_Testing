...
...                  excepet rabbitmq server cert vai Delete /rest/certificates/ca/rabbitmq_readonly when using ca signed appliance cert
...
Regenerate new internal certs when using ca signed appliance cert
    ...
    Log    \n-Regenerate new internal certs via Delete /rest/certificates/ca/rabbitmq_readonly    console=yes
