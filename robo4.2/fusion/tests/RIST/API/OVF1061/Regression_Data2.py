...
OVF1061_SERVER1_SERVER_NAME_1 = "tbird5bay1-1"
OVF1061_SERVER1_SERVER_NAME_2 = "tbird5bay1-os"
OVF1061_SERVER2 = ENC2SHBAY7
OVF1061_SERVER2_SERVER_NAME_1 = "tbird16bay7-1"
OVF1061_SERVER2_SERVER_NAME_2 = "TBIRD16BAY7-OS"
...
NAME_PREFIX = 'Synergy-Ring2-OVF1061-'
...
PROFILE2_EG = EG_NAME
PROFILE2_ENC = ENC2
profile1 = {"type": SERVER_PROFILE_TYPE, "name": PROFILE1_NAME,
            ...
            "hideUnusedFlexNics": True, "affinity": "Bay", "macType": "Physical", "wwnType": "Physical", "serialNumberType": "Physical",
...
profile2 = {"type": SERVER_PROFILE_TYPE, "name": PROFILE2_NAME,
            "description": "", "iscsiInitiatorName": None, "iscsiInitiatorNameType": "AutoGenerated",
            "serverHardwareUri": 'SH:' + PROFILE2_SERVER, "enclosureGroupUri": "EG:" + PROFILE2_EG, 'enclosureUri': 'ENC:' + PROFILE2_ENC,
            "hideUnusedFlexNics": True, "affinity": "Bay", "macType": "Physical", "wwnType": "Physical", "serialNumberType": "Physical",
            "connectionSettings": {"connections": []},
            "bootMode": {"manageMode": True, "mode": "UEFI", "pxeBootPolicy": "Auto"}, "boot": {"manageBoot": True, "order": ["HardDisk"]},
            "firmware": {"manageFirmware": False, "firmwareBaselineUri": None, "forceInstallFirmware": False, "firmwareInstallType": None},
            "bios": {"manageBios": False, "overriddenSettings": []},
            "localStorage": {"sasLogicalJBODs": [], "controllers": []}, }
