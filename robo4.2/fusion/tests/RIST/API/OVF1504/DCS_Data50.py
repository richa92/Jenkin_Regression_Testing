"""
OVF1504 SBAC changes for DCS VM
"""
...
credentials_list = [
    ...
    {"userName": LDAP_GRP_USER, "password": LDAP_GRP_USER_PSWD, "authLoginDomain": LDAP_IP},
    {"userName": AD_GRP_USER, "password": AD_GRP_USER_PSWD, "authLoginDomain": "AD_Server"}
]
...
NS1 = 'Net-Set1'
ETH1 = 'dev100'
INTERCONNECT1 = '{}, interconnect 3'.format(ENC1)
LI1 = 'LE_SYNERGY-LIG_POTASH'
FCOE1 = 'FCoE1'
...
enclosure_profile = {"op": "replace", "path": "/name", "value": 'NewEnclosure', "name": ENC1}
...
storage_pool_profile = {"storageSystemUri": SSYS1, "name": SP1, "isManaged": False}

network_set_profiles = [
    {'name': 'Net-Set3', 'type': NETWORK_SET_TYPE, 'networkUris': ['dev100'], 'nativeNetworkUri': None},
    {'name': 'Net-Set4', 'type': NETWORK_SET_TYPE, 'networkUris': ['dev100'], 'nativeNetworkUri': None},
    {'name': 'Net-Set5', 'type': NETWORK_SET_TYPE, 'networkUris': ['dev100'], 'nativeNetworkUri': None}
]

eth_profile = {'name': 'dev100', 'type': ETHERNET_NETWORK_TYPE, 'vlanId': 500, 'purpose': 'General', 'smartLink': False, 'privateNetwork': False, 'connectionTemplateUri': None, 'ethernetNetworkType': 'Tagged'}
