...
...                  OVF691_API_P006_Assign appliance role_Infrastructure_Administrator to the group in Active Directory via service account binding type
...
*** Test Cases ***
OVF691_API_P006_Assign appliance role_Infrastructure_Administrator to the group in Active Directory via service account binding type
    [Documentation]  OVF691_API_P006_Assign appliance role_Infrastructure_Administrator to the group in Active Directory via service account binding type
    Set Log Level           TRACE
