...
...                  OVF691_API_P013_Assign appliance role_Read_Only to the group in Active Directory via service account binding type
...
*** Test Cases ***
OVF691_API_P013_Assign appliance role_Read_Only to the group in Active Directory via service account binding type
    [Documentation]  OVF691_API_P013_Assign appliance role_Read_Only to the group in Active Directory via service account binding type
