...
...                  OVF691_API_P008_Assign appliance role_Network_Administrator to the group in Active Directory via service account binding type
...
*** Test Cases ***
OVF691_API_P008_Assign appliance role_Network_Administrator to the group in Active Directory via service account binding type
    [Documentation]  OVF691_API_P008_Assign appliance role_Network_Administrator to the group in Active Directory via service account binding type
