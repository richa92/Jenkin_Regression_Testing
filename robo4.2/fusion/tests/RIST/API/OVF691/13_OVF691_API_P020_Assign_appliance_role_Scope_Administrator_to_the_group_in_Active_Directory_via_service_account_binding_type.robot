...
...                  OVF691_API_P020_Assign appliance role_Scope_Administrator to the group in Active Directory via service account binding type
...
*** Test Cases ***
OVF691_API_P020_Assign appliance role_Scope_Administrator to the group in Active Directory via service account binding type
    [Documentation]  OVF691_API_P020_Assign appliance role_Scope_Administrator to the group in Active Directory via service account binding type
