...
...                  OVF691_API_P019_Assign appliance role_Scope_operator to the group in Active Directory via service account binding type
...
*** Test Cases ***
OVF691_API_P019_Assign appliance role_Scope_operator to the group in Active Directory via service account binding type
    [Documentation]  OVF691_API_P019_Assign appliance role_Scope_operator to the group in Active Directory via service account binding type
