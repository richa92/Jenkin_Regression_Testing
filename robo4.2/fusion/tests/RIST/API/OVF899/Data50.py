...
# Name prefixes
NAME_PREFIX = 'Synergy-Ring2-OVF899-'
...
pts2_unassign_profile1_create_expected = {
    "type": SERVER_PROFILE_TYPE, "name": PTS2_UNASSIGN_PROFILE1_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS2_UNASSIGN_PROFILE1_SHT,
    "enclosureGroupUri": 'EG:' + PTS2_UNASSIGN_PROFILE1_EG,
    "iscsiInitiatorNameType": "AutoGenerated", "serialNumberType": "Virtual", "macType": "Virtual",
    "wwnType": "Virtual", "affinity": "Bay",
    "connectionSettings": {"connections": []},
    "boot": {"manageBoot": False, "order": []},
...
pts2_unassign_profile2_create_expected = {
    "type": SERVER_PROFILE_TYPE, "name": PTS2_UNASSIGN_PROFILE2_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS2_UNASSIGN_PROFILE2_SHT,
    "enclosureGroupUri": 'EG:' + PTS2_UNASSIGN_PROFILE2_EG,
    "iscsiInitiatorNameType": "AutoGenerated", "serialNumberType": "Virtual", "macType": "Virtual",
    "wwnType": "Virtual", "affinity": "Bay",
    "connectionSettings": {"connections": []},
    "boot": {"manageBoot": False, "order": []},
...
pts2_unassign_profile3_create_expected = {
    "type": SERVER_PROFILE_TYPE, "name": PTS2_UNASSIGN_PROFILE3_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS2_UNASSIGN_PROFILE3_SHT,
    "enclosureGroupUri": 'EG:' + PTS2_UNASSIGN_PROFILE3_EG,
    "iscsiInitiatorNameType": "AutoGenerated", "serialNumberType": "Virtual", "macType": "Virtual",
    "wwnType": "Virtual", "affinity": "Bay",
    "connectionSettings": {"connections": []},
    "boot": {"manageBoot": False, "order": []},
...
pts8_profile1_unassign = {
    "type": SERVER_PROFILE_TYPE, "name": PTS8_PROFILE1_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS8_SPT1_SHT,
...
pts8_profile2_unassign = {
    "type": SERVER_PROFILE_TYPE, "name": PTS8_PROFILE2_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS8_SPT2_SHT,
...
pts8_profile3_unassign = {
    "type": SERVER_PROFILE_TYPE, "name": PTS8_PROFILE3_NAME,
    "serverHardwareUri": None, "serverHardwareTypeUri": 'SHT:' + PTS8_SPT3_SHT,
    "enclosureGroupUri": 'EG:' + PTS8_PROFILE3_EG,
    "serverProfileTemplateUri": "SPT:" + PTS8_SPT3_NAME,
    "iscsiInitiatorNameType": "AutoGenerated", "serialNumberType": "Virtual", "macType": "Virtual",
    "wwnType": "Virtual", "affinity": "Bay",
    "connectionSettings": {"connections": []},
