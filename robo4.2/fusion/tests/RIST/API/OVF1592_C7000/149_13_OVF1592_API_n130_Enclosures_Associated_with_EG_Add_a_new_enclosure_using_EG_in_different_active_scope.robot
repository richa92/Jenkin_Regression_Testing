*** Settings ***
Documentation        Enclosures Associated with EG_Add a new enclosure using  existing EG, they are in the different active scope
...
*** Test Cases ***
Enclosures Associated with EG_Add a new enclosure using  existing EG, they are in the different active scope
  [Documentation]  Enclosures Associated with EG_Add a new enclosure using  existing EG, they are in the different active scope
  log    Enclosures Associated with EG_Add a new enclosure using  existing EG, they are in the different active scope    console=true
  ...
  log   Successfully! Test Case : OVF1592_API_n130 Enclosures Associated with EG_Add a new enclosure using  existing EG, they are in the different active scope    console=true
