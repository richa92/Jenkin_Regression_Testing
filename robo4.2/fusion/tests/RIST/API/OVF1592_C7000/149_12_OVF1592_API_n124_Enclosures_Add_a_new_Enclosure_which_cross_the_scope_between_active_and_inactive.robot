*** Settings ***
Documentation        Enclosures supports SBAC_Add a new Enclosure which cross the scope between active and inactive
...
Enclosures supports SBAC_Add a new Enclosure which is in the inactive scope
  [Documentation]  Enclosures supports SBAC_Add a new Enclosure which cross the scope between active and inactive
  log    Enclosures supports SBAC_Add a new Enclosure which cross the scope between active and inactive    console=true
  ...
  ${resps}=  Add Enclosures from variable Async  ${Add_Encs3}
  ...
  log    Successfully! Test Case : OVF1592_API_n124 Enclosures supports SBAC_Add a new Enclosure which cross the scope between active and inactive    console=true
