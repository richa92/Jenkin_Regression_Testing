*** Settings ***
Documentation        Enclosures Associated with Firmware_Add a new enclosure using existing Firmware which in the inactive scope
...
*** Test Cases ***
Enclosures Associated with Firmware_Add a new enclosure using existing Firmware which in the inactive scope
  [Documentation]  Enclosures Associated with Firmware_Add a new enclosure using existing Firmware which in the inactive scope
  log    Enclosures Associated with Firmware_Add a new enclosure using existing Firmware which in the inactive scope    console=true
  ...
  log    Successfully! Test Case : OVF1592_API_n133 Enclosures Associated with Firmware_Add a new enclosure using existing FIrmware, they are in the different active scope    console=true
