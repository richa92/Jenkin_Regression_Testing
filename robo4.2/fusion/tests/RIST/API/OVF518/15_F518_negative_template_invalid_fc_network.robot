*** Settings ***
Documentation   Negative tests: Attempt to create a non-VC connection with a
...             fibre channel network that is not fabric attach.
...
TS0 Attempt to Create the Template
    Run Negative Task  ${negative_template_invalid_fc_network_task}
