...
SERVER_HARDWARE_TYPE1 = 'SY 660 Gen9:3:HP Synergy 3820C 10/20Gb CNA'

STOREVIRTUAL_SLPT_STORAGE_SYSTEM = STOREVIRTUAL_SLPT_DHCP_NAME
STOREVIRTUAL_MLPT_STORAGE_SYSTEM = STOREVIRTUAL_MLPT_NAME
STORESERV_STORAGE_SYSTEM = STORESERV1_NAME
STORESERV_STORAGE_POOL = STORESERV1_POOL2
...
STOREVIRTUAL_VOLUME_TEMPLATE_NAME5 = 'OVF959-StoreVirtual-RAID-10_1-Full-Private'
STOREVIRTUAL_VOLUME_TEMPLATE_NAME6 = 'OVF959-StoreVirtual-RAID-10_2-Full-Private'
...
ts0_verify_volume1_create_server_profile2 = {
    ...
    "volumeTemplateUri": "SVT:" + STOREVIRTUAL_ROOT_VOLUME_TEMPLATE,
}
...
ts0_verify_volume1_create_server_profile3 = {
    ...
    "volumeTemplateUri": "ROOT:" + STOREVIRTUAL_SLPT_STORAGE_SYSTEM,
}
...
ts0_verify_volume1_create_server_profile4 = {
    ...
    "volumeTemplateUri": "ROOT:" + STOREVIRTUAL_MLPT_STORAGE_SYSTEM,
}
...
ts0_verify_volume1_create_server_profile5 = {
    ...
    "volumeTemplateUri": "ROOT:" + STORESERV_STORAGE_POOL,
}
...
ts1_verify_volume1_create_server_profile4 = {
    "category": "storage-volumes",
    "description": "Private volume from ROOT template",
    "deviceSpecificAttributes": {
        "dataProtectionLevel": "NetworkRaid10Mirror3Way",
...
ts1_verify_volume2_edit_server_profile1 = {
    ...
    "type": STORAGE_VOLUME_TYPE,
    "uri": STORESERV_VOLUME_TEMPLATE_NAME1,
    "volumeTemplateUri": "SVT:" + STORESERV_ROOT_VOLUME_TEMPLATE,
}

ts1_verify_volume1_create_server_profile3 = {
    "category": "storage-volumes",
    "description": "Private volume from ROOT template",
    "deviceSpecificAttributes": {
        "dataProtectionLevel": "NetworkRaid5SingleParity",
...
ts1_verify_volume2_edit_server_profile4 = {
    "category": "storage-volumes",
    "description": "Private volume from ROOT template",
    "deviceSpecificAttributes": {
        "dataProtectionLevel": "NetworkRaid0None",
...
ts1_verify_volume1_create_server_profile5 = {
    "category": "storage-volumes",
    "description": "Private volume from ROOT template",
    "deviceVolumeName": PROFILE5_VOLUME1_NAME,
    "isPermanent": False,
...
ts1_verify_volumes_after_edit = [
    ...
    ts0_verify_volume1_create_server_profile2.copy(),
    ts0_verify_volume2_edit_server_profile2.copy(),
    ts1_verify_volume1_create_server_profile3.copy(),
    ts1_verify_volume2_edit_server_profile3.copy(),
    ts1_verify_volume1_create_server_profile4.copy(),
    ts1_verify_volume2_edit_server_profile4.copy(),
]

ts1_verify_nonpermanent_volumes_after_edit = [
    ts1_verify_volume1_create_server_profile5.copy(),
]
