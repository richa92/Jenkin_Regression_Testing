...
# Logical JBODs
ljbs = [{"name": "ljb1-sas", "type": SAS_LOGICAL_JBOD_TYPE, "description": "",
         "sasLogicalInterconnectUri": "LE1-SASLIG1-2", "initialScopeUris": [],
         "driveEnclosureUris": ['0000A66102, bay 1'], "numPhysicalDrives": 1, "minSizeGB": "600",
         "maxSizeGB": "600", "driveTechnology": {"deviceInterface": "SAS", "driveMedia": "HDD"},
         "eraseData": False},
        {"name": "ljb1-sata", "type": SAS_LOGICAL_JBOD_TYPE, "description": "",
         "sasLogicalInterconnectUri": "LE1-SASLIG1-2", "initialScopeUris": [],
         "driveEnclosureUris": ['0000A66102, bay 1'], "numPhysicalDrives": 1, "minSizeGB": "200",
         "maxSizeGB": "200", "driveTechnology": {"deviceInterface": "SATA", "driveMedia": "SSD"},
         "eraseData": False}, ]
name_change_ljb = {"name": "ljb1-sas-name-changed", "value": "ljb1-sas-name-changed2"}
