...
*** Test Cases ***
F1236APIp003 Update Gen9 server firmware using Firmware only
    Update server firmware when create profile   ${createGen9Profiles}  ${SNAP6SPP}     ${True}
    Validate Profile Firmware Version   ${createGen9Profiles}   ${SNAP6SPP}
