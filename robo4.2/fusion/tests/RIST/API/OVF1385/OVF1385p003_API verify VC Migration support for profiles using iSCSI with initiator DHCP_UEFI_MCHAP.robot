...
*** Test Cases ***
OVF1385p003_API verify VC Migration support for profiles using iSCSI with initiator DHCP_UEFI_MCHAP
    ...
    ${backupFile}=                Get From Dictionary    ${vc_backup_file_uefi_mchap}    ${Enclosure}
