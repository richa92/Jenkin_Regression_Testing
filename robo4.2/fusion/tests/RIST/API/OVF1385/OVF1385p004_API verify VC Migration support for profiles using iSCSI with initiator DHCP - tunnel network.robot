...
*** Test Cases ***
OVF1385p004 - API verify VC Migration support for profiles using iSCSI with initiator DHCP - tunnel network
    ...
    ${backupFile}=                Get From Dictionary    ${vc_backup_file_uefi_tunnel}    ${Enclosure}
    ...
    ${iscsi_exp} =                Get From Dictionary    ${expect_iscsi_info_mchap}   iscsi
    :FOR                          ${sp}    IN    @{spkeys}
