...
ligs = [
    {'name': LIG_NAME,
     ...
     'uplinkSets': [
         ...
         uplink_sets['FCoE-path1'].copy(),
         uplink_sets['FCoE-path2'].copy(),
     ],
     },
    {
...
egs = [{'name': EG_NAME,
        ...
        [
            {"interconnectBay": 1, "enclosureIndex": 2, "logicalInterconnectGroupUri": "LIG:" + CARBON_LIG_NAME},
            {"interconnectBay": 4, "enclosureIndex": 2, "logicalInterconnectGroupUri": "LIG:" + CARBON_LIG_NAME},
            {"interconnectBay": 3,
