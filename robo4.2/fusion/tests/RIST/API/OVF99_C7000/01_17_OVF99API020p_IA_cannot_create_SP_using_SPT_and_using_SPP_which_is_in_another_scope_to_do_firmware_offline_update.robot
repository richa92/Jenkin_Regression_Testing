...
*** Test Cases ***
IA cannot create SP using SPT and using SPP which is in another scope to do firmware offline update
    set log level    TRACE
    ...
    ${resp} =    Add Server Profile From SPT With Firmware and Scopes   ${createBLProfileFromSPT}    ${ia_anoher_scope}  ${Gen10Firmware}   ${offline_type}  ${sp_param}
