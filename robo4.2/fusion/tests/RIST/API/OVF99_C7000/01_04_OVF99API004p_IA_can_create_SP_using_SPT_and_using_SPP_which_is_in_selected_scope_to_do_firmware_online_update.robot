...
*** Test Cases ***
IA can create SP using SPT and using SPP which is in selected scope to do firmware online update
    set log level    TRACE
    ...
    ${resp} =    Add Server Profile With Spcopes   ${createBLProfileFromSPT}    ${ia_user_scopes}
    ...
    Run Keyword And Ignore Error    power off server    ${SH3}    PressAndHold