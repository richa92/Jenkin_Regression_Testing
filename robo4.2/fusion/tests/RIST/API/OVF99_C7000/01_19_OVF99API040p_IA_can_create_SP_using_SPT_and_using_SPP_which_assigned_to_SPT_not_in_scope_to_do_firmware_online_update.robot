...
*** Test Cases ***
IA can create SP using SPT and using SPP which is assigned to SPT and not in scope to do firmware online update
    set log level    TRACE
    ...
    log      get server profile template....    console=true
