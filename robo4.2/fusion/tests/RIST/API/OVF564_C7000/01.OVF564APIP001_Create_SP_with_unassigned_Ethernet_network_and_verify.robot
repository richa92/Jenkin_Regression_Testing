*** Settings ***
Documentation        OVF564 Create SP with Ethernet function type and unassigned network
...
Create SP with Ethernet function type and unassigned network
    ...
    ${resps} =    Add Server Profiles from variable    ${createProfileP001}

    Validate Server Profile Applied Successfully    ${resps}

    ${rc} =  Validate Server Profiles Connections Network Applied  ${createProfileP001}
