*** Settings ***
Documentation        Verify supportive SHT Gen7 Can Be Imported Using Correct VC Migration Payload
...
Verify supportive SHT Gen7 Can Be Imported Using Correct VC Migration Payload
    ...
    Length Should Be              ${shts['members']}  8
    ...
    Length Should Be              ${sps['members']}  6
