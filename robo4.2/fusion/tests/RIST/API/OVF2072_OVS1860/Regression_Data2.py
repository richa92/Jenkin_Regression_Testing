...
generate_appliance_cert_commands = {'part1': '{0}/{1}'.format(RESULT_DIR, CA1_ORIG_PEM_CRL_FILE),
                                    'part2': '{0}/{1}'.format(RESULT_DIR, CA1_ORIG_DER_CRL_FILE),
                                    'part3': '{0}/{1}'.format(RESULT_DIR, CA1_NEW_DER_CRL_FILE),
                                    'part4': '{0}/{1}'.format(RESULT_DIR, CA1_NEW_PEM_CRL_FILE),
                                    'part5': '{0}/{1}'.format(RESULT_DIR, CA1_MAL_CRL_FILE),
                                    'part6': '{0}/{1}'.format(RESULT_DIR, CA2_ORIG_DER_CRL_FILE),
                                    'part7': '{0}/{1}'.format(RESULT_DIR, CA2_ORIG_PEM_CRL_FILE),
                                    'part8': '{0}/{1}'.format(RESULT_DIR, CA2_NEW_DER_CRL_FILE),
                                    'part9': '{0}/{1}'.format(RESULT_DIR, CA2_NEW_PEM_CRL_FILE)
                                    }
