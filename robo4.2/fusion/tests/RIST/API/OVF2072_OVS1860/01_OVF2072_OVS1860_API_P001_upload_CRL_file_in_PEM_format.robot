*** Settings ***
Documentation        OVF2072_OVS1860_API_P001_upload CRL file in PEM format
...
*** Test Cases ***
OVF2072_OVS1860_API_P001_upload CRL file in PEM format
    [Documentation]  OVF2072_OVS1860_API_P001_upload CRL file in PEM format
    ...
    Log    \n-Upload CRL file in PEM format...    console=true
