*** Settings ***
Documentation        OVF2072_OVS1860_API_N002_upload CRL file signed by other CA
...
*** Test Cases ***
OVF2072_OVS1860_API_N002_upload CRL file signed by other CA
    [Documentation]  OVF2072_OVS1860_API_N002_upload CRL file signed by other CA
    ...
    Log    \n-Uploading CRL file signed by other CA...    console=true
    ${localfile} =  Join Path    ${CURDIR}    \    ${CA2_NEW_DER_CRL_FILE}
    ...
    Should Contain                    ${resp['details']}  ${ERR_MSG_SIGNED_DETIAL}
    Should Contain                    ${resp['recommendedActions']}  ${ERR_MSG_SIGNED_RECOMMAND}
