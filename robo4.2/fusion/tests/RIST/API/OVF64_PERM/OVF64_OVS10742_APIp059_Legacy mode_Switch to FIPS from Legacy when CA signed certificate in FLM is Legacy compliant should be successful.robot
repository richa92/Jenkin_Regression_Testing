...
*** Test Cases ***
Legacy mode_Switch to FIPS from Legacy when CA signed certificate in FLM is Legacy compliant should be successful
    ...
    Install CA Signed Certificate on FLM    ${IssuerIP}    ${ssh_credentials}    ${signature_algorithm_sha1}
    Verify CA Signed Certificate on FLM    LEGACY
    Wait For ALL Enclosures Complete Refresh
    All Enclosures Status Should Be OK or Warning
