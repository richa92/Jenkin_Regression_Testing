*** Settings ***
Documentation        OVF2422 - Disable certificate validation and validate revocation checking down
...
*** Test Cases ***
As an Administrator want to validate certificate revocation checking down after enable certificate validation
    ...
    Wait For Task2    ${resp}    120    5    PASS=Error    errorMessage=Cert_Revoked_Error
