*** Settings ***
Documentation        OVF2422_OVS18519_Legacy_mode_should_import_FIPS_compatible_certificate
...
*** Test Cases ***
OVF2422_OVS18519_Legacy_mode_should_import_FIPS_compatible_cert
    [Documentation]  OVF2422_OVS18519_Legacy_mode_should_import_FIPS_compatible_certificate
    Log  \nrecognize the security-mode...   console=True
    Pass Execution If  '${SECURITY_MODE}' != 'LEGACY'   Found this is not LEGACY mode,so skip test
    ...
    Log    post /rest/certificate/servers import fips compatible leaf cert with ...    console=True
