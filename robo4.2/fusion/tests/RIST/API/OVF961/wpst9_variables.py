...
SERVER_HARDWARE_TYPE1 = 'SHT:BL460c Gen9:Flb1:HP FlexFabric 10Gb 2-port 536FLB Adapter:1:HP FlexFabric 10Gb 2-port 534M Adapter:2:HP LPe1605 16Gb FC HBA for BladeSystem c-Class'
...
profile2_spt_non_compliant = {
    ...
    "compliance-preview": {
        ...
        "manualUpdates": [
            ...
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE2_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\.",
...
profile3_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Connection on FlexibleLOM \(Flb\) \d:\d-b will have its boot changed to not bootable\."
        ],
        "manualUpdates": [
...
profile4_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Change network of connection on FlexibleLOM \(Flb\) \d:\d-b to {\"name\":\"network-untagged\", \"uri\":\"\/rest\/ethernet-networks\/.*\"}\.",
...
profile5_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Connection on Mezzanine \(Mezz\) \d:\d-b will have its boot changed to not bootable\."
        ],
        "manualUpdates": [
