...
STOREVIRTUAL_VOLUME_TEMPLATE_NAME5 = 'OVF961-StoreVirtual-RAID-10+1-Full-Private'
STOREVIRTUAL_VOLUME_TEMPLATE_NAME6 = 'OVF961-StoreVirtual-RAID-10+2-Full-Private'
...
STOREVIRTUAL_VOLUME_TEMPLATE_NAME11 = 'OVF961-StoreVirtual-RAID-10+1-Full-Shared'
STOREVIRTUAL_VOLUME_TEMPLATE_NAME12 = 'OVF961-StoreVirtual-RAID-10+2-Full-Shared'
...
STOREVIRTUAL_VOLUME_TEMPLATE_NAME17 = 'OVF961-StoreVirtual-RAID-10+1-Thin-Private'
STOREVIRTUAL_VOLUME_TEMPLATE_NAME18 = 'OVF961-StoreVirtual-RAID-10+2-Thin-Private'
...
STOREVIRTUAL_VOLUME_TEMPLATE_NAME23 = 'OVF961-StoreVirtual-RAID-10+1-Thin-Shared'
STOREVIRTUAL_VOLUME_TEMPLATE_NAME24 = 'OVF961-StoreVirtual-RAID-10+2-Thin-Shared'
...
STOREVIRTUAL_EXISTING_PRIVATE_VOLUME1 = "tbird15-bay7-rhel-dhcp-managed-volume"
STOREVIRTUAL_EXISTING_PRIVATE_VOLUME2 = "tbird16-bay1-rhel-dhcp-managed-volume"
...
profile1_sp_non_compliant = {
    ...
    "compliance-preview": {
        ...
        "automaticUpdates": [],
        "manualUpdates": [
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
        ],
    }
}
...
profile2_sp_non_compliant = {
    ...
    "compliance-preview": {
        ...
        "automaticUpdates": [],
        "manualUpdates": [
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\.",
            "REGEX:Attachment id \"\d\", volume {\"name\":\".*\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the data protection level setting in the template\."
        ],
    }
}
...
profile1_spt_non_compliant = {
    ...
    "compliance-preview": {
        ...
        "automaticUpdates": [],
        "manualUpdates": [
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the data protection level setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the volume template specified in the profile template\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + STORESERV_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + STORESERV_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + STORESERV_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + STORESERV_VOLUME_TEMPLATE_NAME1 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the volume template specified in the profile template\.",
        ],
    }
}
...
profile2_spt_non_compliant = {
    ...
    "compliance-preview": {
        ...
        "automaticUpdates": [],
        "manualUpdates": [
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE2_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE2_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE2_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the data protection level setting in the template\."
        ],
    }
}
...
profile3_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Change boot for connection on Mezzanine \(Mezz\) \d:\d-a to not bootable\."
        ],
        "manualUpdates": [
            "REGEX:The boot setting for attachment id \"2\" for volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME15 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the associated template setting\.  Change either the profile or the template setting accordingly\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + STOREVIRTUAL_VOLUME_TEMPLATE_NAME15 + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the volume template specified in the profile template\."
        ],
    }
}
...
profile4_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Change network of connection on Mezzanine \(Mezz\) \d:\d-a to {\"name\":\"network-untagged\", \"uri\":\"\/rest\/ethernet-networks\/.*\"}\.",
            "REGEX:Remove the storage path using connection \"1\" from attachment id \"2\" for volume {\"name\":\"" + PROFILE4_VOLUME2_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} due to network change in the associated connection\.",
            "REGEX:Change LUN of volume attachment for {\"name\":\"" + PROFILE4_VOLUME2_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} to Auto\.",
        ],
        "manualUpdates": [
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE4_VOLUME1_NAME + "\", \"uri\":\"/rest/storage-volumes/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE4_VOLUME1_NAME + "\", \"uri\":\"/rest/storage-volumes/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE4_VOLUME1_NAME + "\", \"uri\":\"/rest/storage-volumes/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE4_VOLUME1_NAME + "\", \"uri\":\"/rest/storage-volumes/.*\"} does not match the data protection level setting in the template\.",
            "REGEX:Attachment id \"2\", volume {\"name\":\"" + PROFILE4_VOLUME2_NAME + "\", \"uri\":\"/rest/storage-volumes/.*\"} does not match the volume template specified in the profile template\.",
            "REGEX:Configure storage path\(s\) for attachment id \"2\" to volume {\"name\":\"" + PROFILE4_VOLUME2_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} to match the template configuration\.",
        ],
    }
}
...
profile5_spt_non_compliant = {
    ...
    "compliance-preview": {
        "type": "ServerProfileCompliancePreviewV1",
        "automaticUpdates": [
            "REGEX:Change boot for connection on Mezzanine \(Mezz\) \d:\d-b to not bootable\."
        ],
        "manualUpdates": [
            "REGEX:The boot setting for attachment id \"1\" for volume {\"name\":\"" + PROFILE5_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the associated template setting\.  Change either the profile or the template setting accordingly\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE5_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the sharable setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE5_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the provisioning setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE5_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} does not match the permanent setting in the template\.",
            "REGEX:Attachment id \"1\", volume {\"name\":\"" + PROFILE5_VOLUME1_NAME + "\", \"uri\":\"\/rest\/storage-volumes\/.*\"} must be at least the capacity of the volume as defined in the server profile template\. The capacity of the volume can be corrected on the volumes page.  Alternatively, the volumes defined capacity can be corrected on the server profile template and volume template \(if present\) instead of changing the volumes capacity\."
        ],
    }
}
