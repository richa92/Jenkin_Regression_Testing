*** Settings ***
Documentation        OVF167 - n010_SO_Role_Group_CanNot_Create_Scope
...
*** Test Cases ***
OVF167_n010_SO_Role_Group_CanNot_Create_Scope
    [Documentation]   n010_SO_Role_Group_CanNot_Create_Scope
    Log To Console    \n- Test Case: n010_SO_Role_Group_CanNot_Create_Scope
    ...
    Log To Console    \n- Test Case: Successfully: n010_SO_Role_Group_CanNot_Create_Scope
