...
scaleuser_credentials = {'userName': 'scaleuser', 'password': 'hpvse123'}

proxy_server = [{'type': 'ProxyServer', 'server': '10.0.0.94', 'port': '1080'}]

ENCLOSURE = [{'serialNumber': 'CN75440445', 'scaleName': 'r8-1'},
             {'serialNumber': 'CN754406XJ', 'scaleName': 'r8-2'},
             {'serialNumber': 'CN7515048G', 'scaleName': 'r8-3'},
             {'serialNumber': 'CN751500ZM', 'scaleName': 'r9-1'},
             {'serialNumber': 'CN7516060R', 'scaleName': 'r9-2'},
             {'serialNumber': 'CN751500Z7', 'scaleName': 'r9-3'},
             {'serialNumber': 'CN7544044M', 'scaleName': 'r10-1'},
             {'serialNumber': 'CN754406X9', 'scaleName': 'r10-2'},
             {'serialNumber': 'CN7545048K', 'scaleName': 'r10-3'},
             {'serialNumber': 'CN7515048L', 'scaleName': 'r11-1'},
             {'serialNumber': 'CN751300N8', 'scaleName': 'r11-2'},
             {'serialNumber': 'CN751605ZZ', 'scaleName': 'r11-3'},
             {'serialNumber': 'CN754406X0', 'scaleName': 'r12-1'},
             {'serialNumber': 'CN7544023R', 'scaleName': 'r12-2'},
             {'serialNumber': 'CN754406X3', 'scaleName': 'r12-3'},
             {'serialNumber': 'CN751500ZL', 'scaleName': 'r13-1'},
             {'serialNumber': 'CN751605ZY', 'scaleName': 'r13-2'},
             {'serialNumber': 'CN7515048H', 'scaleName': 'r13-3'},
             {'serialNumber': 'CN75120D6V', 'scaleName': 'r14-1'},
             {'serialNumber': 'CN750160YQ', 'scaleName': 'r14-2'},
             {'serialNumber': 'CN750160YM', 'scaleName': 'r14-3'}]
...
active_directory = [{'name': 'domain1002.net', 'baseDN': 'dc=dom1002,dc=net', 'user': 'Administrator', 'password': 'Cosmos123',
                     'directoryServerIpAddress': '10.2.0.11', 'directoryServerSSLPortNumber': '636',
...
ligs = [{'name': 'potash-eth', 'uplinkSets': [], 'enclosureIndexes': [1, 2, 3], 'interconnectBaySet': 3, 'redundancyType': 'HighlyAvailable',
        ...
        {'name': 'potash-fc', 'uplinkSets': [], 'enclosureIndexes': [1, 2, 3], 'interconnectBaySet': 2, 'redundancyType': 'HighlyAvailable',
...
enclosure_groups = [{'name': 'r8-iscsi-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 1, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 2, 'lig': 'LIG:potash-iscsi'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 4, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 5, 'lig': 'LIG:potash-iscsi'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r9-fcoe-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 2, 'lig': 'LIG:potash-fcoe'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 5, 'lig': 'LIG:potash-fcoe'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r10-fc-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 2, 'lig': 'LIG:potash-fc'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 5, 'lig': 'LIG:potash-fc'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r11-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 1, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 2, 'lig': 'LIG:carbon-r11'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 4, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 5, 'lig': 'LIG:carbon-r11'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r12-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 1, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 2, 'lig': 'LIG:carbon-r12'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 4, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 5, 'lig': 'LIG:carbon-r12'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r13-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 1, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 2, 'lig': 'LIG:carbon-r13'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 4, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 5, 'lig': 'LIG:carbon-r13'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]},
                    {'name': 'r14-test', 'enclosureCount': 3, 'ipAddressingMode': 'DHCP',
                     'interconnectBayMappings': [{'bay': 1, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 2, 'lig': 'LIG:carbon-r14'},
                                                 {'bay': 3, 'lig': 'LIG:potash-eth'},
                                                 {'bay': 4, 'lig': 'SASLIG:natasha'},
                                                 {'bay': 5, 'lig': 'LIG:carbon-r14'},
                                                 {'bay': 6, 'lig': 'LIG:potash-eth'}]}]
...
# update_ligs = [{'name': 'potash-eth-fc', 'uplinkSets': [uplink_sets['uplink'].copy(), uplink_sets['eth'].copy(), uplink_sets['fc-a'].copy(), uplink_sets['fc-b'].copy()],
#                'enclosureIndexes': [1, 2, 3], 'interconnectBaySet': 3, 'redundancyType': 'HighlyAvailable',
#                'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
#                                            {'bay': 6, 'enclosure': 1, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 1},
#                                            {'bay': 3, 'enclosure': 2, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 2},
#                                            {'bay': 6, 'enclosure': 2, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 2},
#                                            {'bay': 3, 'enclosure': 3, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 3},
#                                            {'bay': 6, 'enclosure': 3, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 3}]},
#               {'name': 'potash-fcoe-fc', 'uplinkSets': [uplink_sets['fc-c'].copy(), uplink_sets['fc-d'].copy(), uplink_sets['fcoe-a'].copy(), uplink_sets['fcoe-b'].copy()],
#                'enclosureIndexes': [1, 2, 3], 'interconnectBaySet': 2, 'redundancyType': 'HighlyAvailable',
#                'interconnectMapTemplate': [{'bay': 2, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
#                                            {'bay': 5, 'enclosure': 1, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 1},
#                                            {'bay': 2, 'enclosure': 2, 'type': 'Synergy 20Gb Interconnect Link Module', 'enclosureIndex': 2},
#                                            {'bay': 5, 'enclosure': 2, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 2},
...
remotesupport_edit = [{'op': 'replace', 'path': '/configuration/enableRemoteSupport', 'value': True},
                      ...
                      {'op': 'add', 'path': '/sites/default', 'value': {'name': 'DEFAULT SITE', 'streetAddress1': 'Compaq Center Dr',
                                                                        'streetAddress2': '', 'city': 'Houston', 'provinceState': 'TX', 'postalCode': '', 'timeZone': 'US/Central',
                                                                        'countryCode': 'US', 'type': 'Site', 'default': True}},
                      {'op': 'add', 'path': '/contacts', 'value': {'contactKey': 'default', 'firstName': 'FFF', 'lastName': 'LLL',
                                                                   'email': 'fff.lll@hpe.com', 'primaryPhone': '8884442222', 'alternatePhone': '', 'notes': '', 'language': 'en',
                                                                   'default': True, 'type': 'Contact'}}]
