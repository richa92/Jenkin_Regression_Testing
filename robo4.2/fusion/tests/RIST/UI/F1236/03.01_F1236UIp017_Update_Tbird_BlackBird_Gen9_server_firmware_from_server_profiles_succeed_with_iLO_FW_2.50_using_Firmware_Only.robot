...
*** Test Cases ***
F1236UIp017  Update Tbird BlackBird Gen9 server firmware from server profiles succeed with iLO FW 2.50 using Firmware Only
    Update Server ILO Firmware      ${BB250Server}
    ${rc} =   Fusion UI Create Server Profile      @{TestData.BBProfile}
