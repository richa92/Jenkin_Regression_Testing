...
As an Administrator I want to take backup of the server profile
    ${rc}                               Fusion UI Create Server Profile                             @{TestData.F221UI086.Create}
    Should Be True                      ${rc}   msg=Failed to create server profile

    ${rc}                               Fusion UI Copy Server Profile                               @{TestData.F221UI086.Copy}
    Should Be True                      ${rc}   msg=Failed to take backup of the server profile

    Fusion UI Delete Server Profile By Name                                 ${TestData.F221UI086.Delete[0].name}