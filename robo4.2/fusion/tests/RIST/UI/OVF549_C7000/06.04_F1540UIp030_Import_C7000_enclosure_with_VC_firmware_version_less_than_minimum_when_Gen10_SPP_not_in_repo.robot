...
*** Test Cases ***
F1540UIp030 – Import C7000 enclosure with VC firmware version less than minimum when Gen10 SPP not in repo(Error message and resulotion should be shown)
    ...
    ${rc}   Fusion UI Validate Enclosure Sub Task      @{TestData.ValidateVCUpdateError}
