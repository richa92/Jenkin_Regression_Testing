...
*** Test Cases ***
F1540UIp016 – Import C7000 enclosure with VC firmware version higher than minimum when and select Gen10 SPP(Firmware should be update unless higher than SPP)
    ...
    ${rc}   Fusion UI Validate Enclosure Sub Task      @{TestData.ValidateVCnotUpdate}
