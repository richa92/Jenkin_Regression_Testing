...
*** Test Cases ***
F1540UIp032 – Import Gen8 DL with iLO version less than minimum when Gen10 SPP not in repo(Error message and resulotion should be shown)
    Log to console and logfile  \nTest to downgrade DL ILO firmware and add it to appliance
    Reset iLO and Update Server ILO Firmware      ${G8DLServer}
    ${msg} =   Run Keyword and Expect Error   *    Fusion UI Add Server Hardware   @{TestData.Gen8DLServers}
