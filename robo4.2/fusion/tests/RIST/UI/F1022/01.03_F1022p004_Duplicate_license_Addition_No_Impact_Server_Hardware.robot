...
*** Test Cases ***
Validate duplicate license addition does not impact server hardware
    ${ret} =  Fusion Ui Validate Error When Adding Invalid Or Duplicated Fc Licenses   @{TestData.duplicated_licenses}
