...
*** Test Cases ***
F353p004_Change_SHT_Between_BlackBirds
    ...
    ${Result} =      Fusion UI Edit Server Profile   @{TestData.F353P003.Edit_blackbird1}
    should be true   ${Result}   msg=Failed to edit Server Profiles
    ${Result} =      Fusion UI Verify Server Profile Advanced Info   @{TestData.F353P003.Verify_blackbird1}
    should be true   ${Result}    msg=Failed to verify Server Profile Advanced Info
    ${Result} =      Fusion UI Verify Server Profile General Info    @{TestData.F353P003.Verify_blackbird1}
    should be true   ${Result}    msg=Failed to verify Server Profile from General Info
