...
*** Test Cases ***
F85p0020- check SH ilo reset when power is on in configured status
     ...
     ${Result} =    Fusion UI Power On Server Hardware   @{TestData.ResetIlo}
     should be true            ${Result}    msg=Failed to power on server hardware
