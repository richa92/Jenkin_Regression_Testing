...
Suite Setup       Precondition Setup For F85
Suite Teardown    Clear F85 Server Profiles
...
*** Keywords ***
Precondition Setup For F85
    Set Log Level	TRACE
    Log To Console And Logfile      \nPrepare LIG env for F85
