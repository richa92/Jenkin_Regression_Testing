...
Edit the server profile to Remove the Primary connection path in Connection section
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F221P054.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F221P054.Edit}
