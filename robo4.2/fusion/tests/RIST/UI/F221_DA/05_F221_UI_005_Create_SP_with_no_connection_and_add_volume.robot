...
Create SP with no connections and add volumes
    ${expectedErrorMessage}=  catenate  ${nonStoragePathSpecifiedErrMsgPart1}   ${TestData.F221UI005.Volname}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}  Fusion UI Create Server Profile     @{TestData.F221UI005.Create}
