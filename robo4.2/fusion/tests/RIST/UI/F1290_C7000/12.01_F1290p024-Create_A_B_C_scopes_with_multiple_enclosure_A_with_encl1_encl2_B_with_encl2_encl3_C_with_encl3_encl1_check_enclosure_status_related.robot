...
*** Test Cases ***
Create A/B/C scopes, with multiple enclosure, A with enclosure1&enclsoure2, B with enclosure2&enclosure3, C with enclosure3&enclosure1, check enclosure status related
