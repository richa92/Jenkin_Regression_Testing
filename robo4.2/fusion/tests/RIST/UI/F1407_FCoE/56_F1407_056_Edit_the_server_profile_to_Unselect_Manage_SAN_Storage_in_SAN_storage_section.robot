...
Edit the server profile to Unselect "Manage SAN Storage" in SAN storage section
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1407P056.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1407P056.Edit}