...
Edit the server profile to Change the Boot parameter - Primary to Secondary
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1407P049.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1407P049.Edit}
