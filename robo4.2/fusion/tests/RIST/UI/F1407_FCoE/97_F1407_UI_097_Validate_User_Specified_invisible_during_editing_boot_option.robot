...
Validation of user specified invisible during editing boot option
    ${rc}                                   Fusion UI Create Server Profile                                 @{TestData.F1407UI097.Create}
    Should Be True                          ${rc}   msg=Failed to Create Server Profile

    ${rc}                                   Fusion UI Validate User Specified Invisible On Edit Connection Dialog                     @{TestData.F1407UI097.Edit}
