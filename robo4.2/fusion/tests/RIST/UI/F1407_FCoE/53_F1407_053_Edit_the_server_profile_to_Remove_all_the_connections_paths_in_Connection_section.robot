...
Edit the server profile to Remove all the connections paths in Connection section
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1407P053.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1407P053.Edit}