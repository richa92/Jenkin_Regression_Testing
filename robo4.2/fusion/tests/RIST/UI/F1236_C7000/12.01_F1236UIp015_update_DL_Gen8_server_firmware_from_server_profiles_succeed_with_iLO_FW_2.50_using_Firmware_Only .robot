...
*** Test Cases ***
F1236UIp015  update DL Gen8 server firmware from server profiles succeed with iLO FW 2.50 using Firmware Only
    Update Server ILO Firmware      ${GEN8DL250Server}
    ${rc} =   Fusion UI Create Server Profile      @{TestData.GEN8DLProfile}
