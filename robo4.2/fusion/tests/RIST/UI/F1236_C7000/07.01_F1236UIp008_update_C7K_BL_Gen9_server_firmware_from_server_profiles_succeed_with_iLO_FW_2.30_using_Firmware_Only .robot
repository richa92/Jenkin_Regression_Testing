...
*** Test Cases ***
F1236UIp008  update C7K BL Gen9 server firmware from server profiles succeed with iLO FW 2.30 using Firmware Only
    Update Server ILO Firmware      ${GEN9BL230Server}
