...
*** Test Cases ***
F1236UIp016  update DL Gen9 server firmware from server profiles succeed with iLO FW 2.50 using Firmware Only
    Update Server ILO Firmware      ${GEN9DL250Server}
