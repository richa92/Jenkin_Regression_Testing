...
*** Test Cases ***
F1236UIp004  update DL Gen9 server firmware from server profiles succeed with iLO FW 2.40 using Firmware Only
    Update Server ILO Firmware      ${GEN9DL240Server}
