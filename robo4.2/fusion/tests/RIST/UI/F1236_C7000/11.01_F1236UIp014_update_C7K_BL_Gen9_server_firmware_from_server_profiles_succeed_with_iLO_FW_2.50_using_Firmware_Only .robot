...
*** Test Cases ***
F1236UIp014  update C7K BL Gen9 server firmware from server profiles succeed with iLO FW 2.50 using Firmware Only
    Update Server ILO Firmware      ${GEN9BL250Server}
