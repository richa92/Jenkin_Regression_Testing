...
*** Test Cases ***
F1236UIp007  update C7K BL Gen8 server firmware from server profiles succeed with iLO FW 2.30 using Firmware Only
    Update Server ILO Firmware      ${GEN8BL230Server}
