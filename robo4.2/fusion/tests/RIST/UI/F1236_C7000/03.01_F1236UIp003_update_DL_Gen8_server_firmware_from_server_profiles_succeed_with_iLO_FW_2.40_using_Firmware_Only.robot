...
*** Test Cases ***
F1236UIp003  update DL Gen8 server firmware from server profiles succeed with iLO FW 2.40 using Firmware Only
    Update Server ILO Firmware      ${GEN8DL240Server}
