...
*** Test Cases ***
F1236UIp009  update DL Gen8 server firmware from server profiles succeed with iLO FW 2.30 using Firmware Only
    Update Server ILO Firmware      ${GEN8DL230Server}
