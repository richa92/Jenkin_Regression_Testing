...
*** Test Cases ***
F1236UIp001  update C7K BL Gen8 server firmware from server profiles succeed with iLO FW 2.40 using Firmware Only
    Update Server ILO Firmware      ${GEN8BL240Server}
