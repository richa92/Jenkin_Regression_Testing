...
*** Test Cases ***
F1236UIp002  update C7K BL Gen9 server firmware from server profiles succeed with iLO FW 2.40 using Firmware Only
    Update Server ILO Firmware      ${GEN9BL240Server}
    ${rc} =   Fusion UI Create Server Profile      @{TestData.GEN9BLProfile}
