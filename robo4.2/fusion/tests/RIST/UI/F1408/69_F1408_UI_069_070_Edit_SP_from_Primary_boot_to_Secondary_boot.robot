...
Edit SP from Primary boot to Secondary boot
    ${rc}                               Fusion UI Create Server Profile                 @{TestData.F1408UI069.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}  Fusion UI Edit Server Profile     @{TestData.F1408UI069.Edit}
