...
Edit the server profile to Remove Primary boot connection for Managed volume and Add new connection, select Primary boot and Use Adapter BIOS
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1408P052.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1408P052.Edit}
