...
Edit Server Profile to change Enclosure group
    ${rc}                               Fusion UI Create Server Profile                               @{TestData.F1408UI084.Create}
    Should Be True                      ${rc}   msg=Failed to Create Server Profile
    ${rc}                               Fusion UI Create Tbird Enclosure Group                        @{TestData.F1408UI084.CreateEG}
    Should Be True                      ${rc}   msg=Failed to Create enclosure group
    ${rc}                               Fusion UI Edit Server Profile                                 @{TestData.F1408UI084.Edit}
    ...
    Fusion UI Delete Enclosure Group                @{TestData.F1408UI084.DeleteEG}