...
Edit SP to change boot option from Managed wolume to Specify boot target
    ${rc}                               Fusion UI Create Server Profile                             @{TestData.F1408UI099.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}  Fusion UI Edit Server Profile           @{TestData.F1408UI099.Edit}