...
Edit the server profile to Change the Boot parameter - Secondary to Primary
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1408P050.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1408P050.Edit}
