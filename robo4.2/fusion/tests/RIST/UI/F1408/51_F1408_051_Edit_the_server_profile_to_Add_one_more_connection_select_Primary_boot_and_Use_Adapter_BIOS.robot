...
Edit the server profile to Add one more connection, select Primary boot and Use Adapter BIOS
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1408P051.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1408P051.Edit}
