...
Edit the server profile to delete the boot volume
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1408P034.Create}
    ...
    Run Keyword and Expect Error    ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1408P034.Edit}
