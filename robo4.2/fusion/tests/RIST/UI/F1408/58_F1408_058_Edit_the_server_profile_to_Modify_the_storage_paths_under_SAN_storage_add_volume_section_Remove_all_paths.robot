...
Edit the server profile to Modify the storage paths under SAN storage --> add volume section Remove all paths
    ${rc} =    Fusion Ui Create Server Profile     @{TestData.F1408P058.Create}
    ...
    Run Keyword and Expect Error   ${expectedErrorMessage}    Fusion Ui Edit Server Profile     @{TestData.F1408P058.Edit}