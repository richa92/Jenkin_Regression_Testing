...
F1183UIn004 Edit SP with no SPP and configure BIOS,and Gen 9 snap 6 not in repo,expect success but configure via IP
    ...
    Fusion UI Edit Server Profile        @{TestData.F1183n004}
    Fusion UI Validate Server Profile Task Step     @{TestData.F1183n004}
    ${rc}   Fusion UI Validate Server Profile Status     OK   @{TestData.F1183n004}
