...
# FTS
APPLIANCE_HOSTNAME = 'wpst38-ov.vse.rdlabs.hpecorp.net'
appliance = {
...
enclosures_attributes = [
    {
        'name': 'wpst38',
        'hostname': 'wpst38-oa1.vse.rdlabs.hpecorp.net',
        'oa': 'wpst38-oa1.vse.rdlabs.hpecorp.net',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'wpst38, bay 1'},  # Gen8
            {'name': 'wpst38, bay 2'},  # Gen8
            {'name': 'wpst38, bay 8'},  # Gen8
            {'name': 'wpst38, bay 3'},  # Gen9
            {'name': 'wpst38, bay 7'},  # Gen9
            {'name': 'wpst38, bay 10'},  # Gen9
            {'name': 'wpst38, bay 11'},  # Gen9
        ],
        'interconnects': [{'name': 'wpst38, interconnect 1', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd9', 'd10', 'd11', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst38, interconnect 2', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd9', 'd10', 'd11', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst38, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd11', 'X7', 'X8']},
                          {'name': 'wpst38, interconnect 4', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd11', 'X7', 'X8']},
                          {'name': 'wpst38, interconnect 5', 'linked_ports': ['1']},
                          {'name': 'wpst38, interconnect 6', 'linked_ports': ['1']},
                          ]
    }
]
