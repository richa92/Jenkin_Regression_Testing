...
# FTS
APPLIANCE_HOSTNAME = 'wpst41-ov.vse.rdlabs.hpecorp.net'
appliance = {
...
lig_attributes = [
    {'name': 'LIG41',
     'interconnectMapTemplate': [
         ...
         {'bay': 3, 'enclosure': 1, 'type': 'HP VC Flex-10/10D Module', 'enclosureIndex': 1},
...
ligs = map(build_lig, lig_attributes)
...
enclosures_attributes = [
    {
        'name': 'wpst41',
        'hostname': 'wpst41-oa1.vse.rdlabs.hpecorp.net',
        'oa': 'wpst41-oa1.vse.rdlabs.hpecorp.net',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'wpst41, bay 1'},  # Gen8
            {'name': 'wpst41, bay 2'},  # Gen8
            {'name': 'wpst41, bay 8'},  # Gen8
            {'name': 'wpst41, bay 3'},  # Gen9
            {'name': 'wpst41, bay 7'},  # Gen9
            {'name': 'wpst41, bay 10'},  # Gen9
            {'name': 'wpst41, bay 11'},  # Gen9
            {'name': 'wpst41, bay 4'},  # Gen10
            {'name': 'wpst41, bay 5'},  # Gen10
            {'name': 'wpst41, bay 12'},  # Gen10
            {'name': 'wpst41, bay 13'},  # Gen10
        ],
        'interconnects': [{'name': 'wpst41, interconnect 1', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst41, interconnect 2', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst41, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd10', 'd11', 'd12', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst41, interconnect 4', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd10', 'd11', 'd12', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst41, interconnect 5', 'linked_ports': ['1']},
                          {'name': 'wpst41, interconnect 6', 'linked_ports': ['1']},
                          ]
    }
]
...
group3_servers_attributes = [
    {'name': enclosures_attributes[0]['servers'][7]['name'], 'eg': enclosures_attributes[0]['eg']},
    {'name': enclosures_attributes[0]['servers'][8]['name'], 'eg': enclosures_attributes[0]['eg']},
    {'name': enclosures_attributes[0]['servers'][9]['name'], 'eg': enclosures_attributes[0]['eg']},
    {'name': enclosures_attributes[0]['servers'][10]['name'], 'eg': enclosures_attributes[0]['eg']}
]
...
upt_hops_profiles = [
    ...
    {'pre_existing_profiles': expected_preupdate_profiles + [expected_group1_profiles[1], expected_group2_profiles[1], expected_group3_profiles[1], expected_group1_profiles[2], expected_group2_profiles[2], expected_group3_profiles[2]],
     'new_profiles': [group2_profiles[3].copy(), group3_profiles[3].copy()]}
]
