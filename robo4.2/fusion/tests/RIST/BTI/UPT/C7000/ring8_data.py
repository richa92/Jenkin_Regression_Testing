...
# FTS
APPLIANCE_HOSTNAME = 'wpst42-ov.vse.rdlabs.hpecorp.net'
appliance = {
...
enclosures_attributes = [
    {
        'name': 'wpst42',
        'hostname': 'wpst42-oa1.vse.rdlabs.hpecorp.net',
        'oa': 'wpst42-oa1.vse.rdlabs.hpecorp.net',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'wpst42, bay 1'},  # Gen8
            {'name': 'wpst42, bay 2'},  # Gen8
            {'name': 'wpst42, bay 8'},  # Gen8
            {'name': 'wpst42, bay 3'},  # Gen9
            {'name': 'wpst42, bay 7'},  # Gen9
            {'name': 'wpst42, bay 10'},  # Gen9
            {'name': 'wpst42, bay 11'},  # Gen9
            {'name': 'wpst42, bay 4'},  # Gen10
            {'name': 'wpst42, bay 5'},  # Gen10
            {'name': 'wpst42, bay 12'},  # Gen10
            {'name': 'wpst42, bay 13'},  # Gen10
        ],
        'interconnects': [{'name': 'wpst42, interconnect 1', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst42, interconnect 2', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst42, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd10', 'd11', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst42, interconnect 4', 'linked_ports': ['d1', 'd2', 'd3', 'd7', 'd8', 'd10', 'd11', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst42, interconnect 5', 'linked_ports': ['1']},
                          {'name': 'wpst42, interconnect 6', 'linked_ports': ['1']},
                          ]
    }
]
