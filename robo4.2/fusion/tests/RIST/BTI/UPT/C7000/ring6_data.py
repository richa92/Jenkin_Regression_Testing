...
# FTS
APPLIANCE_HOSTNAME = 'wpst40-ov.vse.rdlabs.hpecorp.net'
appliance = {
...
enclosures_attributes = [
    {
        'name': 'wpst40',
        'hostname': 'wpst40-oa1.vse.rdlabs.hpecorp.net',
        'oa': 'wpst40-oa1.vse.rdlabs.hpecorp.net',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'wpst40, bay 1'},  # Gen8
            {'name': 'wpst40, bay 2'},  # Gen8
            {'name': 'wpst40, bay 8'},  # Gen8
            {'name': 'wpst40, bay 3'},  # Gen9
            {'name': 'wpst40, bay 7'},  # Gen9
            {'name': 'wpst40, bay 10'},  # Gen9
            {'name': 'wpst40, bay 11'},  # Gen9
        ],
        'interconnects': [{'name': 'wpst40, interconnect 1', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst40, interconnect 2', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd9', 'd10', 'd11', 'd12', 'd15', 'd16', 'X6', 'X7', 'X8']},
                          {'name': 'wpst40, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd10', 'd11', 'd12', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst40, interconnect 4', 'linked_ports': ['d1', 'd2', 'd3', 'd4', 'd7', 'd8', 'd10', 'd11', 'd12', 'X7', 'X11', 'X12', 'X13', 'X14']},
                          {'name': 'wpst40, interconnect 5', 'linked_ports': ['1']},
                          {'name': 'wpst40, interconnect 6', 'linked_ports': ['1']},
                          ]
    }
]
