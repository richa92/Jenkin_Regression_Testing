...
APPLIANCE_HOSTNAME = 'ovst04-ov.vse.rdlabs.hpecorp.net'
APPLIANCE_IPV4_ADDRESS = '16.114.208.113'
...
enclosures_attributes = [
    {
        ...
        'servers': [
            {'name': 'MXQ831078H, bay 1'},
            {'name': 'MXQ831078H, bay 2'},
            {'name': 'MXQ831078H, bay 5'},
            {'name': 'MXQ831078H, bay 8'},
            {'name': 'MXQ831078H, bay 7'},  # Gen10
            {'name': 'MXQ831078H, bay 9'},  # Gen10
            {'name': 'MXQ831078H, bay 10'},  # Gen10
        ],
        'interconnects': [{'name': 'MXQ831078H, interconnect 3', 'linked_ports': ['d1', 'd2', 'd5', 'd6', 'd7', 'd8', 'd9', 'd10', 'd13', 'd14', 'd15', 'd17', 'd18', 'd19', 'd20', 'Q1:1', 'Q4:1', 'Q7', 'Q8', 'l1', 'l4']},
                          {'name': 'MXQ831078H, interconnect 6', 'linked_ports': ['d1', 'd2', 'd5', 'd6', 'd7', 'd8', 'd9', 'd10', 'l1', 'l2']},
                          ]
    },
    {
        'name': 'MXQ8320169',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'MXQ8320169, bay 1'},
            {'name': 'MXQ8320169, bay 2'},
            # {'name': 'MXQ8320169, bay 3'},  Missing Mezz1
            {'name': 'MXQ8320169, bay 5'},  # Gen10
            {'name': 'MXQ8320169, bay 6'},  # Gen10
            {'name': 'MXQ8320169, bay 7'},  # Gen10
            {'name': 'MXQ8320169, bay 8'},  # Gen10
        ],
        'interconnects': [{'name': 'MXQ8320169, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd5', 'd6', 'd7', 'd8', 'l1', 'l2']},
                          {'name': 'MXQ8320169, interconnect 6', 'linked_ports': ['d1', 'd2', 'd3', 'd5', 'd6', 'd7', 'd8', 'd13', 'd14', 'd17', 'd18', 'd19', 'd20', 'd21', 'd22', 'Q1:1', 'Q4:1', 'Q7', 'Q8', 'l1', 'l4']},
                          ]
    }
]
