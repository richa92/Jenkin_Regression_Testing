...
APPLIANCE_HOSTNAME = 'ovst05-ov.vse.rdlabs.hpecorp.net'
APPLIANCE_IPV4_ADDRESS = '16.114.217.100'
appliance = {
...
enclosures_attributes = [
    {
        ...
        'servers': [
            {'name': 'MXQ80805DK, bay 1'},
            {'name': 'MXQ80805DK, bay 2'},
            {'name': 'MXQ80805DK, bay 5'},
            {'name': 'MXQ80805DK, bay 7'},
            {'name': 'MXQ80805DK, bay 8'},  # Gen10
            {'name': 'MXQ80805DK, bay 9'},  # Gen10
            {'name': 'MXQ80805DK, bay 10'},  # Gen10
        ],
        'interconnects': [{'name': 'MXQ80805DK, interconnect 3', 'linked_ports': ['d1', 'd2', 'd5', 'd7', 'd8', 'd9', 'd10', 'd13', 'd14', 'd15', 'd17', 'd18', 'd19', 'd20', 'Q1:1', 'Q4:1', 'Q7', 'Q8', 'l1', 'l4']},
                          {'name': 'MXQ80805DK, interconnect 6', 'linked_ports': ['d1', 'd2', 'd5', 'd7', 'd8', 'd9', 'd10', 'l1', 'l2']},
                          ]
    },
    {
        'name': 'MXQ81100P9',
        'hostname': 'MXQ81100P9-oa1.vse.rdlabs.hpecorp.net',
        'oa': 'MXQ81100P9-oa1.vse.rdlabs.hpecorp.net',
        'eg': enclosure_groups[0]['name'],
        'servers': [
            {'name': 'MXQ81100P9, bay 1'},
            {'name': 'MXQ81100P9, bay 2'},
            {'name': 'MXQ81100P9, bay 3'},
            {'name': 'MXQ81100P9, bay 5'},
            {'name': 'MXQ81100P9, bay 6'},  # Gen10
            {'name': 'MXQ81100P9, bay 7'},  # Gen10
            {'name': 'MXQ81100P9, bay 8'},  # Gen10
        ],
        'interconnects': [{'name': 'MXQ81100P9, interconnect 3', 'linked_ports': ['d1', 'd2', 'd3', 'd5', 'd6', 'd7', 'd8', 'l1', 'l2']},
                          {'name': 'MXQ81100P9, interconnect 6', 'linked_ports': ['d1', 'd2', 'd3', 'd5', 'd6', 'd7', 'd8', 'd13', 'd14', 'd17', 'd19', 'd20', 'd21', 'd22', 'Q1:1', 'Q4:1', 'Q7', 'Q8', 'l1', 'l4']},
                          ]
    }
]
