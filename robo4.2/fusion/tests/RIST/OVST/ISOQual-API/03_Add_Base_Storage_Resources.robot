*** Settings ***
Documentation    Tests to add storage system and pools
...              Edit Storage Pool to change it from Discovered to Managed Status
...              Add Storage VOLUME TEMPLATES to OneView
...              Add Storage VOLUMES to OneView
...              Add Already Existing Storage Volumes to OneView
