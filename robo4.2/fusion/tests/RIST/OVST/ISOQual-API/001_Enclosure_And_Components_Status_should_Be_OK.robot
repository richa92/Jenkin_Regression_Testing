...
Suite Teardown                  Run Keywords    All Enclosure State Should Be Monitored
...                             AND     QUAL Suite Teardown
...
*** Keywords ***
All Enclosure State Should Be Monitored
    [Documentation]  Verify state of all Enclosures
    [Tags]      ENCS-STATE
    All Enclosures State Should Be Monitored    Fatal Error