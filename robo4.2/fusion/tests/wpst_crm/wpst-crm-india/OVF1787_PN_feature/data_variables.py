...
host_ip1 = '195.168.140.174'
# host_ip =  '192.168.148.96'
host_ip = '192.168.145.170'
pnet_true = True
pnet_false = False
admin_default_paswd = "admin"
factory_reset_sleep_time = "800"
BACKUPFILE_DIR = "C:\\Check_Out_410_Config\\Check_out_410_RG_05_02_2018\\fusion\\tests\\wpst_crm\\wpst-crm-india\\OVF1787_Nitro_Priv_NW\\"
# Fw_old = 'cust-K120-32-Dev-Gen10.iso'
# Fw_new =  'cust-K120-36-EM2-DEV-G10.iso'
# Fw_latest = 'cust-K120-37-EM2-Dev-G10.iso'
Fw_old = 'Cust-K130-60P-N200-56P-EM204-G10.iso'
Fw_new = 'Cust-K130-60P-N200-56P-EM204-G10.iso'
# Fw_latest = 'Cust-K130-30-EM202-G10-prod.iso'
Fw_latest = 'Cust-K130-60P-N200-56P-EM204-G10.iso'
Fw_unsupported = 'Cust-spp-EM2-k110-36-Gen10.iso'
Module_name = 'Virtual Connect SE 100Gb F32 Module for Synergy'
SPP_Uri = ''
localfile = ''
version_Check = ''
...
Create_bond = "nmcli connection add type bond ifname bond-name mode 4 miimon 100"
...
Tunnel_ip_1 = ''
Tunnel_ip_2 = ''
icm_ip = '192.168.150.80'
server_ip_address = ['195.168.140.33', '192.168.145.80']
disenbserver_ip_address = ['195.168.140.33', '195.168.140.33']
routenbserver_ip_address = ['195.168.140.33', '195.168.140.19']
disenbnopingserver_ip_address = ['192.168.145.80', '192.168.145.80']
rout192enbpingserver_ip_address = ['192.168.145.81', '192.168.145.80']
rr_enb_server_ip_address = ['195.168.140.19', '195.168.140.33']
rr_enb_192server_ip_address = ['192.168.145.80', '192.168.145.81']
ips_b1 = ['192.168.145.80', '195.168.140.19']
ips_b6 = ['192.168.145.81', '195.168.140.33']
...
Enc2MapBaysetB = [
    {'bay': 2, 'enclosure': 1, 'type': 'Synergy 50Gb Interconnect Link Module', 'enclosureIndex': 1},
    {'bay': 5, 'enclosure': 1, 'type': 'Synergy 50Gb Interconnect Link Module', 'enclosureIndex': 1},
    {'bay': 2, 'enclosure': 2, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 2},
    {'bay': 5, 'enclosure': 2, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 2}
]
...
Add_net_Edit_uplink = {
    ...
    "primaryPortLocation": None,
    "nativeNetworkUri": ["Net_2"],
    "networkUris": ["/rest/ethernet-networks/9787a648-90ee-4885-9df3-2fc905b9e6a2", "/rest/ethernet-networks/e41bc85d-3941-45a0-978a-ab5a8f47b146"],
    "fcNetworkUris": [],
    "fcoeNetworkUris": [],
    "reachability": None,
    # "fcMode": null,
...
libody_Dlspeed10gb = [{"op": "replace", "path": "/downlinkSpeedMode", "value": "SPEED_10GB"}]

etht_set1 = {"type": "EthernetInterconnectSettingsV4",
...
LIGS_TB = {'ligsup': [{'name': 'LIG1',
                       ...
                       'internalNetworkUris':[],
                       'ethernetSettings': etht_set1,
                       'qosConfiguration':qos_set1,
                       'downlinkSpeedMode':'SPEED_10GB',
                       'state': 'Active',
                       'telemetryConfiguration': None,
                       'snmpConfiguration': None}],
           'ligsup_NewBB': [{'name': 'LIGnewok',
                             'type': 'logical-interconnect-groupV5',
                             'enclosureType': 'SY12000',
                             'interconnectMapTemplate': Enc2MapBayset2,
                             'enclosureIndexes': [1, 2],
...
server_profile_1 = [{'type': 'ServerProfileV9',
                     ...
                     'connectionSettings': {'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 2:1', 'requestedMbps': '2500', 'networkUri': 'ETH:Net_2', 'mac': None, 'wwpn': None, 'wwnn': None, 'requestedVFs': '0', 'ipv4': {}}, {'id': 2, 'name': '2', 'functionType': 'Ethernet', 'portId': 'Mezz 2:1', 'requestedMbps': '2500', 'networkUri': 'ETH:Net_1', 'mac': None, 'wwpn': None, 'wwnn': None, 'requestedVFs': '0', 'ipv4': {}}]},
...
server_profiles_1 = [{'type': 'ServerProfileV9',
                      'serverHardwareUri': ENC_2 + ', bay 1',
                      'serverHardwareTypeUri': '',
                      'enclosureUri': 'ENC:' + ENC_2,
                      'enclosureGroupUri': 'EG:EG1',
...
server_profiles_2 = [{'type': 'ServerProfileV9',
                      'serverHardwareUri': ENC_2 + ', bay 1',
                      'serverHardwareTypeUri': '',
                      'enclosureUri': 'ENC:' + ENC_2,
                      'enclosureGroupUri': 'EG:EG1',
...
Lag_server_profile = [{'type': 'ServerProfileV9',
                       'serverHardwareUri': ENC_2 + ', bay 1',
                       'serverHardwareTypeUri': '',
                       'enclosureUri': 'ENC:' + ENC_2,
                       'enclosureGroupUri': 'EG:EG1',
...
server_profileA1 = [{'type': 'ServerProfileV9',
                     'serverHardwareUri': ENC_1 + ', bay 6',
                     'serverHardwareTypeUri': '',
                     'enclosureUri': 'ENC:' + ENC_1,
                     'enclosureGroupUri': 'EG:EG1',
...
server_profileA2 = [{'type': 'ServerProfileV9',
                     'serverHardwareUri': ENC_2 + ', bay 1',
                     'serverHardwareTypeUri': '',
                     'enclosureUri': 'ENC:' + ENC_2,
                     'enclosureGroupUri': 'EG:EG1',
...
server_profileA1_Lag = [{'type': 'ServerProfileV9',
                         'serverHardwareUri': ENC_1 + ', bay 6',
                         'serverHardwareTypeUri': '',
                         'enclosureUri': 'ENC:' + ENC_1,
                         'enclosureGroupUri': 'EG:EG1',
...
server_profileA2_lag = [{'type': 'ServerProfileV9',
                         'serverHardwareUri': ENC_2 + ', bay 1',
                         'serverHardwareTypeUri': '',
                         'enclosureUri': 'ENC:' + ENC_2,
                         'enclosureGroupUri': 'EG:EG1',
...
server_profileA2_Edit = [{'type': 'ServerProfileV9',
                          'serverHardwareUri': ENC_2 + ', bay 1',
                          'serverHardwareTypeUri': '',
                          'enclosureUri': 'ENC:' + ENC_2,
                          'enclosureGroupUri': 'EG:EG1',
...
server_profileB1 = [{'type': 'ServerProfileV9',
                     'serverHardwareUri': ENC_1 + ', bay 6',
                     'serverHardwareTypeUri': '',
                     'enclosureUri': 'ENC:' + ENC_1,
                     'enclosureGroupUri': 'EG:EG1',
...
server_profileB2 = [{'type': 'ServerProfileV9',
                     'serverHardwareUri': ENC_2 + ', bay 1',
                     'serverHardwareTypeUri': '',
                     'enclosureUri': 'ENC:' + ENC_2,
                     'enclosureGroupUri': 'EG:EG1',
...
server_profileB3 = [{'type': 'ServerProfileV9',
                     'serverHardwareUri': ENC_2 + ', bay 1',
                     'serverHardwareTypeUri': '',
                     'enclosureUri': 'ENC:' + ENC_2,
                     'enclosureGroupUri': 'EG:EG1',
