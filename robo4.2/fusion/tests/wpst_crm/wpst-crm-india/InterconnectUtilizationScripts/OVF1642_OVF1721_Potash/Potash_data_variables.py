...
def replace_string(string1, str):
    str = string.replace(string1, '|', str)
    return str


Metric_Index = ['0', '1', '2', '3', '4', '5', '6']
...
PFPTrue = True
PFPFalse = False
ICM_4 = ENC1 + ', interconnect 3'
li = 'LE-LIG_Nitro'
li_Potash = 'LE-LIG_Potash'
...
alert_type = 'swmon.cpuhighthreshold'
alert_type_low = 'swmon.cpulowthreshold'
...
Critical_Message = "CPU utilization for interconnect CN77080KR1, interconnect 3 exceeded warning threshold of 25%."
Warning_Message = "Interconnect CPU Utilization for CN77080KR1, interconnect 3 has crossed lower CPU threshold of 20%"
alert_type_memory = 'swmon.ramthreshold'
alert_type_health_critical = 'hpris.emRegistry.2.4.InterconnectManagerInternalCritical'
alert_type_health_warn = 'hpris.emRegistry.2.4.InterconnectManagerInternalWarning'
Memory_regex = 'Memory Utilization for Interconnect\\\s.*?\\\shas crossed memory threshold of 40%.'
critical_Msg_Health = 'The management processor on the interconnect in bay xxx is reporting a critical internal health status.'
warning_Msg_Health = 'The management processor on the interconnect in bay xxx is reporting a warning internal health status.'
...
li_enable = {"type": "EthernetInterconnectSettingsV5", "enableInterconnectUtilizationAlert": True}
Disable_Ports = [{"interconnectName": ICM_4, "portType": "Uplink", "portId": '', "capability": ["Ethernet", "EnetFcoe", "FibreChannel"], "configPortTypes":["EnetFcoe", "Ethernet"], "enabled":False, "portName":"Q1:1", "portStatus":"Linked", "type":"port"},
                 ]
Enable_Ports = [{"interconnectName": ICM_4, "portType": "Uplink", "portId": "", "capability": ["Ethernet", "EnetFcoe", "FibreChannel"], "configPortTypes":["EnetFcoe", "Ethernet"], "enabled":True, "portName":"Q3", "portStatus":"Unknown", "type":"port"}]
interconnects_disable = [ENC1 + ', interconnect 3']
INTERCONNECTS = [ENC1 + ', interconnect 3']
INTERCONNECTS1 = [ENC1 + ', interconnect 6']
downlink_port_disable = [{"interconnectName": ICM_4, "portType": "Downlink", "portId": '', "enabled": False, "portName": "d1", "portStatus": "Linked", "type": "port"},
                         ]
downlink_port_enable = [{"interconnectName": ICM_4, "portType": "Downlink", "portId": '', "enabled": True, "portName": "d1", "portStatus": "Linked", "type": "port"},
                        ]
...
icmap_SE = [{'bay': 2, 'enclosure': 1, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1},
            {'bay': 5, 'enclosure': 1, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1},
            ]

icmap_SE_Potash = [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
...
ligs_tbird_SE_Multi_LIG_All_Users = {'name': 'LIG_Nitro',
...
ligs_tbird_SE_Multi_LIG_All_Users_1 = {'name': 'LIG_Potash',
                                       'type': 'logical-interconnect-groupV5',
                                       'enclosureType': 'SY12000',
                                       'enclosureIndexes': [1],
                                       'interconnectMapTemplate': icmap_SE_Potash,
                                       'uplinkSets': [],
                                       'interconnectBaySet': 3,
                                       'redundancyType': 'Redundant',
                                       'ethernetSettings': None,
...
enc_group_ME = {'name': 'EG',
                ...
                [{'interconnectBay': 1, 'logicalInterconnectGroupUri': None},
                 ...
                 {'interconnectBay': 5, 'logicalInterconnectGroupUri': 'LIG:LIG_Nitro'},
