...
server_profiles = [{'type': 'ServerProfileV6', 'serverHardwareUri': ENC1 + ', bay 3',
...
downlink_enable = {'interconnectName': 'RAVIENCL10, interconnect 3', 'enabled': True,
                   'portName': 'd3',
                   'type': 'port',
                   }

downlink_disable = {'interconnectName': 'RAVIENCL10, interconnect 3', 'enabled': False,
                    'portName': 'd3',
                    'type': 'port',
                    }
