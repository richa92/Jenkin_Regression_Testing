...
ic_firmwareVersion_old = ' 1.2.0.1003'
ic_firmwareVersion_new = ' 1.2.0.1005'
ic_firmwareVersion_old_unsupported = '1.1.0.6'
old_SPP_bundle = 'Cust-K120-1003-EM201-Dev-G10.iso'
old_SPP_bundle_name = 'Cust-K120-1003-EM201-Dev-G10'
latest_SPP_bundle = 'Cust-K120-1005-EM201-Dev-G10.iso'
latest_SPP_bundle_name = 'Cust-K120-1005-EM201-Dev-G10'
...
uplink_interface_1 = "Ten-GigabitEthernet 0/0/2:1"
downlink_interface = "TwentyGigE 0/2/1"
downlink_interface_1 = "TwentyGigE 0/1/6"
...
downlink_port_disable = [{"interconnectName": ICM_1, "portType": "Downlink", "portId": '', "enabled": False, "portName": "d6", "portStatus": "Linked", "type": "port"},
                         ]
downlink_port_enable = [{"interconnectName": ICM_1, "portType": "Downlink", "portId": '', "enabled": True, "portName": "d6", "portStatus": "Linked", "type": "port"},
                        ]
...
icmap_ME = [{'bay': 2, 'enclosure': 1, 'type': 'Virtual Connect SE 40Gb F8 Module for Synergy', 'enclosureIndex': 1},
...
server_profiles1 = [{'type': 'ServerProfileV8', 'name': 'Profile1', 'serverHardwareUri': ENC1 + ', bay 1',
...
server_profiles_2 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC2 + ', bay 6',
                      'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC2, 'enclosureGroupUri': 'EG:EG1',
                      'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                      ...
                      'connectionSettings': {'connections': [{'id': 1, 'name': '', 'functionType': 'Ethernet', 'portId': 'Mezz 2:1-a',
                                                             ...
                                                             {'id': 2, 'name': '', 'functionType': 'Ethernet', 'portId': 'Mezz 2:2-a',
                                                              'requestedMbps': '2500', 'networkUri': 'ETH:Net2', 'mac': None, 'wwpn': None, 'wwnn': None}]}}]
server_profiles_1 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 6',
                      'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG1',
                      'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                      'name': 'Profile1', 'description': '', 'affinity': 'Bay',
                      "boot": None, 'boot': {'manageBoot': False}, "bootMode": {"manageMode": True, "mode": "UEFI", "pxeBootPolicy": "Auto"},
...
server_profiles_LAG1 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                         'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG1',
                         'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                         'name': 'Profile1', 'description': '', 'affinity': 'Bay',
                         "boot": None, 'boot': {'manageBoot': False}, "bootMode": {"manageMode": True, "mode": "UEFI", "pxeBootPolicy": "Auto"},
                         'connectionSettings': {'connections': [{'id': 1, 'name': '', 'functionType': 'Ethernet', 'portId': 'Mezz 2:1-a',
                                                                ...
                                                                {'id': 2, 'name': '', 'functionType': 'Ethernet', 'portId': 'Mezz 2:2-a',
                                                                 'requestedMbps': '2500', 'networkUri': 'ETH:Net2', 'lagName': 'LAG1', 'mac': None, 'wwpn': None, 'wwnn': None}]}}]
# iLo_1 = '192.168.147.62'
iLo_1 = '192.168.147.221'
