...
li_set1= {"type":"EthernetInterconnectSettingsV201","enableTaggedLldp":True}
li_set2= {"type":"EthernetInterconnectSettingsV201","enableRichTLV":False,"enableTaggedLldp":True}
li_set3= {"type":"EthernetInterconnectSettingsV201","enableTaggedLldp":False}
...
uplink_sets_tbird= {'us1': {'name': 'Uplinkset1',
              ...
              'us1_ME_Multi_LIG1': {'name': 'Uplinkset2',
                       ...
                       'nativeNetworkUri': None,
                       'mode': 'Auto',
                       'logicalPortConfigInfos': [{'bay': '2', 'enclosure': '1', 'port': 'Q1.1', 'speed': 'Auto'},
                                                  {'bay': '5', 'enclosure': '2', 'port': 'Q1.1', 'speed': 'Auto'}
                ...
                'us1_ME_LIG2': {'name': 'Us2',
                       ...
                       'nativeNetworkUri': None,
                       'mode': 'Auto',
                       'logicalPortConfigInfos': [{'bay': '6', 'enclosure': '2', 'port': 'Q1.1', 'speed': 'Auto'}
                                                ]},
...
ligs_tbird_ME_Multi_LIG ={'lig1':
         ...
         'uplinkSets': [uplink_sets_tbird['us1_ME_Multi_LIG']],
         #'uplinkSets': [],
         'interconnectBaySet':3,
         'redundancyType':'HighlyAvailable',
         'ethernetSettings': {'type': 'EthernetInterconnectSettingsV201','enableTaggedLldp':False,'interconnectType': 'Ethernet'},
...
ligs_tbird_1 = {'ligTT':
        ...
        {'name': 'LIG1',
         ...
         'interconnectMapTemplate': icmap,
         'interconnectBaySet': 3,
         'uplinkSets': [uplink_sets_tbird['us1'].copy()],
         'redundancyType': 'Redundant',
         'stackingMode': 'Enclosure',
         'ethernetSettings': {'type': 'EthernetInterconnectSettingsV201','enableTaggedLldp': False,'interconnectType': 'Ethernet'},
         'state': 'Active',
...
server_profiles_tbird_Multi_LIG = [{'type': 'ServerProfileV6', 'serverHardwareUri': 'IRTQI6MH9D, bay 4','serverHardwareTypeUri': '', 'enclosureUri': 'ENC:IRTQI6MH9D', 'enclosureGroupUri': 'EG:EGLldp',
