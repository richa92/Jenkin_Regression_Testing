...
icmap_ME = [{'enclosure': -1, 'bay': 1, 'type': 'Mellanox SH2200 TAA Switch Module for Synergy', 'enclosureIndex': -1},
            {'enclosure': -1, 'bay': 4, 'type': 'Mellanox SH2200 TAA Switch Module for Synergy', 'enclosureIndex': -1}
            ]

icmap_ME = [{'enclosure': -1, 'bay': 3, 'type': 'Mellanox SH2200 TAA Switch Module for Synergy', 'enclosureIndex': -1},
            {'enclosure': -1, 'bay': 6, 'type': 'Mellanox SH2200 TAA Switch Module for Synergy', 'enclosureIndex': -1}
            ]
...
sflow_lig_dhcp = {"type": LIG_Version,
                  ...
                  "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_100"},
                                         ...
                                         "sflowPorts": [{"portName": "Q1:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                  ...
                  "uplinkSets": [
                      {'name': 'us1_eth100', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["net_100"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
                       'logicalPortConfigInfos': [{'bay': '3', 'enclosure': '-1', 'port': 'Q1.1', 'speed': 'Speed10G'}]}
                  ]}
...
sflow_lig_static = {"type": LIG_Version,
                    ...
                    "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_200"},
                                           "sflowCollectors": [{"name": "C100", "collectorEnabled": True, "ipAddress": "192.168.146.98", "maxDatagramSize": "1400", "maxHeaderSize": "128", "port": "6343", "collectorId": 1}],
                                           "sflowAgents": [{"ipMode": "Static"}],
                                           "sflowPorts": [{"portName": "d1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                           "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                             {"configurationMode": "Sampling", "direction": "INGRESS", "samplingRate": "4000", "samplingEnabled": True}]}
                                                          ]
                                           },
                    "uplinkSets": [
                        {'name': 'us1_eth100', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["net_200"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
                         'logicalPortConfigInfos': [{'bay': '3', 'enclosure': '-1', 'port': 'Q2.1', 'speed': 'Speed10G'}]}
                    ]}
...
sflow_lig_ippool = {"type": LIG_Version,
                    ...
                    "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_300"},
                                           ...
                                           "sflowPorts": [{"portName": "Q3:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                           "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                             {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]}
                                                          ]
                                           },
...
sflow_lig_nonexistant_receiver = {"type": LIG_Version,
                                  ...
                                  "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_100"},
                                                         "sflowCollectors": [{"name": "C100", "collectorEnabled": True, "ipAddress": "10.10.10.1", "maxDatagramSize": "1400", "maxHeaderSize": "128", "port": "6343", "collectorId": 1}],
                                                         "sflowAgents": [{"ipMode": "Static", "ipAddr": "192.168.151.228", "subnetMask": "255.255.248.0"}],
                                                         "sflowPorts": [{"portName": "Q1:1", "collectorId": "2", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                                         "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                                           {"configurationMode": "Sampling", "direction": "Ingress", "samplingRate": "256", "samplingEnabled": True}]}
                                                                        ]
                                                         },
                                  "uplinkSets": [
                                      {'name': 'us1_eth100', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["net_100"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
...
sflow_lig_invalid_static_config = {"type": LIG_Version,
                                   "ethernetSettings": {"type": LIG_EthernetInterconnectSettings, "enableIgmpSnooping": False, "igmpIdleTimeoutInterval": 260, "enableFastMacCacheFailover": True, "macRefreshInterval": 5, "enableNetworkLoopProtection": True, "enablePauseFloodProtection": True, "enableRichTLV": False, "interconnectType": "Ethernet", "dependentResourceUri": None, "name": "defaultEthernetSwitchSettings", "category": None, "uri": "/ethernetSettings"},
                                   "description": None,
                                   "name": "LIG_STATIC_1",
                                   "interconnectMapTemplate": icmap_ME,
...
sflow_lig_non_subnet_ippool = {"type": LIG_Version,
                               "ethernetSettings": {"type": LIG_EthernetInterconnectSettings, "enableIgmpSnooping": False, "igmpIdleTimeoutInterval": 260, "enableFastMacCacheFailover": True, "macRefreshInterval": 5, "enableNetworkLoopProtection": True, "enablePauseFloodProtection": True, "enableRichTLV": False, "interconnectType": "Ethernet", "dependentResourceUri": None, "name": "defaultEthernetSwitchSettings", "category": None, "uri": "/ethernetSettings"},
                               "description": None,
                               "name": "LIG_STATIC_1",
                               "interconnectMapTemplate": icmap_ME,
...
sflow_editlig_more_uplinkports = {"type": LIG_Version,
                                  ...
                                  "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_100"},
                                                         ...
                                                         "sflowPorts": [{"portName": "Q1:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                                         "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                                           {"configurationMode": "Sampling", "direction": "Ingress", "samplingRate": "4000", "samplingEnabled": True}]},
                                                                        {"portName": "Q2:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                                         "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                                           {"configurationMode": "Sampling", "direction": "Ingress", "samplingRate": "4000", "samplingEnabled": True}]},
                                                                        {"portName": "Q3:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                                         "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                                           {"configurationMode": "Sampling", "direction": "Ingress", "samplingRate": "4000", "samplingEnabled": True}]}
                                                                        ]
                                                         },
...
sflow_edit_lig_wrong_collectorid_for_port = {"type": LIG_Version,
                                             ...
                                             "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_100"},
                                                                    "sflowCollectors": [{"name": "C100", "collectorEnabled": True, "ipAddress": "10.10.10.1", "maxDatagramSize": "1400", "maxHeaderSize": "128", "port": "6343", "collectorId": 1},
                                                                                        {"name": "C200", "collectorEnabled": True, "ipAddress": "50.50.50.1", "maxDatagramSize": "4000", "maxHeaderSize": "1024", "port": "6343", "collectorId": 2}],
                                                                    "sflowAgents": [{"ipMode": "DHCP"}],
                                                                    "sflowPorts": [{"portName": "Q1:1", "collectorId": "3", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                                                    "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                                                      {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]}
                                                                                   ]
                                                                    },
...
sflow_lig_for_le = {"type": LIG_Version,
                    ...
                    "sflowConfiguration": {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "net_200"},
                                           ...
                                           "sflowAgents": [{"ipMode": "Static"}],
                                           "sflowPorts": [{"portName": "Q2:1", "collectorId": "1", "icmName": "Mellanox SH2200 TAA Switch Module for Synergy", "bayNumber": 3,
                                                           "enclosureIndex": -1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                                             {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]}
                                                          ]
                                           },
