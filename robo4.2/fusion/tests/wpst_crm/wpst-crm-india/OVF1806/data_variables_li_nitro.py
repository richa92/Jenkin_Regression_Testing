...
# print 'kc - defining the required variables'
# print ' ----------------------------------- '
...
edit_li_edit_collector_ip = {'sflowconfiguration': {
    ...
    "sflowPorts": [{
        "portName": sflow_port_2,
        "collectorId": 1,
        "icmName": "SGH721WSR0, interconnect 2",
        "bayNumber": 2,
        "enclosureIndex": 1,
...
sflow_server1 = [{'name': 'server1', 'type': 'ServerProfileV9', 'serverHardwareUri': 'SH:SGH721WSR0, bay 1', 'enclosureGroupUri': 'EG:EG', 'serialNumberType': 'Physical', 'iscsiInitiatorNameType': 'AutoGenerated', 'macType': 'Physical', 'wwnType': 'Physical', 'description': 'Updated Profile', 'affinity': 'Bay',
...
sflow_server2 = [{'name': 'server2', 'type': 'ServerProfileV9', 'serverHardwareUri': 'SH:SGH721WSR0, bay 4', 'enclosureGroupUri': 'EG:EG', 'serialNumberType': 'Physical', 'iscsiInitiatorNameType': 'AutoGenerated', 'macType': 'Physical', 'wwnType': 'Physical', 'description': 'Updated Profile', 'affinity': 'Bay',
                  'boot': {'manageBoot': False},
                  'bootMode': {'manageMode': False},
                  'firmware': {'manageFirmware': False, 'firmwareBaselineUri': '', 'forceInstallFirmware': False, 'firmwareInstallType': None},
                  'bios': {'manageBios': False, 'overriddenSettings': []},
...
port_result_100g = {'autoNegEnabled': True, 'operationalFecMode': 'Invalid',
                    'operationalSpeed': 'Speed100G', 'portSplitMode': 'Unknown', 'portStatus': 'Unlinked', }
port_result_40g = {'autoNegEnabled': False, 'operationalFecMode': 'Disabled',
                   'operationalSpeed': 'Speed40G', 'portSplitMode': 'Unsplit', 'portStatus': 'Linked', }
port_result_25g = {'autoNegEnabled': False, 'operationalFecMode': 'Invalid',
                   'operationalSpeed': 'Speed25G', 'portSplitMode': 'Unsplit', 'portStatus': 'Linked', }
port_result_10g = {'autoNegEnabled': False, 'operationalFecMode': 'Invalid',
                   'operationalSpeed': 'Speed10G', 'portSplitMode': 'Unsplit', 'portStatus': 'Linked', }
non_existing_q_port = {'autoNegEnabled': True, 'operationalFecMode': 'Invalid',
                       'operationalSpeed': 'Speed0M', 'portSplitMode': 'Unknown', 'portStatus': 'Unlinked'}

not_available_qsplit_port = {'autoNegEnabled': False, 'connectorType': None, 'operationalFecMode': 'Auto',
                             'operationalSpeed': 'Auto', 'portSplitMode': 'NotApplicable', }

icmap_ME_Nitro = [{'enclosure': 1, 'bay': 2, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1},
                  {'enclosure': 1, 'bay': 5, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1}
                  ]
icmap_ME_Nitro_bay2 = [{'enclosure': 1, 'bay': 2, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1}
                       ]

icm_name_nitro = 'Virtual Connect SE 100Gb F32 Module for Synergy'
redundancyType = 'Redundant'
side_a_redundancyType = 'NonRedundantASide'
lig_nitro_sflow_data = {"type": "sflow-configuration", "enabled": True, "sflowNetwork": {"name": "Ethernet_1000"},
                        "sflowCollectors": [{"name": "C1", "collectorEnabled": True, "ipAddress": "192.168.147.210", "maxDatagramSize": "410", "maxHeaderSize": "128", "port": "6343", "collectorId": 1},
                                            {"name": "C2", "collectorEnabled": True, "ipAddress": "192.168.147.190", "maxDatagramSize": "420", "maxHeaderSize": "128", "port": "6343", "collectorId": 2},
                                            {"name": "C3", "collectorEnabled": True, "ipAddress": "192.168.146.109", "maxDatagramSize": "430", "maxHeaderSize": "128", "port": "6343", "collectorId": 3}],
                        "sflowAgents": [{"ipMode": "Static"}],
                        "sflowPorts": [{"portName": sflow_port_1, "collectorId": "1", "icmName": icm_name_nitro, "bayNumber": 2,
                                        "enclosureIndex": 1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                         {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]},
                                       {"portName": sflow_port_2, "collectorId": "2", "icmName": icm_name_nitro, "bayNumber": 2,
                                        "enclosureIndex": 1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                         {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]},
                                       {"portName": sflow_port_3, "collectorId": "3", "icmName": icm_name_nitro, "bayNumber": 2,
                                        "enclosureIndex": 1, "sflowConfigurationModes": [{"configurationMode": "Polling", "pollingInterval": "20", "pollingEnabled": True},
                                                                                         {"configurationMode": "Sampling", "direction": "BOTH", "samplingRate": "256", "samplingEnabled": True}]},
                                       ]
                        }
sflow_lig_nitro = {"type": LIG_Version,
                   "ethernetSettings": {"type": 'EthernetInterconnectSettingsV4', "enableIgmpSnooping": False, "igmpIdleTimeoutInterval": 260, "enableFastMacCacheFailover": True, "macRefreshInterval": 5, "enableNetworkLoopProtection": True, "enablePauseFloodProtection": True, "enableRichTLV": False, "interconnectType": "Ethernet", "dependentResourceUri": None, "name": "defaultEthernetSwitchSettings", "category": None, "uri": "/ethernetSettings"},
                   "description": None,
                   "name": "LIG_Nitro",
                   "interconnectMapTemplate": icmap_ME_Nitro_bay2,
                   "enclosureType": "SY12000",
                   "enclosureIndexes": [1],
                   "interconnectBaySet": "2",
                   "redundancyType": side_a_redundancyType,
                   "internalNetworkUris": [],
                   "snmpConfiguration": None,
                   "qosConfiguration": None,
                   "sflowConfiguration": lig_nitro_sflow_data,
                   "uplinkSets": [{'name': 'us1', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["Ethernet_Vlan_1"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
                                   'logicalPortConfigInfos': [{'bay': '2', 'enclosure': '1', 'port': 'Q6.1', 'speed': 'Auto'}]},
                                  {'name': 'us2', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["Ethernet_1000", "Ethernet_Vlan_1", "Ethernet_111"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
                                   'logicalPortConfigInfos': [{'bay': '2', 'enclosure': '1', 'port': 'Q2.1', 'speed': 'Auto'}]},
                                  {'name': 'us3', 'ethernetNetworkType': 'Tagged', 'networkType': 'Ethernet', 'networkUris': ["Ethernet_1003"], 'primaryPort': None, 'nativeNetworkUri': None, 'mode': 'Auto',
                                   'logicalPortConfigInfos': [{'bay': '2', 'enclosure': '1', 'port': 'Q3', 'speed': 'Auto'}]}
                                  ]}

sflow_eg_with_nitro = [{'name': 'EG',
                        'ipAddressingMode': "External",
                        'enclosureCount': 1,
                        'configurationScript': None,
                        'interconnectBayMappings': [{'interconnectBay': 1, 'logicalInterconnectGroupUri': None},
                                                    {'interconnectBay': 2, 'logicalInterconnectGroupUri': "LIG:LIG_Nitro"},
                                                    {'interconnectBay': 3, 'logicalInterconnectGroupUri': "LIG:LIG"},
                                                    {'interconnectBay': 4, 'logicalInterconnectGroupUri': None},
                                                    {'interconnectBay': 5, 'logicalInterconnectGroupUri': None},
                                                    {'interconnectBay': 6, 'logicalInterconnectGroupUri': "LIG:LIG"}
...
if 'Nitro' in icm_type:
    ...
    # Receiver Status
    # sFlowRcvrStatus = ".enterprises.11.5.7.5.8.2.2.115.1.1.1.5"  # value 1 - Enabled, 2- Disabled
    sFlowRcvrStatus = ".enterprises.11.5.7.5.9.2.2.115.1.1.1.5"  # value 1 - Enabled, 2- Disabled
    ...
    sFlowInterfaceCounterPollerStatus = ".enterprises.11.5.7.5.9.2.2.115.2.1.1.6.11.1.3.6.1.2.1.2.2.1.1"
    sFlowInterfaceSamplingStatus = ".enterprises.11.5.7.5.9.2.2.115.15.1.1.7.11.1.3.6.1.2.1.2.2.1.1"

    sFlowAgentIpAddr = ".enterprises.14706.1.1.3.0"
    sFlowAgentStatus = ".enterprises.11.5.7.5.9.2.2.115.4.0"    # value 1 - Enabled, 2- Disabled
    sFlowSubnet = ".enterprises.11.5.7.5.9.1.27.1.5.1.3.4594"
    ...
    interfaceIngressSamplingRate = ".enterprises.14706.1.1.5.1.4.11.1.3.6.1.2.1.2.2.1.1"
    interfaceEgressSamplingRate = ".enterprises.14706.1.1.5.1.4.11.1.3.6.1.2.1.2.2.1.1"
    interfaceSamplingDirection = ".enterprises.11.5.7.5.9.2.2.115.15.1.1.2.11.1.3.6.1.2.1.2.2.1.1"  # 3 - BOTH, 2 - Egress , 1 - Ingress

    # To get interface list
    hafniumInterfaceList = "1.3.6.1.2.1.31.1.1.1.1"
    # or
    # hafniumInterfaceList =      "ifName"
# For Nitro Auto Split #
    ifExtFecMode = 'enterprises.11.5.7.5.9.1.4070.1.1.1.20'  # <int>' # INTEGER  { invalid ( 0 ) , auto ( 1 ) , cl74 ( 2 ) , cl91 ( 3 ) , disabled ( 4 ) }
    ifExtAutoConfigure = 'enterprises.11.5.7.5.9.1.4070.1.1.1.11'  # .<int>' # TruthValue
    ifExtNegStatusConfigured = 'enterprises.11.5.7.5.9.1.4070.1.1.1.10'  # .<int>' # TruthValue
    ifExtAutoSplitStatus = 'enterprises.11.5.7.5.9.1.4070.1.1.1.9'  # .<int>'  # INTEGER  { disable ( 0 ) , enable ( 1 ) }
    ifExtPortState = 'enterprises.11.5.7.5.9.1.4070.1.1.1.4'  # .<int>' # INTEGER  { blocking ( 0 ) , forwarding ( 1 ) }
    ifExtAvailable = 'enterprises.11.5.7.5.9.1.4070.1.1.1.1'  # .<int>' # INTEGER  { available ( 1 ) , notAvailable ( 2 ) }
    ifExtFecModeStatus = 'enterprises.11.5.7.5.9.1.4070.1.1.1.21'  # .<int>' # INTEGER  { invalid ( 1 ) , cl74 ( 2 ) , cl91 ( 3 ) , disabled ( 4 ) }

    interface_details = ['ifDescr', 'ifType', 'ifSpeed', 'ifPhysAddress', 'ifAdminStatus', 'ifOperStatus']
