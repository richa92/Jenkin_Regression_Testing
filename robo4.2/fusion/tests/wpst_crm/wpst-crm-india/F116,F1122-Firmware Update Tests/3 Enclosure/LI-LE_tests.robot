...
Create LE-3 enc-scenario testing
    ${Status}=    Run Keyword And Ignore Error    fusion_ui_create_tbird_logical_enclosure    ${TestData.les[2]}
...
Something Wrong with IC stacking Roles.FW update might Not be successfull!!
...
3.POSITIVE-ORCHESTRATED-Downgrade FW of LE--with force option-Shared Infrastructure
    ...
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3NDFU.enclosure[1].name}    300
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3NDFU.enclosure[2].name}    200
...
1.POSITIVE-PARALLEL-Upgrade FW of LE--without force-Shared Infrastructure
    fusion_ui_power_off_server_profile_by_name    ${TestData.CreateProfile[0].name}
    fusion_ui_power_off_server_profile_by_name    ${TestData.CreateProfile[1].name}
    fusion_ui_power_off_server_profile_by_name    ${TestData.CreateProfile[2].name}
    fusion_ui_power_off_server_profile_by_name    ${TestData.CreateProfile[3].name}

    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware1.enclosure[0].name}    400
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware1.enclosure[1].name}    300
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware1.enclosure[2].name}    200
...
2.POSITIVE-PARALLEL-Downgrade FW of LE--with force option-Shared Infrastructure
    Log To Console    ******VERIFY IC STACKING DOMAIN ROLE of LE BEFORE FW UPDATE******
...
3.POSITIVE-PARALLEL-Same Version FW update for LE--with force option-Shared Infrastructure

    Run Keyword and ignore error   fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[0].name}    400
    Run Keyword and ignore error   fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[1].name}    300
    Run Keyword and ignore error   fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[2].name}    200
    ...
    fusion_ui_power_on_server_profile_by_name   ${TestData.CreateProfile[1].name}
    fusion_ui_power_on_server_profile_by_name   ${TestData.CreateProfile[2].name}
    fusion_ui_power_on_server_profile_by_name   ${TestData.CreateProfile[3].name}
...
1.POSITIVE-ORCHESTRATED-Update Firmware(Stage+Activate) test-(upgrade)
   	...
   	Log To Console    ******VERIFY IC STACKING DOMAIN ROLE of LE BEFORE FW UPDATE******
    ${Status}=    fusion_ui_verify_ic_stacking_domain_role_of_li    @{TestData.logicalconnectNDFU}[2]
    Run Keyword and Continue on Failure    Should Be Equal    '${Status}'    'True'    Something Wrong with IC stacking Roles.FW update might Not be successfull!!
...
################ LI Upgrade - PARALLEL    Firmware Update Positive Tests ##################

1.POSITIVE-PARALLEL-Update Firmware(Stage+Activate) test-(upgrade)
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[0].name}    400
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[1].name}    300
    Run Keyword and ignore error    fusion_ui_wait_for_enclosure_refresh_complete   ${TestData.firmware3.enclosure[2].name}    200
...
2.POSITIVE-PARALLEL-Update Firmware(Stage+Activate) test-(downgrade)
...
3.POSITIVE-PARALLEL-Staging to the baseline version for firmware update-same version-With Force
...
4.POSITIVE-PARALLEL-Activate to the staged baseline tests(upgrade)-same version-With Force
