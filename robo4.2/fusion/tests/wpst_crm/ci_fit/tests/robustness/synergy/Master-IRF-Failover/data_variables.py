...
# EMAIL_TO = 'jason.mas.pernito@hpe.com,gopikannan.narayanan@hpe.com'
...
SW_59XX_IPADDR = '15.186.x.x'
SW_59XX_USERNAME = 'admin'
SW_59XX_PASSWORD = 'password'
# Mapping of your 59XX switch cpu-mac to that of your power control XMLs
SW_iPDU_XML = {
    '00e0-fc0f-8c02': {
        'on': './iPDU/set_top_59xx_on.xml',
        'off': './iPDU/set_top_59xx_off.xml'
    },
    '00e0-fc0f-8c03': {
        'on': './iPDU/set_bottom_59xx_on.xml',
        'off': './iPDU/set_bottom_59xx_off.xml'
    }
}
...
ICM_SCRIPTS_DIR = '/root/ci-fit/4.00/fusion-irf-robustness/tests/wpst_crm/\
ci_fit/tools/interconnect/scripts'
ICM_PASSWD_SCRIPT = 'get-icm-passwd.sh'

# Your enclosure name(s)
ENC_NAME = ['CN7545022V', 'CN75140CR3']
# Your Potash interconnect names
ICM_NAMES = [ENC_NAME[1] + ', interconnect 3',
             ENC_NAME[0] + ', interconnect 6']

# OV Uplinks to Potash operationalSpeed mapping
OPERATIONAL_SPEED = {
    'Speed_40G': 'FortyGigE',
    'Speed_10G': 'Ten-GigabitEthernet'
}
...
TARGET_LI = 'LE-LIG-ICM-3_6-HA'
TARGET_US = ['BIG-PIPE-ENET', 'FCOE-A', 'FCOE-B', 'Tunnel1', 'UNTAG']
...
EXPECTED_PORTS = [
    'Ten-GigabitEthernet0/0/1:1(P)', 'Ten-GigabitEthernet0/0/1:2(P)',
    'Ten-GigabitEthernet1/0/1:1(P)', 'Ten-GigabitEthernet1/0/1:2(P)',
    'Ten-GigabitEthernet0/0/1:3(P)', 'Ten-GigabitEthernet0/0/1:4(P)',
    'Ten-GigabitEthernet1/0/1:3(P)', 'Ten-GigabitEthernet1/0/1:4(P)',
    'FortyGigE0/0/3(P)', 'FortyGigE0/0/4(P)', 'FortyGigE1/0/3(P)',
    'FortyGigE1/0/4(P)',
    'FortyGigE0/0/2(P)',
    'FortyGigE1/0/2(P)'
]
...
SEQUENTIAL_PING_SCRIPT = '/root/ci-fit/fusion/tests/wpst_crm/ci_fit/\
