...
CHECK_READONLY_NO13811 = '172.19.13.3 172.17.37.2 172.20.1.3 172.17.37.3 172.20.1.2 172.19.13.2'
...
CHECK_MEATGRINDER_NO13811 = '172.19.13.3 172.17.37.2 172.20.1.3 172.17.37.3 172.20.1.2 172.19.13.2'
...
PING_HAFILE_NO13811 = '/root/ci-fit/4.10/fusion/tests/wpst_crm/ci_fit/tools/appliance/d-nct/HA_ipaddr_no13811.conf'
...
CHECK_MULTIPATH_NO13811_LESS1FC = {
    # bay1
    # '172.16.3.3': 2,
    # bay2
    '172.17.37.2': 1,
...
CHECK_MULTIPATH_NO13811_LESS1BAY2 = {
    # bay1
    # '172.16.3.3': 2,
    # bay2
    '172.17.37.2': 1,
...
HFSH_COMMANDS = ['show clock', 'show interface description', 'show clock']
ICM_SCRIPTS_DIR = '/root/ci-fit/4.10/fusion/tests/wpst_crm/ci_fit/tools/interconnect/scripts'
...
STACKING_SLEEP = '5m'
EDIT_UPLINK_SETS_SLEEP = '5m'
TOGGLE_UPLINK_PORT_SLEEP = '5m'
...
POST_DELETE_PROFILE_CONNECTION_SLEEP = '30m'
