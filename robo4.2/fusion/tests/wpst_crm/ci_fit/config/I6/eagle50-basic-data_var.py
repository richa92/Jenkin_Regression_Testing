...
appliance = {'type': 'ApplianceNetworkConfiguration',
             ...
             [{'device': 'eth0',
               ...
               'app1Ipv4Addr': '15.186.10.50',
               'app2Ipv4Addr': '15.186.11.50',
               'virtIpv4Addr': '15.186.9.50',
               'ipv6Type': 'UNCONFIGURE',
               'hostname': 'ci-manager-eagle50.us.rdlabs.hpecorp.net',
               'confOneNode': True,
...
"""
ranges = [{'name': 'Eagle50-MAC', 'type': 'Range', 'category': 'id-range-VMAC', 'rangeCategory': 'CUSTOM', 'startAddress': '12:11:11:00:00:00', 'endAddress': '12:11:11:0F:FF:FF', 'enabled': True},
        {'name': 'Eagle50-WWN', 'type': 'Range', 'category': 'id-range-VWWN', 'rangeCategory': 'CUSTOM', 'startAddress': '10:00:1C:11:00:00:00:00', 'endAddress': '10:00:1C:11:00:0F:FF:FF', 'enabled': True},
          {'name': 'Eagle50-SN', 'type': 'Range', 'category': 'id-range-VSN', 'rangeCategory': 'CUSTOM', 'startAddress': 'VCUNNN0000', 'endAddress': 'VCUNNN0ZZZ', 'enabled': True}]
...
"""
encs = [
        {'hostname': '15.186.9.50', 'username': 'Administrator', 'password': 'compaq', 'enclosureGroupUri': 'EG:EG 1', 'force': False, 'licensingIntent': 'OneViewNoiLO'},
        ]
...
"""
les = [{'name': 'LE',
    'enclosureUris': ['ENC:CN7545085K','ENC:CN75450856',],
...
"""
server_profiles = [
                    {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545085K, bay 1',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545085K', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile1', 'description': '', 'affinity': 'Bay',
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:ENet104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545085K, bay 2',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545085K', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile2', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:ENet104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450856, bay 1',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450856', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile3', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:ENet104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450856, bay 2',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450856', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile4', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:ENet104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450856, bay 7',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450856', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile5', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:ENet104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450856, bay 8',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450856', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'Profile6', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
