...
appliance = {'type': 'ApplianceNetworkConfiguration',
             ...
             [{'device': 'eth0',
               ...
               'app1Ipv4Addr': '15.186.10.49',
               'app2Ipv4Addr': '15.186.11.49',
               'virtIpv4Addr': '15.186.9.49',
               'ipv6Type': 'UNCONFIGURE',
               'hostname': 'ci-manager-eagle49.us.rdlabs.hpecorp.net',
               'confOneNode': True,
...
"""
ranges = [{'name': 'Eagle49-MAC', 'type': 'Range', 'category': 'id-range-VMAC', 'rangeCategory': 'CUSTOM', 'startAddress': 'B2:88:88:00:00:00', 'endAddress': 'B2:88:88:0F:FF:FF', 'enabled': True},
          {'name': 'Eagle49-WWN', 'type': 'Range', 'category': 'id-range-VWWN', 'rangeCategory': 'CUSTOM', 'startAddress': '10:00:14:11:00:00:00:00', 'endAddress': '10:00:14:11:00:0F:FF:FF', 'enabled': True},
          {'name': 'Eagle49-SN', 'type': 'Range', 'category': 'id-range-VSN', 'rangeCategory': 'CUSTOM', 'startAddress': 'VCUSSS0000', 'endAddress': 'VCUSSS0ZZZ', 'enabled': True}]
...
"""
encs = [
        {'hostname': '15.186.9.49', 'username': 'Administrator', 'password': 'compaq', 'enclosureGroupUri': 'EG:EG 1', 'force': False, 'licensingIntent': 'OneViewNoiLO'},
        ]
...
"""
server_profiles = [
                    {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545022V, bay 1',
    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545022V', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN7545022V bay 1', 'description': '', 'affinity': 'Bay',
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545022V, bay 2',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545022V', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN7545022V bay 2', 'description': '', 'affinity': 'Bay',
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545022V, bay 7',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545022V', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN7545022V bay 7', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
##                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN7545022V, bay 8',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN7545022V', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN7545022V bay 8', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
