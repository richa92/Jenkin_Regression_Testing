...
"""
ranges = [{'name': 'Eagle47-MAC', 'type': 'Range', 'category': 'id-range-VMAC', 'rangeCategory': 'CUSTOM', 'startAddress': 'B2:66:66:00:00:00', 'endAddress': 'B2:66:66:0F:FF:FF', 'enabled': True},
          {'name': 'Eagle47-WWN', 'type': 'Range', 'category': 'id-range-VWWN', 'rangeCategory': 'CUSTOM', 'startAddress': '10:00:10:11:00:00:00:00', 'endAddress': '10:00:10:11:00:0F:FF:FF', 'enabled': True},
          {'name': 'Eagle47-SN', 'type': 'Range', 'category': 'id-range-VSN', 'rangeCategory': 'CUSTOM', 'startAddress': 'VCUQQQ0000', 'endAddress': 'VCUQQQ0ZZZ', 'enabled': True}]
...
"""
encs = [
        {'hostname': '15.186.9.47', 'username': 'Administrator', 'password': 'compaq', 'enclosureGroupUri': 'EG:EG 1', 'force': False, 'licensingIntent': 'OneViewNoiLO'},
        ]
...
server_profiles = [
    ...
    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450498', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN75450498 bay 1', 'description': '', 'affinity': 'Bay',
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450498, bay 2',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450498', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN75450498 bay 2', 'description': '', 'affinity': 'Bay',
...
#                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450498, bay 7',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450498', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN75450498 bay 7', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
...
##                                    {'id': 4, 'name': '4', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-c', 'requestedMbps': '2500', 'networkUri': 'ETH:net_104', 'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                   ...
                   {'type': 'ServerProfileV6', 'serverHardwareUri': 'CN75450498, bay 8',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:CN75450498', 'enclosureGroupUri': 'EG:EG 1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual', 'name': 'CN75450498 bay 8', 'description': '', 'affinity': 'Bay',
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'bootMode': {'manageMode':True, 'mode': 'UEFI', 'pxeBootPolicy': 'IPv4'},
                    'firmware':{'manageFirmware':False,'firmwareBaselineUri':'','forceInstallFirmware':False,'firmwareInstallType':None},
                    'bios':{'manageBios':False,'overriddenSettings':[]},
