...
li_uplink_set_Edit = {'name': 'ss-comp-ug1',
                      'ethernetNetworkType': 'Tagged',
                      'networkType': 'Ethernet',
                      'networkUris': ['wpstnetwork1'],
                      'fcNetworkUris': [],
                      ...
                      'connectionMode': 'Auto',
                      'nativeNetworkUri': None,
                      'portConfigInfos': [{'bay': '1', 'port': 'X2', 'desiredSpeed': 'Auto', 'enclosure': Enclosure_Name1}]}
...
eg_body1 = {'name': 'config4-group',
            ...
            [{'interconnectBay': 1, 'enclosureIndex': 1, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-SS1'},
             ...
             {'interconnectBay': 3, 'enclosureIndex': 1, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-SS1'},
             {'interconnectBay': 4, 'enclosureIndex': 1, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-SS1'}
             ]}

encs = [{'hostname': Enclosure_IP, 'username': 'Administrator', 'password': 'Compaq123', 'enclosureGroupUri': 'EG:config4-group', 'force': False, 'licensingIntent': 'OneViewNoiLO'}]
...
li_US = {"type": "uplink-setV5", "name": "ss-comp-add", "networkUris": [],
         "portConfigInfos": [{"desiredSpeed": "Auto", "location": {"locationEntries": [{"value": "X5", "type": "Port"},
                                                                                       {"value": 2, "type": "Bay"},
