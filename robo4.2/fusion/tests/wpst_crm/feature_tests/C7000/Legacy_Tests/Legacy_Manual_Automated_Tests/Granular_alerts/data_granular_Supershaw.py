...
lig = {'name': 'LIG-COMP-SS',
       ...
       'uplinkSets': [{'name': 'ss-comp-ug1', 'networkType': 'Ethernet', 'ethernetNetworkType': 'Tagged', 'networkUris': ['wpstnetwork1', 'wpstnetwork3'], 'mode': 'Auto', 'lacpTimer': 'Short', 'primaryPort': None,
                       'logicalPortConfigInfos': [{'bay': '1', 'enclosure': '1', 'port': 'X2', 'speed': 'Auto'},
                                                  {'bay': '3', 'enclosure': '1', 'port': 'X1', 'speed': 'Auto'}]},
                      {'name': 'ss-comp-ug2', 'networkType': 'Ethernet', 'ethernetNetworkType': 'Tagged', 'networkUris': ['wpstnetwork2', 'wpstnetwork4'],
