...
enc_group = {'name': 'config1-group',
             ...
             [{'interconnectBay': 1, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-OU1'},
                 ...
                 {'interconnectBay': 5, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-OU2'},
                 {'interconnectBay': 6, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-OU2'},
                 {'interconnectBay': 7, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-OU2'},
                 {'interconnectBay': 8, 'logicalInterconnectGroupUri': 'LIG:LIG-COMP-OU2'}],
             'ipRangeUris': [],
             'enclosureCount': 1,
...
edit_lig = {'lig1':
            ...
            {'name': 'LIG-COMP-OU2',
                'type': 'logical-interconnect-groupV6',
                'enclosureType': 'C7000',
                'interconnectMapTemplate': [{'enclosure': 1, 'enclosureIndex': 1, 'bay': 5, 'type': 'HP VC 8Gb 24-Port FC Module'},
...
edit_lig1 = {'lig1':
             ...
             {'name': 'LIG-COMP-OU2',
                 'type': 'logical-interconnect-groupV6',
                 'enclosureType': 'C7000',
                 'interconnectMapTemplate': [{'enclosure': 1, 'enclosureIndex': 1, 'bay': 7, 'type': 'HP VC Flex-10 Enet Module'},
                                             {'enclosure': 1, 'enclosureIndex': 1, 'bay': 8, 'type': 'HP VC Flex-10 Enet Module'}],
                 "internalNetworkUris": [],
                 "uplinkSets": [],
                 "stackingMode": "Enclosure",
