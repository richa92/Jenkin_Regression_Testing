...
inter_headers = {'X-Api-Version': '500', 'Accept-Language': 'en',
                 'auth': u'LTY5MDY3OTcwMzI2UcaDwrvfZaZ5gJo68IngzQSxgk-v5ybx',
                 'Accept': 'application/json',
                 'Content-Type': 'application/json'}
login_header = {'X-Api-Version': '500', "Content-Type": "application/json"}
login_payload = {"password": "wpsthpvse1", "userName": "Administrator",
...
def get_logical_interconnect(app_ip, li_uri, enc1, ports, output):
    '''
...
def verify_login_count(app_ip, li_uri, enc1, ports, output):
    '''
