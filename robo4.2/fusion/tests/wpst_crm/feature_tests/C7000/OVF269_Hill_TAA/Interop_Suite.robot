...
4 Manual Login Redistribution
	...
	${output_1}	${logins}=	verify_login_count	${APPLIANCE_IP}	${out['members'][0]['uri']}	${ENC1}	${bay_port_detail}	${mlr_initial_output}
	...
	sleep	120sec
	${output_2}	${logins}=	verify_login_count	${APPLIANCE_IP}	${out['members'][0]['uri']}	${ENC1}	${bay_port_detail}	${mlr_final_output}
	...
	${output_3}	${logins}=	verify_login_count	${APPLIANCE_IP}	${out['members'][0]['uri']}	${ENC1}	${bay_port_detail}	${mlr_initial_output}
