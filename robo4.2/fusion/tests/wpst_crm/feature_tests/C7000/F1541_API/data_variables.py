...
localfile2= """c:\\Supportfiles\\C7K_sppfiles\\Downgrade_one\\CUST-SPP-RPMONLY-DOWNGRADE-191.iso"""
localfile3= """c:\\Supportfiles\\C7K_sppfiles\\Downgrade_one\\SPP-pb191-downgrde-scexe.iso"""
localfile4= """c:\\Supportfiles\\C7K_sppfiles\\upgarde_one\\cust-upgrade-scexe-4-6-c7k.iso"""
localfile5= """c:\\Supportfiles\\C7K_sppfiles\\upgarde_one\\cust-upgrade-rpm-4-6-c7k.iso"""

ENC_ALERTS= """Update firmware
...
Activate complete"""
#  EXE and RPM Support ######+===================
LI_DOWNGRADE_STAGEING_PRLDEMO_SCEXE_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}
LI_DOWNGRADE_ACTIVATION_PARALLELDEMO_SCEXE_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}

LI_UPGRADE_UPDATE_PARALLELDEMO_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"False","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}



LI_DOWNGRADE_STAGEING_ODDEVEN_SCEXE_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}

LI_DOWNGRADE_ACTIVATION_ODDEVEN_SCEXE_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}


LI_UPGRADE_STAGEING_ODDEVEN_RPM_SCEXE = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_ODDEVEN_RPM_SCEXE = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_DOWNGRADE_STAGEING_SERIAL_SCEXE_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}

LI_DOWNGRADE_ACTIVATION_SERIAL_SCEXE_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}

LI_UPGRADE_STAGEING_PARALLEL_RPM_SCEXE = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_PARELLEL_RPM_SCEXE = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_UPGRADE_STAGEING_SERIAL_RPM_SCEXE = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_SERIAL_RPM_SCEXE = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_DOWNGRADE_STAGEING_PARALLEL_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}

LI_DOWNGRADE_ACTIVATION_PARALLEL_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191'}


LI_UPGRADE_STAGEING_ODDEVEN_RPM_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_ODDEVEN_RPM_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_UPGRADE_STAGEING_SAMEVERSION_RPM_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_SAMEVERSION_RPM_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_DOWNGRADE_STAGEING_PARALLEL_RPM_SCEXES = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}

LI_DOWNGRADE_ACTIVATION_PARALLEL_RPM_SCEXES = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}


LI_UPGRADE_STAGEING_ODDEVEN_SCEXES_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_ODDEVEN_SCEXES_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_DOWNGRADE_STAGEING_ODDEVEN_RPM_SCEXES = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}

LI_DOWNGRADE_ACTIVATION_ODDEVEN_RPM_SCEXES = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}


LI_UPGRADE_STAGEING_PARALLEL_SCEXES_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_PARALLEL_SCEXES_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}



LI_DOWNGRADE_STAGEING_SERIAL_RPM_SCEXES = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}

LI_DOWNGRADE_ACTIVATION_SERIAL_RPM_SCEXES = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}


LI_UPGRADE_STAGEING_SERIAL_SCEXES_RPM = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_SERIAL_SCEXES_RPM = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_UPGRADE_STAGEING_SERIAL_SCEXE_SCEXE = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_SERIAL_SCEXE_SCEXE = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'false','sppUri':'/rest/firmware-drivers/{}'.format(spp)}


LI_UPGRADE_STAGEING_SAMEVERSION_SCEXE_SCEXE = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_ACTIVATION_SAMEVERSION_SCEXE_SCEXE = {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/{}'.format(spp)}

LI_UPGRADE_STAGE_ACTIVE_UPSAMEVERSION_SCEXE_SCEXE  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"true","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}



LI_DOWNGRADE_UPDATE_SERIAL_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191","command":"UPDATE","force":"true","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}

LI_DOWNGRADE_UPDATE_ODDEVEN_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191","command":"UPDATE","force":"true","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}

LI_DOWNGRADE_UPDATE_ODDEVEN_RPM_RPM  = {"sppUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191","command":"UPDATE","force":"true","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}


LI_DOWNGRADE_UPDATE_PARALLELDEMO_RPM_RPM  = {"sppUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}
LI_DOWNGRADE_UPDATE_PARALLELDEMO_New_RPM_RPM     = {"command":"UPDATE","ethernetActivationDelay":"5","ethernetActivationType":"Parallel","fcActivationDelay":"5","fcActivationType":"Parallel","force": "true","sppUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191"}


LI_UPGRADE_UPDATE_SERIAL_RPM_SCEXE  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"false","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}

LI_UPGRADE_UPDATE_SERIAL_RPM_RPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"false","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}

LI_DOWNGRADE_UPDATE_PARALLEL_RPM_SCEXE  = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}


LI_UPGRADE_UPDATE_PARALLEL_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"False","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

LI_DOWNGRADE_UPDATE_ODDEVEN_RPM_SCEXE  = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}


LI_UPGRADE_UPDATE_ODDEVEN_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"false","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}


LI_UPGRADE_UPDATE_PARALLEL_SCEXE_RPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

LI_DOWNGRADE_UPDATE_PARALLEL_SCEXE_SCEXERPM  = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

LI_UPGRADE_UPDATE_SERIAL_RPM_SCEXERPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"false","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}


LI_UPGRADE_UPDATE_ODDEVEN_SAMEVERSION_RPM_SCEXERPM  = {"sppUri":"/rest/firmware-drivers/{}".format(spp),"command":"UPDATE","force":"true","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}
...
##  LE Level Firmware upgrade  ########################

LE_DOWNGRADE_SHARED_INFRA_PROFILE_SCEXE_RPM= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
...
LE_DOWNGRADE_SHARED_INFRA_RPM_SCEXE = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_SCEXE_RPM = {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_DOWNGRADE_SHARED_INFRA_RPM_RPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_DOWNGRADE_SHARED_INFRA_RPM_RPM_SAME_NAGATIVE = {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_RPM_SCEXE= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_SCEXE_SCEXE = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}


LE_DOWNGRADE_SHARED_INFRA_PROFILE_SCEXE_SCEXE= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}


LE_DOWNGRADE_SHARED_INFRA_SCEXE_RPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_RPM_RPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_RPM_RPM_GEN10SNAP1 = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPPGen10Snap1_2016_1110_49",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_RPM_RPM_GEN10SNAP1_54 = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_DOWNGRADE_SHARED_INFRA_PROFILEDEMO_RPM_RPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_SAME_VERSION_RPM_SCEXE = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_SAME_VERSION_SCEXE_SCEXERPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_DOWNGRADE_SHARED_INFRA_PROFILE_SCEXE_SCEXERPM = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

LE_UPGRADE_SHARED_INFRA_PROFILE_RPM_SCEXERPM = {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
#    Negative test FOr LE Scenarios #######

LE_DOWNGRADE_SCEXE_NO_FLAG= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
LI_ALERTS_MESSAGES =    {'LI_UPADTE_STARTED':'Update success for logical interconnect','LI_UPDATE_SUCCESS':'Update started for logical interconnect','LI_STAGING_STARTED':'Staging started for logical interconnect','LI_STAGING_SUCCESS':'Stage success for logical interconnect','LI_ACTIVATION_STARTED':'Activation started for logical interconnect','LI_ACTIVATION_SUCCESS':'Activate success for logical interconnect'}

LI_ALERTS_MESSAGES_NEW=    ['Update success for logical interconnect','Update started for logical interconnect','Staging started for logical interconnect','Stage success for logical interconnect','Activation started for logical interconnect','Activate success for logical interconnect']
...
#${ICM_Alert2}                    Staging success for the interconnect SGH420HHY8, interconnect 3 with firmware version 3.01 v7.2.1_38 from baseline

#${ICM_Alert3}                    Activation success for the interconnect SGH420HHY8, interconnect 3 with firmware version 3.01 v7.2.1_38 from baseline
#${ICM_Alert4}                       Activation started for the interconnect SGH420HHY8, interconnect 3 with firmware version 3.01 v7.2.1_38 from baseline
...
apic_ip = ['192.168.144.13003','10.10.5.16']                   

li_spp_downgrade= {'command':'UPDATE','sppUri':'/rest/firmware-drivers/{}'.format(spp),'force': True}

li_spp_upgrade=  {'command':'UPDATE','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','force': 'true'}
...
li_spp_upgrade2= {'command':'Stage','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','force': 'true'}
li_spp_upgrade3= {'command':'ACTIVATE','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','force': 'true'}
li_spp_upgrade4= {'command':'Update','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','force': 'true'}
...
li_spp_upgrade6= {"command":"UPDATE","ethernetActivationDelay":"5","ethernetActivationType":"Parallel","fcActivationDelay":"5","fcActivationType":"Parallel","force": "true","sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe"}
...
li_spp_upgrade7= {'command':'UPDATE','ethernetActivationDelay':'0','ethernetActivationType':'Parallel','fcActivationDelay':'0','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
li_spp_upgrade6_same= {'command':'UPDATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'false','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
li_spp_upgrade1_al= {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
li_spp_upgrade1_ala= {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}

li_spp_upgrade_Ranjan_bug= {'command':'UPDATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': True,'sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}

li_spp_upgrade1_test= {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
li_spp_upgrade5_test= {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
New_li_spp_downgrade_li_tst = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}
...
Demo_New_li_spp_Downgrade_LI_li_tst_h = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"false","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

demo_New_li_spp_downgrade_li_tst_l = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

Demo_li_spp_upgrade5_test_l= {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
Demo_li_Stagingon_oneLi= {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
Demo_upgrade_li_1_multi_lis_stage_lower = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}

Demo_upgrade_li_1_multi_lis_tests1_lower_bb1 = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}
# Tests 
...
Demo_li_spp_DOWNGRADELIgrade1_test_stg_serial_higher = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'Serial','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
Demo_li_spp_dwngrd1_test_stg_oddeven_higher = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
Demo_li_spp_downgrade_test_oddeven_active_higher= {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'OddEven','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}


Demo_li_spp_upgrade1_test_stg_lower = {'command':'STAGE','ethernetActivationDelay':'5','ethernetActivationType':'OddEven','fcActivationDelay':'5','fcActivationType':'Serial','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
Demo_li_spp_upgrade5_test_act_lower= {'command':'ACTIVATE','ethernetActivationDelay':'5','ethernetActivationType':'Parallel','fcActivationDelay':'5','fcActivationType':'Parallel','force': 'true','sppUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe'}
...
demo_New_li_spp_downgrade_li_tst_lower_l = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Parallel","ethernetActivationDelay":"5","fcActivationType":"Parallel","fcActivationDelay":"5"}
...
demo_New_li_spp_downgrade_Serial_li_tst_lower_l = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}


demo_New_li_spp_downgrade_li_serial_lower_l = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"true","ethernetActivationType":"Serial","ethernetActivationDelay":"5","fcActivationType":"Serial","fcActivationDelay":"5"}
...
le_spp_pp= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"true","firmwareUpdateOn":"SharedInfrastructureOnly"}}

le_spp_pp_OA_onlyf= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"false","firmwareUpdateOn":"EnclosureOnly"}}
le_spp_pp_OA_onlyf1= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"true","firmwareUpdateOn":"EnclosureOnly"}}
...
hple_spp_pp_OA_onlyf= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"EnclosureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

le_spp_pp_sh_inf_only= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"true","firmwareUpdateOn":"SharedInfrastructureOnly"}}
le_spp_pp_sh_inf_onlyf= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"false","firmwareUpdateOn":"SharedInfrastructureOnly"}}

hple_spp_pp_sh_inf_onlyf= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

le_spp_pp_sh_inf_prf_only= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"true","firmwareUpdateOn":"SharedInfrastructureAndServerProfiles"}}
...
le_spp_pp_sh_inf_prf_onlyf= {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware":"false","firmwareUpdateOn":"SharedInfrastructureAndServerProfiles"}}
hple_spp_pp_sh_inf_prf_onlyf= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
new_le_spp_pp_sh_inf_only = {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware": True,"firmwareUpdateOn":"SharedInfrastructureOnly"}}
new_le_spp_pp_sh_inf_only_bug = {"op":"replace","path":"/firmware","value":{"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","forceInstallFirmware": 'true',"firmwareUpdateOn":"SharedInfrastructureOnly"}}
...
hple_spp_bb_nw= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

hple_spp_bb_nw_lw= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
# Test LE flow

hple_spp_bb_upgrade_lower_with_No_flag_OA= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"EnclosureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
hple_spp_bb_downgrade_shareinfraonly_without_flag_dwngrade_h= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
hple_spp_bb_downgrade_sh_infra_with_flag_higher = {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
hple_spp_bb_downgrade_higher_with_flag_sh_prifile= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

hple_spp_bb_dwngrde_higher_with_flag_sh_prifile= {"forceInstallFirmware": True,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureAndServerProfiles",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
li_spp_upgrade6_same_version= {"command":"UPDATE","ethernetActivationDelay":"5","ethernetActivationType":"Parallel","fcActivationDelay":"5","fcActivationType":"Parallel","force": "false","sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe"}

li_spp_upgrade6_downgrade_version= {"command":"UPDATE","ethernetActivationDelay":"5","ethernetActivationType":"Parallel","fcActivationDelay":"5","fcActivationType":"Parallel","force": "false","sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe"}
...
New_li_spp_upgrade_li_tst_same_L = {"sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","command":"UPDATE","force":"false","ethernetActivationType":"OddEven","ethernetActivationDelay":"5","fcActivationType":"OddEven","fcActivationDelay":"5"}
...
li_spp_upgrade6_downgrade_version_hh= {"command":"UPDATE","ethernetActivationDelay":"5","ethernetActivationType":"Parallel","fcActivationDelay":"5","fcActivationType":"Parallel","force": "false","sppUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe"}

# Negtive LE

hple_spp_bb_nw_same= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
hple_spp_bb_upgrade_no_flag= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"SharedInfrastructureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}

hple_spp_pp_OA_onlyf_s_oa= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"EnclosureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
hple_spp_pp_OA_onlyf_s_oa_Neg_lower= {"forceInstallFirmware": False,"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe",
         "firmwareUpdateOn":"EnclosureOnly",
         "logicalInterconnectUpdateMode":"Parallel",
         "validateIfLIFirmwareUpdateIsNonDisruptive": False,}
...
OA_CREDENTIAL_DATA = {"oaIpAddress":"192.168.144.130","oaUsername":"Administrator","oaPassword":"Admin"}
...
eth_nw1_p= [{"vlanId":"1","ethernetNetworkType":"Tagged","subnetUri":None,"purpose":"General","name":"ETH_NW1","smartLink":"true","privateNetwork":"false","connectionTemplateUri":None,"type":"ethernet-networkV300"},]
eth_s_bb = [{"vlanId":"100","ethernetNetworkType":"Tagged","subnetUri":None,"purpose":"General","name":"ETH_NW2","smartLink":'true',"privateNetwork":'false',"connectionTemplateUri":None,"type":"ethernet-networkV300"},]

fc_networks_p = [{'type': 'fc-networkV300','linkStabilityTime': 30,'autoLoginRedistribution': True,
...
enc_group = {'name': 'EG_B1',
               ...
               'interconnectBayMappings':
                    ...
                    {'interconnectBay': 5, 'logicalInterconnectGroupUri': 'LIG:LIG_B1'},
...
encREAL1 = [{'hostname': '192.168.144.130', 'username': 'Administrator', 'password': 'Admin', 'enclosureGroupUri': 'EG:EG_B1', 'force': False, 'licensingIntent': 'OneViewNoiLO'}]
encREAL = [{'hostname': '192.168.144.130', 'username': 'Administrator', 'password': 'Admin', 'enclosureGroupUri': 'EG:EG_B1', 'force': True,'licensingIntent': 'OneViewNoiLO', 'firmwareBaselineUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','forceInstallFirmware':'true'}]
encREALBB = [{'hostname': '192.168.144.130', 'username': 'Administrator', 'password': 'Admin', 'enclosureGroupUri': 'EG:EG_B1', 'force': True,'licensingIntent': 'OneViewNoiLO'}]
encREAL_duringenc = [{'hostname': '192.168.144.130', 'username': 'Administrator', 'password': 'Admin', 'enclosureGroupUri': 'EG:EG_B1', 'force': True,'licensingIntent': 'OneViewNoiLO', 'firmwareBaselineUri':'/rest/firmware-drivers/SPP-pb191-downgrde-scexe','forceInstallFirmware':True}]
encReal_new_duringenc = {"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","updateFirmwareOn":"EnclosureOnly","force":"false","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}

encReal_new_duringenc_no_flag = {"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"false","forceInstallFirmware":"false","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}
#enc_new_REAL_during_enc = [{'username':'Administrator','password':'Admin','enclosureGroupUri':'EG:EG_B1','firmwareBaselineUri':'/rest/firmware-drivers/{}'.format(spp),'updateFirmwareOn':'EnclosureOnly','force':'true','forceInstallFirmware':'true','licensingIntent':'OneViewNoiLO','hostname':'192.168.144.130'}]
enc_new_REAL_during_enc = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"false","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_Manage_MANUAL = [{'hostname': '192.168.144.130', 'username': 'Administrator', 'password': 'Admin', 'enclosureGroupUri': 'EG:EG_B1', 'force': True,'licensingIntent': 'OneViewNoiLO'}]


enc_new_REAL_during_enc_downgrade_rpm = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_upgrade_rpm = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_downgrade_scexe = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/SPP-pb191-downgrde-scexe","updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_upgrade_scexe_rpm = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_upgrade_rpm_rpm = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_downgrade_rpm_rpm = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/CUST-SPP-RPMONLY-DOWNGRADE-191","updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]

enc_new_REAL_during_enc_upgrade_rpm_scexes = [{"username":"Administrator","password":"Admin","enclosureGroupUri":'EG:EG_B1',"firmwareBaselineUri":"/rest/firmware-drivers/{}".format(spp),"updateFirmwareOn":"EnclosureOnly","force":"true","forceInstallFirmware":"true","licensingIntent":"OneViewNoiLO","hostname":"192.168.144.130"}]
...
encs_f1541_new_downgrade = enc_new_REAL_during_enc_downgrade_rpm

encs_f1541_new_downgrade_rpm = enc_new_REAL_during_enc_downgrade_rpm

encs_f1541_new_upgrade_rpm = enc_new_REAL_during_enc_upgrade_rpm

encs_f1541_new_downgrade_scexe = enc_new_REAL_during_enc_downgrade_scexe

encs_f1541_new_downgrade_same_version_scexe = enc_new_REAL_during_enc_downgrade_scexe

encs_f1541_new_upgrade_scexe_rpm = enc_new_REAL_during_enc_upgrade_scexe_rpm
encs_f1541_new_upgrade_rpm_rpm = enc_new_REAL_during_enc_upgrade_rpm_rpm
encs_f1541_new_downgrade_rpm_rpm = enc_new_REAL_during_enc_downgrade_rpm_rpm
encs_f1541_new_upgrade_rpm_scexes = enc_new_REAL_during_enc_upgrade_rpm_scexes 
...
BB_icmap = [{'enclosure': 1, 'enclosureIndex': 1, 'bay': 1, 'type': 'HP VC Flex-10/10D Module'},
         {'enclosure': 1, 'enclosureIndex': 1, 'bay': 2, 'type': 'HP VC Flex-10/10D Module'},
         ...
         {'enclosure': 1, 'enclosureIndex': 1, 'bay': 7, 'type': 'HP VC 8Gb 20-Port FC Module'},
         {'enclosure': 1, 'enclosureIndex': 1, 'bay': 8, 'type': 'HP VC 8Gb 20-Port FC Module'},
        ...
        {'name': 'LIG_B1',
         ...
         'uplinkSets': [{'name': 'FC-FA1',
                        ...
                        {'name': 'FC-FA2',
                            ...
                            'nativeNetworkUri': None,
                            'mode': 'Auto',
                            'logicalPortConfigInfos': [{'bay': '6', 'port': '2', 'speed': 'Auto'}]}
                        ],
         'stackingMode': 'Enclosure',
         'ethernetSettings': None,
         'state': 'Active',
...
lig_c7k_enc = {"type":"logical-interconnect-groupV400",
...
fc_networks_NW1 = [{'type': 'fc-networkV300','linkStabilityTime': 30,'autoLoginRedistribution': True,
                'name': 'FC_NW1','connectionTemplateUri': None,'managedSanUri': None,'fabricType': 'FabricAttach'}]

fc_networks_NW2 = [{'type': 'fc-networkV300','linkStabilityTime': 30,'autoLoginRedistribution': True,
...
"""
server_profiles = [{'type': 'ServerProfileV5', 'serverHardwareUri': 'SGH420HHY8, bay 8',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:SGH420HHY8', 'enclosureGroupUri': 'EG:EG_B1', 'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                   ...
                   {'type': 'ServerProfileV5', 'serverHardwareUri': 'SGH420HHY8, bay 3',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:SGH420HHY8', 'enclosureGroupUri': 'EG:EG_B1', 'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
...
server_profiles_2FC_2ETH_BFS_Automation_SP = [
                   {'type': 'ServerProfileV7', 'serverHardwareUri': ENC1 + ', bay 3',
                    ...
                    'bootMode':{'manageMode':'true','mode':'UEFI','pxeBootPolicy':'Auto'},
                    'connections': [
                                    {'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 1:1-d',
                                     'requestedMbps': int(2500), 'networkUri': 'ETH:ETH_NW1',
                                      'mac': None, 'wwpn': '', 'wwnn': ''},
                                    {'id': 2, 'name': '2', 'functionType': 'Ethernet', 'portId': 'Mezz 1:2-d',
                                     'requestedMbps': int(2500), 'networkUri': 'ETH:ETH_NW2',
                                      'mac': None, 'wwpn': '', 'wwnn': ''},
                                    {'id': 3, 'name': '3', 'functionType': 'FibreChannel', 'portId': 'Auto',
                                     'requestedMbps': 'Auto', 'networkUri': 'FC:FC_NW1',
...
####### Variable Declaration For F1541 Feature  ############
...
ICM_Alert1_stg_star_1_end=    ' with firmware version 4.50 2016-04-01T03:15:46Z from baseline'
HICM_Alert1_stg_star_1_end=    ' with firmware version 4.60 2016-12-12T14:52:01Z from baseline'

ICM_Alert1_stg_star_2_end=    ' with firmware version 4.50 2016-04-21T17:54:55Z from baseline'
HICM_Alert1_stg_star_2_end=    ' with firmware version 4.60 2016-12-12T14:52:01Z from baseline'
...
#1 4.40 2014-10-12T08:56:22Z(4.60 2016-10-21T15:07:21Z)    4.40 2014-10-12T08:56:22Z  (4.60 2016-10-21T15:07:21Z)
HICM_Alert1_stg_star_1_end=    ' with firmware version 4.60 2016-12-12T14:52:01Z from baseline'

#${HICM_Alert1_stg_star_3_end}    \  with firmware version 3.08 v7.4.0_13 from baseline
HICM_Alert1_stg_star_3_end=    ' with firmware version 4.60 2016-12-12T14:52:01Z from baseline'

ICM_Alert1_stg_star_1010D_end=    ' with firmware version 4.50 2016-04-21T17:38:08Z from baseline'
HICM_Alert1_stg_star_1010D_end=    ' with firmware version 4.60 2016-12-12T14:34:52Z from baseline'

ICM_Alert1_act_OCHO_succ_end=      ' with firmware version 2.10 9.5.5.01 from baseline'
HICM_Alert1_act_OCHO_succ_end=      ' with firmware version 2.10 9.5.5.01 from baseline'


#  LI ALERTS Validation ################

LI_UPDATE_SUCCESS=       'Update success for logical interconnect'

LI_UPADTE_STARTED=       'Update started for logical interconnect'
...
LI_FC_INTERCONNECTS=    {ICM_NAME5,ICM_NAME6}

LI_1010D_VC_INTERCONNECTS=    {ICM_NAME1,ICM_NAME2}
LI_OCHO_VC_INTERCONNECTS=           {ICM_NAME7,ICM_NAME8}


LI_SUPERSHAW_INTERCONNECTS=      {ICM_NAME3,ICM_NAME4}


LI_ALL_VC_INTERCONNECTS=      {ICM_NAME1,ICM_NAME2,ICM_NAME3,ICM_NAME4,ICM_NAME5,ICM_NAME6,ICM_NAME7,ICM_NAME8}
...
OA_HOST=           '192.168.144.130'
OA_USER=            'Administrator'
OA_PASS=                'Admin'

ALLBAYS= {'1','2','3','4','5','6','7','8'}
ACTIONOFF=        'OFF'
ACTIONON =          'ON'
DEVICE=                'INTERCONNECT'
...
HH_VV=        '?view=flat-tree&start=0&count=50&_'
TAKS_VAR=      '/rest/tasks/'
FIRST_URI=            '/rest/index/resources?category=tasks&start=0&query=%22parentTaskUri%3A%27%2Frest%2Ftasks%2F'
SECOND_URI=             '%27%22&_'

STAGING_TIME=    '70min'

ACTIVATE_SERIAL_TIME=     '199min'
ACTIVATE_ODDEVEN_TIME=     '199min'
ACTIVATE_PARALLEL_TIME=     '180min'
UPDATE_PARALLEL_TIME=     '180min' 
UPDATE_SERIAL_TIME=     '199min'
UPDATE_ODDEVEN_TIME=     '180min'     
"""
