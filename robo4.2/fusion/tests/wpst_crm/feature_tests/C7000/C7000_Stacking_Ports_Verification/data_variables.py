...
Firmware_Bundles = ['bp-2017-05-26-01.iso', 'bp-2018-09-12-01.iso']

fw_uri_4_10 = '/rest/firmware-drivers/bp-2017-05-26-01'

fw_uri_5_0 = '/rest/firmware-drivers/bp-2018-09-12-01'

SPP_4_10 = 'bp-2017-05-26-01.iso'

SPP_5_0 = 'bp-2018-09-12-01.iso'

ENC1 = 'enc1'
LIG = 'LIG'

server_profiles = [[{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 6',
                     ...
                     'name': 'Enc1-' + ENC1 + '-bay-6', 'description': '', 'affinity': 'Bay',
...
encs = [{'hostname': '15.186.20.255', 'username': 'Administrator', 'password': 'compaq', 'enclosureGroupUri': 'EG:EG', 'force': False, 'licensingIntent': 'OneView'}]
