...
ENC1_SERVER_1_ENC1_DL = 'd10'
ENC1_SERVER_1_ENC2_DL = 'd22'
ENC1_SERVER_2_ENC1_DL = 'd2'
ENC1_SERVER_2_ENC2_DL = 'd14'

# Enclosure 2 servers downlink on Enc1 and Enc2; 2 servers on each enclosure
ENC2_SERVER_1_ENC2_DL = 'd2'
ENC2_SERVER_1_ENC1_DL = 'd14'
...
ENC1_SP_1_NAME = 'SP-%s-enc1-bay10' % RACK
ENC1_SP_2_NAME = 'SP-%s-enc1-bay2' % RACK
ENC2_SP_1_NAME = 'SP-%s-enc2-bay2' % RACK
ENC2_SP_2_NAME = 'SP-%s-enc2-bay4' % RACK
ENC1_SP_1_BFS_NAME = 'SP-%s-BFS-enc1-bay10' % RACK
ENC2_SP_1_BFS_NAME = 'SP-%s-BFS-enc2-bay4' % RACK

# servers name
ENC1_SERVER_1 = '%s, bay 10' % ENC_1
ENC1_SERVER_2 = '%s, bay 2' % ENC_1
ENC2_SERVER_1 = '%s, bay 2' % ENC_2
     ...
     'connectionSettings': {'connections': [{'id': 1,
                                            ...
                                            {'id': 2,
                                             ...
                                             'boot': {'priority': 'Primary',
                                                       ...
                                                       'targets': [{'arrayWwpn': '20210002AC012B0C', 'lun': '1'}]},
                                             'mac': None,
                                             'wwpn': None,
                                             'wwnn': None},
                                            {'id': 3,
                                             ...
                                             'boot': {'priority': 'Secondary',
                                                      'bootVolumeSource': 'UserDefined',
                                                      'targets': [{'arrayWwpn': '20220002AC012B0C', 'lun': '1'}]},
                                             'mac': None,
                                             'wwpn': None,
                                             'wwnn': None}
                                            ]}
