"""
data file for testing FC DirectAttach with LE Highly Available redundancy for enclosure AZ51
"""
...
# This is to make test program working for A+B (2 LI) and HA (1 LI);
# mainly for uplinkset verification
LIs = [LI, LI]
...
ASIDE_SERVER_DOWNLINKS = [ENC1_SERVER_1_ENC1_DL, ENC1_SERVER_2_ENC1_DL, ENC2_SERVER_1_ENC1_DL,
                          ENC2_SERVER_2_ENC1_DL]
BSIDE_SERVER_DOWNLINKS = [ENC1_SERVER_1_ENC2_DL, ENC1_SERVER_2_ENC2_DL, ENC2_SERVER_1_ENC2_DL,
                          ENC2_SERVER_2_ENC2_DL]
...
ENC2_SERVER_1_IP_A = '10.11.2.3'      # Esx BFS server and Local RH6.7 static IP
...
bfs_server_profiles = [
    ...
    {'type': SP_TYPE,
     ...
     'boot': {'manageBoot': True, 'order': ['HardDisk']},
     'connectionSettings': {
         'connections': make_conn_data(bfs_conn_data_b)}
     }
]
    ...
    [
        {
            ...
            'usBody': {
                ...
                'manualLoginRedistributionState': 'Supported',
                'connectionMode': 'Auto',
                'portConfigInfos': [{'enclosure': ENC_1, 'bay': '3', 'port': 'Q1',
                                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None
            }
        },
        {
            ...
            'usBody': {
                ...
                'manualLoginRedistributionState': 'Supported',
                'connectionMode': 'Auto',
                'portConfigInfos': [{'enclosure': ENC_1, 'bay': '3', 'port': 'Q8:1',
                                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None
            }
        },
        {
            ...
            'usBody': {
                ...
                'manualLoginRedistributionState': 'Supported',
                'connectionMode': 'Auto',
                'portConfigInfos': [{'enclosure': ENC_1, 'bay': '3', 'port': 'Q7',
                                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None
            }
        },
        {
            ...
            'usBody': {
                ...
                'manualLoginRedistributionState': 'Supported',
                'connectionMode': 'Auto',
                'portConfigInfos': [{'enclosure': ENC_1, 'bay': '3', 'port': NEG_UPLINK_PORT,
                                     'desiredSpeed': 'Auto'},
                                    {'enclosure': ENC_2, 'bay': '6', 'port': NEG_UPLINK_PORT,
                                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None}
        },
        {
        ...
        },
        {
            ...
            'usBody': {
                ...
                'connectionMode': 'Auto',
                'portConfigInfos': [
                    {'enclosure': ENC_1, 'bay': '3', 'port': ALREADY_ASSIGNED_PORT,
                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None}
        },
        {
            ...
            'usBody': {
                ...
                'manualLoginRedistributionState': 'Supported',
                'connectionMode': 'Auto',
                'portConfigInfos': [{'enclosure': ENC_1, 'bay': '3', 'port': 'Q10:1',
                                     'desiredSpeed': 'Auto'}],
                'logicalInterconnectUri': None}
        }
    ]
