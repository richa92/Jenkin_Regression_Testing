...
network_sets = [{"name": "Netset1", "networkUris": ["Net-Vlan401"], "connectionTemplateUri":None, "type":"network-setV5", "nativeNetworkUri":None},
                {"name": "Netset2", "networkUris": ["Net-Vlan401", "Net-Vlan402", "Net-Vlan403"], "connectionTemplateUri":None, "type":"network-setV5", "nativeNetworkUri":None}
                ]
...
server_profiles = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 4',
                    ...
                    'name': ENC1 + '_Bay4', 'description': 'Gen9 Win', 'affinity': 'Bay',
...
server_profiles1 = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 6',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:' + enc_group['name'],
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay6', 'description': 'Gen9 Win', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                     'connectionSettings': {
                         'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
...
server_profiles2 = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 6',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:' + enc_group['name'],
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay6', 'description': 'Gen9 Win', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
...
server_profiles3 = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 6',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:' + enc_group['name'],
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay6', 'description': 'Gen9 Win', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
...
server_profiles4 = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 6',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:' + enc_group['name'],
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay6', 'description': 'Gen9 Win', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
...
ilo_details_enc1_bay4 = {'ilo_ip': '15.245.133.62', 'username': 'Administrator', 'password': 'hpvse123'}
ilo_details_enc2_bay4 = {'ilo_ip': '15.245.133.132', 'username': 'Administrator', 'password': 'hpvse123'}
...
ping_cmd_enc2_bay4 = ['ping -S 10.11.1.55 10.12.1.101>1.txt',
                      'ping -S 10.12.1.101 10.11.1.55>2.txt'
                      ]
