...
IC3_DA_WWN_1 = '20:21:00:02:ac:01:ee:50'
IC3_DA_WWN_2 = '21:21:00:02:ac:01:ee:50'
IC6_DA_WWN_1 = '20:22:00:02:ac:01:ee:50'
IC6_DA_WWN_2 = '21:22:00:02:ac:01:ee:50'
...
# For LI uplinkset uplinks speed change
li_uplinksets = {
    'US_DA1_8Gb':
        li_fc_us(name=ASIDE_UPLINK_SETS[0],
                 fcNetworkUris=['DA1'],
...
bfs_conn_data_a = [
    ...
    {'name': 'conn-fc', 'functionType': 'FibreChannel', 'portId': MZ + ':1-b',
     ...
     'boot': {'priority': 'Primary',
              ...
              'targets': [
                  {'arrayWwpn': da_3par_wwpn_Aside_1, 'lun': '0'},
                  {'arrayWwpn': da_3par_wwpn_Aside_2, 'lun': '0'}
              ]},
     },
    {'name': 'conn-fc2', 'functionType': 'FibreChannel', 'portId': 'Auto',
     'networkUri': 'FC:DA2',
     'boot': {'priority': 'Secondary',
              'bootVolumeSource': 'UserDefined',
              'targets': [
                  {'arrayWwpn': da_3par_wwpn_Bside_1, 'lun': '0'},
                  {'arrayWwpn': da_3par_wwpn_Bside_2, 'lun': '0'}
              ]},
     }
]
...
# For connection map and 3par attached device verification, and downlink disable case
