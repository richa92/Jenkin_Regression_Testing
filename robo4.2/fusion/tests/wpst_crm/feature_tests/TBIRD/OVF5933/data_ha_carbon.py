...
ethernet_networks = [{'type': 'ethernet-networkV4', 'ethernetNetworkType': 'Tagged', 'name': 'eth_401', 'privateNetwork': False, 'purpose': 'General', 'smartLink': True, 'vlanId': 401},
                     {'type': 'ethernet-networkV4', 'ethernetNetworkType': 'Tagged', 'name': 'eth_403', 'privateNetwork': False, 'purpose': 'General', 'smartLink': True, 'vlanId': 403}
                     ]
...
snmp_host = '15.186.25.25'
snmp_user = 'root'
snmp_pass = 'password@123'
server_bay = ['CN754406W5, bay 2']
...
ENC1_SERVER_Fc_ILO = {'ilo_ip': '15.245.132.77', 'username': 'Administrator', 'password': 'hpvse123', 'OS': 'windows'}

ILO_List = [ENC1_SERVER_Fc_ILO]

ENC1_SERVER_FcoE_cred = {'username': 'Administrator', 'password': 'hpvse@1', 'ip': '', 'gateway_ip': ''}
