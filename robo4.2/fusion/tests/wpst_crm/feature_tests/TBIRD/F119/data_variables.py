...
ilo_details1 = {'ilo_ip': '', 'username': 'Administrator', 'password': 'hpvse123'}

ilo_details = {'ilo_ip': '', 'username': 'Administrator', 'password': 'Hpvse@1'}

server_details1 = {'username': 'Administrator', 'password': 'hpvse@1'}
...
ic_firmwareVersion_old = '1.02.05'
ic_firmwareVersion_new = '1.02.06'

old_SPP_bundle = 'SPP2016100.2016_1015.191.iso'
latest_SPP_bundle = 'SPP2017070.2017_0528.144.iso'
...
INTERCONNECTS = ['CN7545049F, interconnect 1', 'CN7545049F, interconnect 4']
...
Linked_Uplink_port = ['1', '2', '3']
Linked_Downlink_port = ['d1', 'd2']
...
uplink_sets = {'UplinkSet_1': {'name': 'UplinkSet_1', 'networkType': 'FibreChannel', 'ethernetNetworkType': None, 'networkUris': ['FC_1'], 'mode': 'Auto', 'lacpTimer': 'Short', 'primaryPort': None,
               ...
               'UplinkSet1_20580': {'name': 'UplinkSet_1', 'networkType': 'FibreChannel', 'ethernetNetworkType': None, 'networkUris': ['FC_1'], 'mode': 'Auto', 'lacpTimer': 'Short', 'primaryPort': None,
                                    'logicalPortConfigInfos': [{'bay': '1', 'enclosure': '-1', 'port': '1', 'speed': 'Speed4G'}]},
               ...
               'UplinkSet1_20581': {'name': 'UplinkSet_1', 'networkType': 'FibreChannel', 'ethernetNetworkType': None, 'networkUris': ['FC_1'], 'mode': 'Auto', 'lacpTimer': 'Short', 'primaryPort': None,
                                    'logicalPortConfigInfos': [{'bay': '1', 'enclosure': '-1', 'port': '1', 'speed': 'Speed8G'}]},
...
PROFILE1 = 'CN7545049F_Bay1-Carbon'
PROFILE2 = 'CN7545049F_Bay2-Carbon'

PROFILES = ['CN7545049F_Bay1-Carbon', 'CN7545049F_Bay2-Carbon']
...
server_profile3 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG_1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                    'name': PROFILE1, 'description': 'Server using Carbon', 'affinity': 'Bay',
                    'boot': {'manageBoot': False},
                    'bootMode': None,
                    'connections': [{'id': 1, 'name': 'Downlink_1', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_1'}
                                    ]}
                   ]
...
server_profiles = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                   ...
                   [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                     ...
                     'boot': {'manageBoot': False},
                     'bootMode': None,
                     'connections': [{'id': 1, 'name': 'Downlink_3', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1'},
                                     {'id': 2, 'name': 'Downlink_4', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_2'}
                                     ]}]
                   ]
...
server_profile_20634 = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                          ...
                          'bootMode': None,
                          'connections': [{'id': 1, 'name': 'Downlink_1', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1'},
                                          {'id': 2, 'name': 'Downlink_2', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_2'}
                                          ]}],
                        [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                          'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG_1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                          'name': PROFILE2, 'description': 'Server using Carbon', 'affinity': 'Bay',
                          ...
                          'bootMode': None,
                          'connections': [{'id': 1, 'name': 'Downlink_3', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1'},
                                          {'id': 2, 'name': 'Downlink_4', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_2'}
                                          ]}]
                        ]

server_profile_20503 = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                          'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG_1', 'serialNumberType': 'UserDefined', 'macType': 'Virtual', 'wwnType': 'Virtual',
                          'name': PROFILE1, 'description': 'Server using Carbon', 'affinity': 'Bay',
                          'boot': {'manageBoot': False},
                          'bootMode': None,
                          'connections': [{'id': 1, 'name': 'Downlink_1', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1'},
                          ...
                          'serialNumber': 'VCX3598765', 'uuid': '2dc0ab1f-dd38-4f20-babc-53868065ce10'
                          }],
                        [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                          'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG_1', 'serialNumberType': 'UserDefined', 'macType': 'Physical', 'wwnType': 'Physical',
                          'name': PROFILE2, 'description': 'Server using Carbon', 'affinity': 'Bay',
                          'boot': {'manageBoot': False},
                          'bootMode': None,
                          'connections': [{'id': 1, 'name': 'Downlink_3', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1'},
                          ...
                          'serialNumber': 'VCU8956471', 'uuid': '3fc1d67b-cc46-5d18-abbc-89562348bc01'
                          }]
                        ]
...
multi_profile = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                 ...
                 [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                   ...
                   'boot': {'manageBoot': False},
                   'bootMode': None,
                   'connections': [{'id': 1, 'name': 'Downlink_3', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_1'},
                                   {'id': 2, 'name': 'Downlink_4', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_2'}
                                   ]}]
                 ]
...
profile_20994 = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                 ...
                 [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                   ...
                   'boot': {'manageBoot': False},
                   'bootMode': None,
                   'connections': [{'id': 1, 'name': 'Downlink_2', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_2'}
                                   ]}]
                 ]
...
server_profiles_20635 = [[{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                           ...
                           'boot': {'manageBoot': False},
                           'bootMode': None,
                           'connections': [{'id': 1, 'name': 'Downlink_1', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_20635'},
                                           {'id': 2, 'name': 'Downlink_2', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_2'},
                                           ]}],
                         [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 2',
                           'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG_1', 'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                           ...
                           'boot': {'manageBoot': False},
                           'bootMode': None,
                           'connections': [{'id': 1, 'name': 'Downlink_3', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_20635'},
                                           {'id': 2, 'name': 'Downlink_4', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': '16000', 'networkUri': 'FC:FC_2'},
                                           ]}]
                         ]
...
profile_redundant_electron = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                               ...
                               'bootMode': None,
                               'connections': [{'id': 1, 'name': 'Downlink_1', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_1',
                                                'wwnn': '20:00:7E:9B:F9:0B:00:00', 'wwpn': '10:00:7E:9B:F9:0B:00:00', 'wwpnType': 'UserDefined'},
                                               {'id': 2, 'name': 'Downlink_2', 'functionType': 'FibreChannel', 'portId': 'Auto', 'requestedMbps': 'Auto', 'networkUri': 'FC:FC_2',
...
val_sp1_20503 = {'serialNumberType': 'UserDefined', 'serialNumber': 'VCX3598765', 'uuid': '2dc0ab1f-dd38-4f20-babc-53868065ce10'}
val_sp2_20503 = {'serialNumberType': 'UserDefined', 'serialNumber': 'VCU8956471', 'uuid': '3fc1d67b-cc46-5d18-abbc-89562348bc01'}
