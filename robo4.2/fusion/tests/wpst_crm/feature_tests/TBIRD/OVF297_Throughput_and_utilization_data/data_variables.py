...
ligs = {'lig1':
        ...
        {'name': Lig_name,
         ...
         'ethernetSettings': None,
         'state': 'Active',
         'telemetryConfiguration': {"type": "telemetry-configuration", "enableTelemetry": 'true', "sampleCount": 60, "sampleInterval": 60},
         'snmpConfiguration': {'type': 'snmp-configuration',
                               'readCommunity': 'public',
                               'systemContact': '',
                               'enabled': 'true',
        ...
        'lig_neg': {'name': Lig_name,
                    ...
                    'ethernetSettings': None,
                    'state': 'Active',
                    'telemetryConfiguration': {"type": "telemetry-configuration", "enableTelemetry": 'true', "sampleCount": 60, "sampleInterval": 0},
                             'snmpConfiguration': {'type': 'snmp-configuration',
                                                   'readCommunity': 'public',
                                                   'systemContact': '',
                                                   'enabled': 'true',
        ...
        'lig_neg1': {'name': Lig_name,
                     ...
                     'ethernetSettings': None,
                     'state': 'Active',
                     'telemetryConfiguration': {"type": "telemetry-configuration", "enableTelemetry": 'true', "sampleCount": 0, "sampleInterval": 60},
                              'snmpConfiguration': {'type': 'snmp-configuration',
                                                    'readCommunity': 'public',
                                                    'systemContact': '',
                                                    'enabled': 'true',
...
LI = les['le1']['name'] + '-' + Lig_name + '-1'
LI_A = les['le2']['name'] + '-' + Lig_name_A + '-1'
LI_B = les['le3']['name'] + '-' + Lig_name_B + '-1'

fc_bay_num_4 = uplink_sets['UplinkSet_2']['logicalPortConfigInfos'][0]['bay']
portno_for_statistics_4_1 = uplink_sets['UplinkSet_2']['logicalPortConfigInfos'][0]['port']

fc_bay_num_1 = uplink_sets['UplinkSet_1']['logicalPortConfigInfos'][0]['bay']
portno_for_statistics_1_Q1 = "Q1:1"
...
telemetry_60 = {"type": "telemetry-configuration", "enableTelemetry": "true", "sampleCount": 60, "sampleInterval": 60}
telemetry_24 = {"type": "telemetry-configuration", "enableTelemetry": "true", "sampleCount": 24, "sampleInterval": 3600}
...
server_profiles_B_side = [{'type': 'ServerProfileV11', 'serverHardwareUri': ENC1 + ', bay 2',
