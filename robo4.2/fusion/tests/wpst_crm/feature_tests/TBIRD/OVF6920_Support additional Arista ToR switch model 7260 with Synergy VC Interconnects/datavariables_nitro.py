...
ETH_UPLINKS = ['Q6:2', 'Q6:1']

# Ethernet uplink ports of Nitro IC6
ETH2_UPLINKS = ['Q6:2', 'Q6:1']
...
# The uplink & switch ports used for test case 1 - Uplink ports are on a single Nitro connected to a Arista-1 ToR switch (Single-homed from the Nitro)

UP_Ports_TC1 = ['Q6:2']  # uplink ports of Nitro IC3 connected to Arista1
Switch_ports_TC1 = ['65']  # Arista1 ports connected to IC3 Nitro
# port 65 -> Q6.1(IC3)  -> ARISTA1

# The uplink & switch ports used for test case 2 - All ULS ports are on a single Nitro with at least 1 port connected to each Arista ToR switch in a 2 switch configuration (Dual-homed from each Nitro)

UP_Ports_TC2_SW1 = ['Q6:2']  # uplink ports of Nitro IC3 connected to Arista1
UP_Ports_TC2_SW2 = ['Q6:1']  # uplink ports of Nitro IC3 connected to Arista2
Switch1_ports_TC2 = ['65']  # Arista1 ports connected to IC3 Nitro
Switch2_ports_TC2 = ['65']  # Arista2 ports connected to IC3 Nitro

# port 65 -> Q6.2(IC3)  -> ARISTA1
# port 65 -> Q6.1(IC3)  -> ARISTA2
...
Uplink_bay2 = ['Q6:2']  # uplink ports of Nitro IC3 connected to Arista 1
Uplink_bay5 = ['Q6:2']  # uplink ports of Nitro IC6 connected to Arista 1
UP_Ports_TC3 = ['Q6:2', 'Q6:2']  # uplink ports used from two Nitro connecting to Arista 1
Switch_ports_TC3 = ['65', '66']  # Arista1 ports connecting to two Nitro

# port 65 -> Q6.1(IC3), port 66 -> Q6.1(IC6)  ->  ARISTA1

# The uplink & switch ports used for test case 4 & 6 - uplink ports span both Nitro with at least 2 ports from each Nitro connected a different Arista ToR switch in a 2 switch configuration (Dual-homed from each Nitro)
# Test case 6 is A side & B side with same port configuration

UP_Ports_TC4_SW1 = ['Q6:2', 'Q6:2']  # uplink ports of Nitro IC3, IC6 connected to Arista1
UP_Ports_TC4_SW2 = ['Q6:1', 'Q6:1']  # uplink ports of Nitro IC3, IC6 connected to Arista2
Switch1_ports_TC4 = ['65', '66']  # Arista1 ports connecting to two Nitro
Switch2_ports_TC4 = ['65', '66']  # Arista2 ports connecting to two Nitro

# ports 65 -> Q6.1(IC3), port 66 -> Q6.1(IC6)  ->  (ARISTA 1)
# ports 65 -> Q6.2(IC3), port 66 -> Q6.2(IC6)  ->  (ARISTA 2)

# Test case 5 - Disabling Arista1 port 1:1 and Enabling the same port
Switch_ports_TC5 = ['65', '66']  # Arista1 port which is disabled
port_no = ['65', '66']  # This is the switch port.

# Arista 1 port 65 -> Q6.2 (IC3)
# Arista 1 port 66 -> Q6.2 (IC6)
...
uplink_sets_in_ligA = [{
    ...
    'logicalPortConfigInfos': [
        {'enclosure': '1', 'bay': '3', 'port': ETH_UPLINKS[0], 'speed': 'Auto'},
        {'enclosure': '1', 'bay': '3', 'port': ETH_UPLINKS[1], 'speed': 'Auto'}]
...
uplink_sets_in_ligB = [{
    ...
    'mode': 'Auto',
    'nativeNetworkUri': None,
    'logicalPortConfigInfos': [{'enclosure': '2', 'bay': '6', 'port': ETH2_UPLINKS[0], 'speed': 'Auto'},
                               {'enclosure': '2', 'bay': '6', 'port': ETH2_UPLINKS[1], 'speed': 'Auto'}]
}]
...
US_names = ['US_Splitter']
Uplink_port = ['Dual_Homed_single', 'Single_Homed_double', 'Dual_Homed_double']
...
li_uplinksets = {
    'Dual_Homed_single':
        {'name': 'US_Splitter',
         ...
         'connectionMode': 'Auto',
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[1], 'desiredSpeed': 'Auto'}],
    ...
    'Single_Homed_double':
        {'name': 'US_Splitter',
         ...
         'connectionMode': 'Auto',
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '6', 'port': ETH2_UPLINKS[0], 'desiredSpeed': 'Auto'}],
         'logicalInterconnectUri': None},
    ...
    'Dual_Homed_double':
        {'name': 'US_Splitter',
         ...
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[1], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '6', 'port': ETH2_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '6', 'port': ETH2_UPLINKS[1], 'desiredSpeed': 'Auto'}]
         }
}
...
# based on ip's i have redirected to each file used for test case9
ping_server1 = ['ping server_ip -t > test1.txt', 'ping server_ip -t > test2.txt']

ping_server2 = ['ping server_ip -t > test3.txt', 'ping server_ip -t > test4.txt']

# Ping gateway continuously
ping_cont_gateway_server1 = ['ping server_ip > gate1.txt', 'ping server_ip > gate2.txt']

ping_cont_gateway_server2 = ['ping server_ip > gate3.txt', 'ping server_ip > gate4.txt']
...
cont_ping_files = [ping1, ping2, ping3, ping4, ping5, ping6, ping7, ping8]
