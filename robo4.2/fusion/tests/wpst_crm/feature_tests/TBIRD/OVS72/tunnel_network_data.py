...
networks = [{'name': n,
             ...
             'smartLink': True,
             'privateNetwork': False,
             'ethernetNetworkType': 'Tunnel'} for n in rlist(100, 233, 'tunn_')]

network_129 = [{'name': 'tunn_229',
                'type': 'ethernet-networkV4',
                'vlanId': 229,
                'purpose': 'General',
                'smartLink': True,
...
updated_internal_network_list = ['tunn_229']
vlan_reserved_pools = [{
    'start': 1,
    'length': 129,
    'type': 'vlan-pool'
