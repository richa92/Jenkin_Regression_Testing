...
ETH_UPLINKS = ['Q1', 'Q3', 'Q4', 'Q5']

# Ethernet uplink ports of potash IC5
ETH2_UPLINKS = ['Q2', 'Q3', 'Q4', 'Q5']
...
SWITCH1 = '15.245.128.177'
SWITCH2 = '15.245.128.139'

# Switch Credentials
Switch1_cred = {'username': 'admin', 'password': 'wpsthpvse1'}
...
UP_Ports_TC1 = ['Q1', 'Q3']  # uplink ports of Potash IC 2 connected to Arista1
Switch_ports_TC1 = ['1.1', '2.1']  # Arista1 ports connected to IC2 potash
# port 1.1 -> Q1(IC2), port 2.1 -> Q3(IC2)  -> ARISTA1

# The uplink & switch ports used for test case 2 - All ULS ports are on a single Potash with at least 1 port connected to each Arista ToR switch in a 2 switch configuration (Dual-homed from each Potash)

UP_Ports_TC2_SW1 = ['Q1', 'Q3']  # uplink ports of potash IC 2 connected to Arista1
UP_Ports_TC2_SW2 = ['Q4', 'Q5']  # uplink ports of potash IC 2 connected to Arista2
Switch1_ports_TC2 = ['1.1', '2.1']  # Arista1 ports connected to IC2 potash
Switch2_ports_TC2 = ['1.1', '2.1']  # Arista2 ports connected to IC2 potash

# port 1.1 -> Q1(IC2), port 2.1 -> Q3(IC2)   -> ARISTA1
# port 1.1 -> Q4(IC2), port 2.1 -> Q5(IC2)   -> ARISTA2

# The uplink & switch ports used for test case 3 - Uplink ports span both Potash and all ports are connected to a single Arista ToR switch in a 2 switch configuration (Single-homed from each Potash)

Uplink_bay2 = ['Q1', 'Q3']  # uplink ports of potash IC 2 connected to Arista 1
Uplink_bay5 = ['Q2', 'Q3']  # uplink ports of potash IC 5 connected to Arista 1
UP_Ports_TC3 = ['Q1', 'Q3', 'Q2', 'Q3']  # uplink ports used from two potash connecting to Arista 1
Switch_ports_TC3 = ['1.1', '2.1', '3.1', '4.1']  # Arista1 ports connecting to two potash

# port 1.1 -> Q1(IC2), port 2.1 -> Q3(IC2) , port 3.1 -> Q2(IC5), port 4.1 -> Q3(IC5)  -> ARISTA1

# The uplink & switch ports used for test case 4 & 6 - uplink ports span both Potash with at least 2 ports from each Potash connected a different Arista ToR switch in a 2 switch configuration (Dual-homed from each Potash)
# Test case 6 is A side & B side with same port configuration

UP_Ports_TC4_SW1 = ['Q1', 'Q3', 'Q2', 'Q3']  # uplink ports of Potash IC2, IC5 connected to Arista1
UP_Ports_TC4_SW2 = ['Q4', 'Q5', 'Q4', 'Q5']  # uplink ports of Potash IC2, IC5 connected to Arista1
Switch1_ports_TC4 = ['1.1', '2.1', '3.1', '4.1']  # Arista1 ports connecting to two potash
Switch2_ports_TC4 = ['1.1', '2.1', '3.1', '4.1']  # Arista2 ports connecting to two potash

# ports 1.1 -> Q1(IC2), port 2.1 -> Q3(IC2) , port 3.1 -> Q2(IC5), port 4.1 -> Q3(IC5) (ARISTA 1)
# ports 1.1 -> Q4(IC2), port 2.1 -> Q5(IC2) , port 3.1 -> Q4(IC5), port 4.1 -> Q5(IC5) (ARISTA 2)

# Test case 5 - Disabling Arista1 port 1:1 and Enabling the same port

UP_Ports_TC5 = ['Q1']  # uplink ports from potash IC2 connecting to Arista1 1:1
Switch_ports_TC5 = ['1.1']  # Arista1 port which is disabled
port_no = 1  # This is the switch port.For evaluating index of switch port in script I have used this variable

# Arista 1 port 1:1 -> Q1 (IC2)
...
uplink_sets_in_lig = [{
    ...
    'logicalPortConfigInfos': [
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[0], 'speed': 'Auto'},
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[1], 'speed': 'Auto'}]
}]
...
uplink_sets_in_ligA = [{
    ...
    'logicalPortConfigInfos': [
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[0], 'speed': 'Auto'},
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[1], 'speed': 'Auto'},
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[2], 'speed': 'Auto'},
            {'enclosure': '1', 'bay': '2', 'port': ETH_UPLINKS[3], 'speed': 'Auto'}]
}]
...
uplink_sets_in_ligB = [{
    ...
    'logicalPortConfigInfos': [
            ...
            {'enclosure': '2', 'bay': '5', 'port': ETH2_UPLINKS[1], 'speed': 'Auto'},
            {'enclosure': '2', 'bay': '5', 'port': ETH2_UPLINKS[2], 'speed': 'Auto'},
            {'enclosure': '2', 'bay': '5', 'port': ETH2_UPLINKS[3], 'speed': 'Auto'}]
}]
...
server_profiles_AB = [{'type': 'ServerProfileV10',
                       'serverHardwareUri': ENC1 + ', bay 1',
                       'serverHardwareTypeUri': '',
                       'enclosureUri': 'ENC:' + ENC1,
...
LSG1 = {'name': LSG,
        ...
        'switchMapTemplate': {'switchMapEntryTemplates': [
            {'logicalLocation': {'locationEntries': [{'relativeValue': 1, 'type': 'StackingMemberId'}]},
             'permittedSwitchTypeUri': 'SWT:Arista 7060X'}, {'logicalLocation': {'locationEntries': [{'relativeValue': 2, 'type': 'StackingMemberId'}]}, 'permittedSwitchTypeUri': 'SWT:Arista 7060X'}
        ]}}
...
Uplink_port = ['Dual_Homed_single', 'Single_Homed_double', 'Dual_Homed_double', 'Single_Homed_Single']
...
li_uplinksets = {
    'Dual_Homed_single':
        {'name': 'Single_Homed',
         ...
         'connectionMode': 'Auto',
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[1], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[2], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[3], 'desiredSpeed': 'Auto'}],
    ...
    'Single_Homed_double':
        {'name': 'Single_Homed',
         ...
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[1], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[1], 'desiredSpeed': 'Auto'}],
         'logicalInterconnectUri': None},
    ...
    'Dual_Homed_double':
        {'name': 'Single_Homed',
         ...
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '2', 'port': ETH_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             ...
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[0], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[1], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[2], 'desiredSpeed': 'Auto'},
                             {'enclosure': ENC2, 'bay': '5', 'port': ETH2_UPLINKS[3], 'desiredSpeed': 'Auto'}]
         },
...
ping_cmd = 'ping server_ip > sample.txt'

# ping command for server to gateway ping
ping_gateway = 'ping 10.11.0.1 > sample1.txt'
