    ...
    'BFS': {
        ...
        'interconnectMapTemplate': [
            {'bay': 3, 'enclosure': 1,
             ...
             'enclosureIndex': 1},
            {'bay': 6, 'enclosure': 2,
             'type': 'Virtual Connect SE 40Gb F32 Module for Synergy',
             'enclosureIndex': 2},
            {'bay': 6, 'enclosure': 1,
             'type': 'Synergy 20Gb Interconnect Link Module',
             'enclosureIndex': 1},
...
server_profiles = [{'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 1',
                   ...
                   {'type': 'ServerProfileV10', 'serverHardwareUri': ENC1 + ', bay 3',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:%s' % EG2,
                    'serialNumberType': 'Virtual', 'macType': 'Virtual', 'wwnType': 'Virtual',
                    'name': ENC1 + '_Bay3_Gen10_Quack', 'description': 'Gen10_Win', 'affinity': 'Bay',
                    'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'connectionSettings': {
                        'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
                   ...
                   {'type': 'ServerProfileV10', 'serverHardwareUri': ENC2 + ', bay 2',
                    ...
                    'name': ENC2 + '_Bay2_Gen10_Quack_BFS', 'description': 'Gen10_Win', 'affinity': 'Bay',
                    'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'connectionSettings': {
                        'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
                                        ...
                                        {'id': 3, 'name': '3', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:1-b',
                                         'requestedMbps': '2500', 'networkUri': 'FCOE:fcoe-30',
                                         'boot': {'priority': 'Primary', 'bootVolumeSource': 'UserDefined',
                                                  'targets': [{'arrayWwpn': '20230002AC01D4DB', 'lun': '1'}]}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                                        {'id': 4, 'name': '4', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:2-b',
                                         'requestedMbps': '2500', 'networkUri': 'FCOE:fcoe-40',
                                         'boot': {'priority': 'Secondary', 'bootVolumeSource': 'UserDefined',
                                                  'targets': [{'arrayWwpn': '21230002AC01D4DB', 'lun': '1'}]}, 'mac': None, 'wwpn': '', 'wwnn': ''}
                                        ]}}
                   ]
...
ilo_details = [{'ilo_ip': '15.245.132.194', 'username': 'Administrator', 'password': 'hpvse123'},  # Enc2Bay1-Windows-Gen9-Bronco
               {'ilo_ip': '15.245.132.204', 'username': 'Administrator', 'password': 'hpvse123'},  # Enc2Bay2-BFS-Windows-Gen10-Quack
...
server_credentials = [{'userName': 'Administrator', 'password': '-hpvse123.'}, {'userName': 'Administrator', 'password': 'Wpsthpvse@1'}, {'userName': 'Administrator', 'password': '-hpvse123.'}]
server_BFS_Enc1_bay1 = {'ip': '10.11.1.84', 'username': 'root', 'password': '-hpvse123.'}
...
diskspd_cmd = ['cmd /c "C:\Users\Administrator\Desktop\diskspd.exe -c50M -d60 -r -w70 -t9 -o9 -b10K -h -L D:\sample.dat >C:\sample1.dat"',
               'cmd /c "C:\Users\Administrator\Desktop\Diskspd\diskspd.exe -c50M -d60 -r -w70 -t9 -o9 -b10K -h -L C:\sample.dat >C:\sample2.dat"',
               'cmd /c "C:\Users\Administrator\Desktop\Diskspd\diskspd.exe -c50M -d60 -r -w70 -t9 -o9 -b10K -h -L F:\sample.dat >C:\sample1.dat"'
               ]
Interconnect_name = [ENC1 + ', ' + 'interconnect 3', ENC2 + ', ' + 'interconnect 6']
dw_ports_3 = ['d1', 'd3', 'd13', 'd14']
dw_ports_6 = ['d1', 'd2', 'd13', 'd15']
port_name = ['Q4:1', 'Q4:1']
