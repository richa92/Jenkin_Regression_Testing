...
icmap_1 = \
    [
        ...
        {'bay': 6, 'enclosure': 1, 'type': 'Synergy 10Gb Interconnect Link Module', 'enclosureIndex': 2}
    ]
...
ENC1_SP_1_NAME = 'Enc1_Bay3'
ENC2_SP_1_NAME = 'Enc2_Bay7'
ENC1_SP_2_NAME = 'Enc1_Bay10'
ENC2_SP_2_NAME = 'Enc2_Bay2'
server_profile_names = [ENC1_SP_1_NAME, ENC1_SP_2_NAME, ENC2_SP_1_NAME, ENC2_SP_2_NAME]

# servers name

ENC1_SERVER_1 = '%s, bay 3' % ENC1
ENC2_SERVER_1 = '%s, bay 7' % ENC2
ENC1_SERVER_2 = '%s, bay 10' % ENC1
ENC2_SERVER_2 = '%s, bay 2' % ENC2
...
ilo_details = [{'ilo_ip': '15.245.132.57', 'username': 'Administrator', 'password': 'hpvse123'},
               {'ilo_ip': '15.245.132.37', 'username': 'Administrator', 'password': 'hpvse123'},
               {'ilo_ip': '15.245.132.53', 'username': 'Administrator', 'password': 'hpvse123'},
               {'ilo_ip': '15.245.132.153', 'username': 'Administrator', 'password': 'hpvse1'}]

server_details = [{'username': 'Administrator', 'password': 'Hpvse@1'}, {'username': 'Administrator', 'password': 'hpvse1'},
                  {'username': 'Administrator', 'password': 'hpvse1'}, {'username': 'Administrator', 'password': 'hpvse1'}]
...
server_profiles = [{'type': 'ServerProfileV10',
                    ...
                    'connectionSettings': {'connections': [{'id': 1,
                                                            ...
                                                            'portId': 'Mezz 3:1-a',
                                                            'requestedMbps': getEnetRBW(ENC_CLTYPE),
                                                           ...
                                                           {'id': 3,
                                                            ...
                                                            'portId': 'Auto',
                                                            'requestedMbps': getFcRBW(ENC_CLTYPE),
                                                            'networkUri': 'FC:DA1',
                                                            'mac': None,
                                                            'wwpn': None,
                                                            'wwnn': None},
...
diskspd_cmd = ["C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d1200 -r -w70 -t9 -o9 -b10K -h -L E:\\sample.dat >C:\\OVF5609_file1.dat",
               "C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d1200 -r -w70 -t9 -o9 -b10K -h -L D:\\sample.dat >C:\\OVF5609_file2.dat",
               "C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d900 -r -w70 -t9 -o9 -b10K -h -L D:\\sample.dat >C:\\OVF5609_file3.dat",
               "C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d900 -r -w70 -t9 -o9 -b10K -h -L D:\\sample.dat >C:\\OVF5609_file4.dat"]

diskspd_cmd1 = ["C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d500 -r -w70 -t9 -o9 -b10K -h -L E:\\sample.dat >C:\\OVF5609_file1.dat",
                "C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d300 -r -w70 -t9 -o9 -b20K -h -L E:\\sample.dat >C:\\OVF5609_file1.dat",
                "C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d300 -r -w70 -t9 -o9 -b30K -h -L E:\\sample.dat >C:\\OVF5609_file1.dat"]
...
diskspd_cmd_3600 = ["C:\\Users\\Administrator\\Desktop\\Diskspd\\diskspd.exe -c50M -d3600 -r -w70 -t9 -o9 -b10K -h -L E:\\sample.dat >C:\\OVF5609_file1.dat",
