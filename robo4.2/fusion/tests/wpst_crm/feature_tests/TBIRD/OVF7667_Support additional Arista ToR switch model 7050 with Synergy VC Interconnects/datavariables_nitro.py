...
# IP Series to be changed according to valid ip we get
IP_Series = '10\\.\\d+\\.\\d+\\.\\d+'
...
SWITCH1 = '15.245.128.216'
SWITCH2 = '15.245.128.215'

# Switch Credentials
Switch1_cred = {'username': 'admin', 'password': 'password'}
Switch2_cred = {'username': 'admin', 'password': 'password'}
...
UP_Ports_TC1 = ['Q5:1']  # uplink ports of Nitro IC3 connected to Arista1
Switch_ports_TC1 = ['25']  # Arista1 ports connected to IC3 Nitro
# port 25 -> Q5.1(IC3)  -> ARISTA1
...
UP_Ports_TC2_SW1 = ['Q5:1']  # uplink ports of Nitro IC3 connected to Arista1
UP_Ports_TC2_SW2 = ['Q3']  # uplink ports of Nitro IC3 connected to Arista2
Switch1_ports_TC2 = ['25']  # Arista1 ports connected to IC3 Nitro
Switch2_ports_TC2 = ['51']  # Arista2 ports connected to IC3 Nitro

# port 25 -> Q5.1(IC3)  -> ARISTA1
# port 51 -> Q3(IC3)  -> ARISTA2
...
Uplink_bay2 = ['Q5:1']  # uplink ports of Nitro IC3 connected to Arista 1
Uplink_bay5 = ['Q3']  # uplink ports of Nitro IC6 connected to Arista 1
UP_Ports_TC3 = ['Q5:1', 'Q3']  # uplink ports used from two Nitro connecting to Arista 1
Switch_ports_TC3 = ['25', '51']  # Arista1 ports connecting to two Nitro

# port 25 -> Q5.1(IC3), port 51 -> Q3(IC6)  ->  ARISTA1
...
UP_Ports_TC4_SW1 = ['Q5:1', 'Q3']  # uplink ports of Nitro IC3, IC6 connected to Arista1
UP_Ports_TC4_SW2 = ['Q3', 'Q5:1']  # uplink ports of Nitro IC3, IC6 connected to Arista2
Switch1_ports_TC4 = ['25', '51']  # Arista1 ports connecting to two Nitro
Switch2_ports_TC4 = ['51', '25']  # Arista2 ports connecting to two Nitro

# ports 51 -> Q3(IC3), port 25 -> Q3(IC6)  ->  (ARISTA 1)
# ports 51 -> Q5(IC3), port 25 -> Q5(IC6)  ->  (ARISTA 2)

# Test case 5 - Disabling Arista1 port 1:1 and Enabling the same port

UP_Ports_TC5 = ['Q5:1']  # uplink ports from Nitro IC3 connecting to Arista1 51
Switch_ports_TC5 = ['25', '51']  # Arista1 port which is disabled
port_no = ['25', '51']  # This is the switch port.

# Arista 1 port 25 -> Q5.1 (IC3)
# Arista 1 port 51 -> Q3 (IC6)
...
uplink_sets_in_ligB = [{
    ...
    'mode': 'Auto',
    'nativeNetworkUri': None,
    'logicalPortConfigInfos': [{'enclosure': '2', 'bay': '6', 'port': ETH2_UPLINKS[1], 'speed': 'Auto'}]
},
    {
    'name': 'US_Unsplitter',
    'ethernetNetworkType': 'Tagged',
...
LSG1 = {'name': LSG,
        ...
        'switchMapTemplate': {'switchMapEntryTemplates': [
            {'logicalLocation': {'locationEntries': [{'relativeValue': 1, 'type': 'StackingMemberId'}]},
             'permittedSwitchTypeUri': 'SWT:Arista 7050X'}, {'logicalLocation': {'locationEntries': [{'relativeValue': 2, 'type': 'StackingMemberId'}]}, 'permittedSwitchTypeUri': 'SWT:Arista 7050X'}
        ]}}
...
Uplink_port = ['Dual_Homed_single', 'Single_Homed_Nitro2', 'Dual_Homed', 'Dual_Homed_Nitro2']
...
li_uplinksets = {
    ...
    'Single_Homed_Nitro2':
        {'name': 'US_Unsplitter',
         ...
         'manualLoginRedistributionState': 'NotSupported',
         'connectionMode': 'Auto',
         'portConfigInfos': [{'enclosure': ENC2, 'bay': '6', 'port': ETH2_UPLINKS[0], 'desiredSpeed': 'Auto'}]
         },
    'Dual_Homed':
        {'name': 'US_Splitter',
         'ethernetNetworkType': 'Tagged',
    ...
    'Dual_Homed_Nitro2':
        {'name': 'US_Unsplitter',
         ...
         'manualLoginRedistributionState': 'NotSupported',
         'connectionMode': 'Auto',
         'portConfigInfos': [{'enclosure': ENC1, 'bay': '3', 'port': ETH_UPLINKS[1], 'desiredSpeed': 'Auto'},
...
uplinkset_unsplitter_li = {
    ...
    'portConfigInfos': [{'desiredSpeed': 'Auto', 'location': {'locationEntries':
                                                              [{'value': ETH_UPLINKS[1], 'type': 'Port'},
                                                               {'value': '3', 'type': 'Bay'},
                                                               {'value': ENC_List[0], 'type': 'Enclosure'
                                                                }]}
                         }],
    'networkType': 'Ethernet',
    'manualLoginRedistributionState': 'NotSupported',
    'logicalInterconnectUri': 'EG:%s' % LI,  # user should defined logical interconnect name
    'connectionMode': 'Auto',
