...
UP_Ports_TC1 = ['Q5']  # uplink ports of Potash IC 2 connected to Arista1
Switch_ports_TC1 = ['49.1']  # Arista1 ports connected to IC2 potash
# port 49 -> Q5(IC2) -> ARISTA1
...
UP_Ports_TC2_SW1 = ['Q5']  # uplink ports of potash IC 2 connected to Arista1
UP_Ports_TC2_SW2 = ['Q3']  # uplink ports of potash IC 2 connected to Arista2
Switch1_ports_TC2 = ['49.1']  # Arista1 ports connected to IC2 potash
Switch2_ports_TC2 = ['49.1']  # Arista2 ports connected to IC2 potash

# port 49.1 -> Q5(IC2)   -> ARISTA1
# port 49.1 -> Q3(IC2)   -> ARISTA2
...
Uplink_bay2 = ['Q5']  # uplink ports of potash IC 2 connected to Arista 1
Uplink_bay5 = ['Q5']  # uplink ports of potash IC 5 connected to Arista 1
UP_Ports_TC3 = ['Q5', 'Q5']  # uplink ports used from two potash connecting to Arista 1
Switch_ports_TC3 = ['49.1', '50']  # Arista1 ports connecting to two potash

# port 49 -> Q5(IC2), port 50 -> Q5(IC5)  -> ARISTA1
...
UP_Ports_TC4_SW1 = ['Q5', 'Q5']  # uplink ports of Potash IC2, IC5 connected to Arista1
UP_Ports_TC4_SW2 = ['Q3', 'Q3']  # uplink ports of Potash IC2, IC5 connected to Arista2
Switch1_ports_TC4 = ['49.1', '50']  # Arista1 ports connecting to two potash
Switch2_ports_TC4 = ['49.1', '50']  # Arista2 ports connecting to two potash

# ports 49 -> Q5(IC2), port 50 -> Q5(IC5) -> (ARISTA 1)
# ports 49 -> Q3(IC2), port 50 -> Q3(IC5) -> (ARISTA 2)

# Test case 5 - Disabling Arista1 port 1:1 and Enabling the same port

Switch_ports_TC5 = ['49.1', '50']  # Arista1 port which is disabled
port_no = ['49.1', '50']  # This is the switch port to disable

# Arista 1 port 49 -> Q5 (IC2)
