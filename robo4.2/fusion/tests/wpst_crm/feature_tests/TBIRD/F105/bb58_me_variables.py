...
ethernet_ranges = [{'prefix': 'net_', 'suffix': '', 'start': 2, 'end': 1001, 'name': None, 'type': 'ethernet-networkV4',
                    'vlanId': None, 'purpose': 'General', 'smartLink': False, 'privateNetwork': False,
                    'connectionTemplateUri': None,
                    'ethernetNetworkType': 'Tagged'},
                   ]
...
uplink_sets = {'us1': {'name': 'us1',
                       ...
                       'networkUris': make_range_list(1001, 1016, 'fcoe-'),
               ...
               'us2': {'name': 'us2',
                       'ethernetNetworkType': 'Tagged',
                       'networkType': 'Ethernet',
                       'networkUris': make_range_list(1017, 1024, 'fcoe-'),
                       'nativeNetworkUri': None,
                       'mode': 'Auto',
                       'lacpTimer': 'Long',
               ...
               'us33a': {'name': 'us-33-exceeds-32max',
                         'ethernetNetworkType': 'Tagged',
                         'networkType': 'Ethernet',
               ...
               'us10': {'name': 'us-spans-multiple-ICMs',
                        'ethernetNetworkType': 'Tagged',
                        'networkType': 'Ethernet',
               ...
               'duplicate-vlan-eth': {'name': 'duplicate-vlan',
                                      'ethernetNetworkType': 'Tagged',
                                      'networkType': 'Ethernet',
               ...
               'AsideIBS3': {'name': 'IBS3-Aside-Q6-40gb',
                             'ethernetNetworkType': 'Tagged',
                             'networkType': 'Ethernet',
               ...
               'BsideIBS3': {'name': 'IBS3-Bside-Q6-40gb',
                             'ethernetNetworkType': 'Tagged',
                             'networkType': 'Ethernet',
...
li_uplink_sets = {'us1': {'name': 'us1',
                          ...
                          'networkUris': [],
                          'fcNetworkUris': [],
                          'fcoeNetworkUris': make_range_list(1029, 1030, 'fcoe-'),
                          'lacpTimer': 'Short',
                  ...
                  'us1-32fcoe': {'name': 'us1',
                                 ...
                                 'nativeNetworkUri': None,
                                 'portConfigInfos': [
                                     {'enclosure': ENC1, 'bay': '3', 'port': 'Q1', 'desiredSpeed': 'Auto'},
                                     {'enclosure': ENC1, 'bay': '3', 'port': 'Q2', 'desiredSpeed': 'Auto'}]},
                  ...
                  'us3': {'name': 'us3',
                          ...
                          'networkUris': [],
                          'fcNetworkUris': [],
                          'fcoeNetworkUris': make_range_list(1009, 1015, 'fcoe-'),
                          'lacpTimer': 'Short',
                          'logicalInterconnectUri': None,
                          'primaryPortLocation': None,
                          'manualLoginRedistributionState': 'NotSupported',
                          'connectionMode': 'Auto',
                          'nativeNetworkUri': None,
                          'portConfigInfos': [{'enclosure': ENC2, 'bay': '6', 'port': 'Q5', 'desiredSpeed': 'Auto'},
                                              {'enclosure': ENC2, 'bay': '6', 'port': 'Q6', 'desiredSpeed': 'Auto'}]},

                  'us1-remove-uplink-port': {'name': 'us1',
                                             'ethernetNetworkType': 'Tagged',
                                             'networkType': 'Ethernet',
                                             'networkUris': [],
                                             'fcNetworkUris': [],
                                             ...
                                             'connectionMode': 'Auto',
                                             'nativeNetworkUri': None,
                                             'portConfigInfos': [{'enclosure': ENC1, 'bay': '3', 'port': 'Q1',
                                                                  'desiredSpeed': 'Auto'}]},
                  'us-1-fcoe': {'name': 'us-1-fcoe',
                                'ethernetNetworkType': 'Tagged',
                                'networkType': 'Ethernet',
                                'networkUris': [],
                                'fcNetworkUris': [],
                                ...
                                'nativeNetworkUri': None,
                                'portConfigInfos': [
                                    {'enclosure': ENC1, 'bay': '3', 'port': 'Q5', 'desiredSpeed': 'Auto'}]},

                  'us-16-fcoe': {'name': 'us-16-fcoe',
                                 'ethernetNetworkType': 'Tagged',
                                 'networkType': 'Ethernet',
                                 'networkUris': [],
                                 'fcNetworkUris': [],
                  ...
                  'BFS': {'name': 'Bside-Q6-40gb',
                          ...
                          'connectionMode': 'Auto',
                          'nativeNetworkUri': None,
                          'portConfigInfos': [{'enclosure': ENC2, 'bay': '6', 'port': 'Q6', 'desiredSpeed': 'Auto'}]},
                  }
...
ligs = {'LIG1': {'name': 'LIG1',
        ...
        'lig2':
            {'name': 'LIG1',
             ...
             'redundancyType': 'HighlyAvailable',
             'fcoeSettings': {'fcoeMode': 'FcfNpv'},
             'uplinkSets': [uplink_sets['us33'].copy()],
             'stackingMode': 'Enclosure',
             'ethernetSettings': None,
             'state': 'Active',
             'telemetryConfiguration': None,
        ...
        'lig4':
            {'name': 'LIG-with-more-than-64-fcoe',
             ...
             'redundancyType': 'HighlyAvailable',
             'fcoeSettings': {'fcoeMode': 'FcfNpv'},
             'uplinkSets': [uplink_sets['us-32fcoe-a'].copy(), uplink_sets['us-32fcoe-b'].copy(),
        ...
        'lig6':
            {'name': 'LIG1',
             ...
             'redundancyType': 'HighlyAvailable',
             'fcoeSettings': {'fcoeMode': 'FcfNpv'},
             'uplinkSets': [uplink_sets['us1a'].copy(), uplink_sets['us2a'].copy(), uplink_sets['us3a'].copy(),
                        ...
                        'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
                                        ...
                                        {'id': 2, 'name': '2', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:1-b',
                                         ...
                                         'boot': {'priority': 'Primary', 'bootVolumeSource': 'UserDefined',
                                                  'targets': [{'arrayWwpn': '21110002AC003655', 'lun': '1'}]},
                                         'mac': None,
                                         'wwpn': '', 'wwnn': ''},
                                        ]}},
...
server_profiles2 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG',
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay1-BFS', 'description': 'Booted to W2012 LUN - Bside', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                     'connectionSettings': {
                         'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-a',
                                          'requestedMbps': '2500', 'networkUri': 'ETH:eth-102',
                                          'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                                         {'id': 2, 'name': '2', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:2-b',
                    ...
                    {'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 3',
                     'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC1, 'enclosureGroupUri': 'EG:EG',
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay3-BFS', 'description': 'Firebird! - esxi6 - Bside', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                     'connectionSettings': {
                         'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 6:2-a',
                                          'requestedMbps': '2500', 'networkUri': 'ETH:eth-102',
                                          'boot': {'priority': 'NotBootable'}, 'mac': None, 'wwpn': '', 'wwnn': ''},
                                         {'id': 2, 'name': '2', 'functionType': 'FibreChannel', 'portId': 'Mezz 6:2-b',
                                          'requestedMbps': '2500', 'networkUri': 'FCOE:fcoe-1003',
                                          'boot': {'priority': 'Primary', 'bootVolumeSource': 'UserDefined',
                                                   'targets': [{'arrayWwpn': '21110002AC003655', 'lun': '0'}]},
                                          'mac': None,
                    ...
                    {'type': 'ServerProfileV8', 'serverHardwareUri': ENC2 + ', bay 6',
                     ...
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC2 + '_Bay6-BFS', 'description': 'Redbird! - esxi6 - Bside', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                     'connectionSettings': {
                         'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-a',
