...
ranges = [{'name': 'FCOE-MAC', 'type': 'Range', 'category': 'id-range-VMAC', 'rangeCategory': 'CUSTOM',
           'startAddress': '00:BA:51:00:00:00', 'endAddress': '00:BA:51:00:00:7F', 'enabled': True},
          {'name': 'FCOE-WWN', 'type': 'Range', 'category': 'id-range-VWWN', 'rangeCategory': 'CUSTOM',
           'startAddress': '21:11:BA:51:00:00:00:00', 'endAddress': '21:11:BA:51:00:00:00:7F', 'enabled': True},
...
server_profiles = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                    ...
                    'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
                                     'requestedMbps': '2500', 'networkUri': 'ETH:eth-401',
                                    ...
                                    {'id': 2, 'name': '2', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:1-b',
                                     ...
                                     'boot': {'priority': 'Primary', 'bootVolumeSource': 'UserDefined',
                                              'targets': [{'arrayWwpn': '20110002AC012B0C', 'lun': '2'}]}, 'mac': None,
                                     'wwpn': '', 'wwnn': ''},
                                    ]},
                   {'type': 'ServerProfileV8', 'serverHardwareUri': ENC2 + ', bay 4',
                    'serverHardwareTypeUri': '', 'enclosureUri': 'ENC:' + ENC2, 'enclosureGroupUri': 'EG:%s' % EG2,
                    'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                    'name': ENC2 + '_Bay4-BFS', 'description': 'esxi 6 - Aside', 'affinity': 'Bay',
                    'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                    'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:1-a',
                                     'requestedMbps': '2500', 'networkUri': 'ETH:eth-401',
                                    ...
                                    {'id': 2, 'name': '2', 'functionType': 'FibreChannel', 'portId': 'Mezz 3:1-b',
                                     'requestedMbps': '2500', 'networkUri': 'FCOE:fcoe-1002',
                                     'boot': {'priority': 'Primary', 'bootVolumeSource': 'UserDefined',
                                              'targets': [{'arrayWwpn': '20110002AC012B0C', 'lun': '1'}]}, 'mac': None,
                                     'wwpn': '', 'wwnn': ''},
                                    ]},
                   ]
...
server_profiles2 = [{'type': 'ServerProfileV8', 'serverHardwareUri': ENC1 + ', bay 1',
                     ...
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC1 + '_Bay1-BFS', 'description': 'Booted to esxi6 LUN - Bside', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                    ...
                    {'type': 'ServerProfileV8', 'serverHardwareUri': ENC2 + ', bay 4',
                     ...
                     'serialNumberType': 'Physical', 'macType': 'Physical', 'wwnType': 'Physical',
                     'name': ENC2 + '_Bay4-BFS', 'description': 'esxi6 - Bside', 'affinity': 'Bay',
                     'bootMode': {'manageMode': True, 'mode': 'UEFI', 'pxeBootPolicy': 'Auto'},
                     'boot': {'manageBoot': True, 'order': ['HardDisk']},
                     'connections': [{'id': 1, 'name': '1', 'functionType': 'Ethernet', 'portId': 'Mezz 3:2-a',
                                      'requestedMbps': '2500', 'networkUri': 'ETH:eth-401',
