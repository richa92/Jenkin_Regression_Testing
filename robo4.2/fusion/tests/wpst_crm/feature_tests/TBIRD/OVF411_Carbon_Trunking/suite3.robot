...
| step2(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
...
| step3(TC#15): | [Documentation] | Create 2 ULS, with trunking enabled in ULS, ports 1-2 in TG1 and ports 3-4 in TG2 with tor configured with tg1, port1-4 
| | Create uls in LI | ${fcmodes[0]} |  ${US_details[0]['name']} | ${FC_uris[0]} | ${desiredSpeeds[0]} | ${US_details[0]['bay']} | ${ENC_0_uri} | ${US_details[0]['Act_ports'][0:2]} |
| | Sleep | 30s |
| | Create uls in LI | ${fcmodes[0]} |  ${US_details[1]['name']} | ${FC_uris[1]} | ${desiredSpeeds[0]} | ${US_details[1]['bay']} | ${ENC_0_uri} | ${US_details[1]['Act_ports'][2:4]} |
| | Sleep | 30s |
...
| | :FOR | ${port} | IN | @{US_details[1]['Act_ports'][2:4]} |
| | \ | ${portStatus} | ${trunkMaster} | ${enabled} | Get port details | ${Enclosure_Name[0]} | ${US_details[1]['bay']} | ${port} |
| | \ | Run Keyword Unless | '${portStatus}'=='Unlinked' | FAIL |


| step4(TC#16): | [Documentation] | Create 2 ULS with ports 1-2 in TG1 and ports 3-4 in TG2, and trunking enabled on TOR for TG1 and trunking disabled for TG2
...
| step5(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| step6(TC#17): | [Documentation] | Create 2 ULS with ports 1-2 in TG1(trunk enabled) and ports 3-4 in TG2(trunk disabled), in TOR HW trunk area 1 for TG1 and HW trunk area 2 for TG2 | 
| | Create uls in LI | ${fcmodes[0]} |  ${US_details[0]['name']} | ${FC_uris[0]} | ${desiredSpeeds[0]} | ${US_details[0]['bay']} | ${ENC_0_uri} | ${US_details[0]['Act_ports'][0:2]} |
| | Sleep | 30s |
| | Create uls in LI | ${fcmodes[1]} |  ${US_details[1]['name']} | ${FC_uris[1]} | ${desiredSpeeds[0]} | ${US_details[1]['bay']} | ${ENC_0_uri} | ${US_details[1]['Act_ports'][2:4]} |
| | Sleep | 30s |

| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment1'][0:2]} |
| | Sleep | 60s |

| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment2'][2:4]} |
| | Sleep | 60s |
...
| step7(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| step8(TC#18): | [Documentation] | Create 1 ULS with ports 1-4 with trunking enabled, and TOR create TG1 with port 1 and TG2 with port 2 

| | Create uls in LI | ${fcmodes[0]} |  ${US_details[0]['name']} | ${FC_uris[0]} | ${desiredSpeeds[0]} | ${US_details[1]['bay']} | ${ENC_0_uri} | ${US_details[1]['Act_ports']} |
| | Sleep | 30s |

| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment1'][0:1]} |
| | Sleep | 60s |
| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment2'][1:2]} |
| | Sleep | 60s |
...
| step9(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| step10(TC#19): | [Documentation] | Create 1 ULS, with trunking enabled in ULS, ports Q1:1-Q1:4 and configure 4 ports in HW TG2 
| | Create uls in LI | ${fcmodes[0]} |  ${US_details[0]['name']} | ${FC_uris[0]} | ${desiredSpeeds[0]} | ${US_details[2]['bay']} | ${ENC_0_uri} | ${US_details[2]['Act_ports'][0:4]} |
| | Sleep | 30s |
| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment2']} |
| | Sleep | 60s |
...
| step11(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| step12(TC#20): | [Documentation] | Create 1 ULS with ports 1-2 in TG1, with trunking enabled connected to ports 1-2 on TOR with trunking disabled in ports 1-4
...
| | Disable trunk ports in trunk group | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment1']} |
| | Sleep | 60s |
| | :FOR | ${port} | IN | @{US_details[0]['Act_ports'][0:2]} |
| | \ | ${portStatus} | ${trunkMaster} | ${enabled} | Get port details | ${Enclosure_Name[0]} | ${US_details[0]['bay']} | ${port} |
| | \ | Run Keyword Unless | '${portStatus}'=='Linked' | FAIL |
...
| step13(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| step14(TC#21): | [Documentation] | Create 1 ULS with ports 1-4 with trunking disabled, and TOR create TG1 with port 1-2. Verify on OV, ports 1&2 should be unlinked and ports 3&4 should be linked.
| | Create uls in LI | ${fcmodes[1]} |  ${US_details[0]['name']} | ${FC_uris[0]} | ${desiredSpeeds[0]} | ${US_details[0]['bay']} | ${ENC_0_uri} | ${US_details[0]['Act_ports'][0:4]} |
| | Sleep | 30s |
| | Create Trunk Group with ports | ${FC_switch_details} | ${Trunk_Commands} | ${FC_switch_ports['segment1'][0:2]} |
| | Sleep | 60s |
...
| step15(TC#cleanup): | [Documentation] | Deleting the ULS from LIG, LI and clearing the trunk group in switch | 
| | Clear ULS in LIG & LI | ${LIG_uri_list[0]} | ${LIG_name_list[0]} |
| | ${show_command_output} | Check For Trunk Group in Brocade | ${FC_switch_details} | ${Trunk_Commands} |
| | ${lines} | Get Lines Containing String | ${show_command_output} | ${no_trunk_message} |
| | ${line_count} | Get Line Count | ${lines} |
...
| | Sleep | 3s |
| | Close Connection |
| Disable trunk ports in trunk group | [Arguments] | ${FC_switch_details} | ${Trunk_Commands} | ${Ports_in_TG} |
| | [Documentation] | Disabling the trunk ports in  trunk group |
| | Open Connection | ${FC_switch_details['ip']} | 
| | Login | ${FC_switch_details['userName']} | ${FC_switch_details['password']} |
| | :FOR | ${y} | IN  | @{Ports_in_TG} |
| | \ | Execute Command | ${Trunk_Commands[3]} ${y} 0 |
