...
<#"rescan"|diskpart *> $null
Start-Sleep -s 5
$iSCSI = gwmi win32_diskdrive | where {$_.model -like "3PARdata*"}
...
<#
Mount D: Drive
$drive = gwmi Win32_Volume | where {$_.DeviceID -like "*0c44b2f5-9e8c-4f93-a70c-52f71b2889f9*"}
$drive.AddMountPoint("D:\")
$drive.DriveLetter = "D:"
$drive.Put_
$drive.Mount()
Start-Sleep -s 5
