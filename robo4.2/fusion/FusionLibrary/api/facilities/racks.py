...
class Rack(object):
    ...
    def create(self, body, api=None, headers=None):
        ...
        uri = 'https://%s/rest/racks' % (self.fusion_client._host)
    ...
    def delete(self, name=None, uri=None, api=None, headers=None):
        ...
        if uri:
            ...
            if response['count'] == 0:
                logger._log('Rack %s does not exist' % (name), level='WARN')
                return
            ...
            # deletes all racks
            uri = 'https://%s/rest/racks' % (self.fusion_client._host, uri)
    ...
    def get(self, uri=None, api=None, headers=None, param=''):
        ...
        if uri:
            ...
            uri = 'https://%s/rest/racks%s' % (self.fusion_client._host, param)
