...
This file contains all element ID on i3S login page/screen
'''


class i3SLoginPage(object):
    # Login Page
    ...
    ID_ELEMENT_AUTHN_PROVIDER = "xpath=//*[@id='hp-authn-provider-list-item']/div/a/span[2]"
    ID_COMBO_AUTHN_PROVIDER = "xpath=//*[@id='hp-authn-provider-list-item']"
    ID_ELEMENT_DIR = "xpath=//ul/li/a[text()='%s']"
