...
...              Workflows:
...              pybot -v fusion_api_resource:"../fusion/Resources/api/fusion_api_resource.txt" "..\i3s\tests\i3s\I3sFusionEnablement\prerequisites\i3s_prerequisites.txt"

Resource         ../resource.robot
Suite Setup      I3S Suite Setup
...
Add Golden Images
    ...
    \    ${Response}=    I3s Api Add Goldenimage    ${GI_PATH}    param=?name=${NAME}&description=${DESC}
...
Add Artifact Bundle
    ...
    #P0 - refers to the Priority of the test case. P0 is the highest priority.
...
Create OSBuildplan
    ...
    #extract the full names of the planscript from the partially specified names in the planscripts uri of build plans
    \    ${buildplan_req} =    Update Planscript Partial Names With Full Names    ${buildPlan}
    \    ${bp_body} =    Create Build Plan Payload    ${buildplan_req}
