...
ov_appliances = ['fe80::9eb6:54ff:fe98:8160']
i3s_appliances = ['fe80::9eb6:54ff:fe98:66c8' ]
enclosures_count = '1'
DEFAULT_USER = 'Administrator'
status = '200'
NEW_PASSWORD = 'admin123'
SUBNET_1 = '255.255.252.0'
IPV4GATEWAY = '15.212.168.1'
DOMAINNAME = 'hpecorp.net'
HOSTNAME = 'ci-9cb654988160'
DNS1 = '16.110.135.51'
DNS2 = '16.110.135.52'
MAC = '9c:b6:54:98:81:60'
MAINTENANCEIP1 = '15.212.171.197'
MAINTENANCEIP2 = '15.212.171.198'
CLUSTERIP = '15.212.171.196'
OV_ACTIVE = 'fe80::9eb6:54ff:fe98:8160'
Ov_Build_sha = 'HPEOneView-SSH-3.00.07-0285174_signed-withsig_PASS3.zip.sha256'
OV_Build = 'HPEOneView-SSH-3.00.07-0285174_signed-withsig_PASS3.zip'
OV_Build_unzipped = 'HPEOneView-SSH-3.00.07-0285174_signed'
I3S_Build_sha = 'HPEImageStreamer-SSH-3.00.05-0284004_signed-withsig.zip.sha256'
I3S_Build = 'HPEImageStreamer-SSH-3.00.05-0284004_signed-withsig.zip'
I3S_Build_unzipped = 'HPEImageStreamer-SSH-3.00.05-0284004_signed'
build_server = '15.212.171.89'
...
ipv4ranges = [{'type': 'Range',
               ...
               'subnetUri': ' '},              
              {'type': 'Range',
               'startAddress': '15.212.171.141',
               'endAddress': '15.212.171.146',
               'name': 'mgmt_nw',
               'subnetUri': ' '}
              ]
...
'networkType':'Ethernet','ethernetNetworkType':'Tagged','name':'uplink_set'}
]
}
...
'applianceUri':'MXQ64801LT, appliance 2',
...
artifactbundle_add = {
        'name':'c:/Users/Administrator/GoldenImage_download/esxiABMinAug31.zip'
}
...
'serverHardwareUri' : 'MXQ64801LT, bay 2',
'serverHardwareTypeUri' : 'SY 480 Gen9 1',
'enclosureGroupUri': 'EG-1enc',
'enclosureUri':'MXQ64801LT',
'affinity':'Bay',
...
BLADES = {'Blade1'    :    'MXQ64801LT, bay 2'}