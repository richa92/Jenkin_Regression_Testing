''' Data variable file of 164.70 '''
# pylint: disable=invalid-name
# from winnt import NULL
# from requests.api import patch

admin_credentials = {'userName': 'Administrator', 'password': 'admin123'}
ov_appliances = ['fe80::32e1:71ff:fe68:ba78', 'fe80::1602:ecff:fe45:afb8']
MAC = "30:e1:71:68:ba:78"
i3s_appliances = [
    'fe80::1602:ecff:fe46:b1f0',
    'fe80::1602:ecff:fe45:1de8',
    'fe80::9eb6:54ff:fe98:67d0',
    'fe80::1602:ecff:fe46:12a0']
i3s_enclosure = ['MXQ646057N', 'MXQ646057L', 'MXQ646057K', 'MXQ646057D']
enclosures_count = '6'
...
# DNS1 = '16.110.135.51'
# DNS2 = '16.110.135.52'
# MAINTENANCEIP1 = '15.212.164.71'
# MAINTENANCEIP2 = '15.212.164.72'
CLUSTERIP = '15.212.164.70'
OV_ACTIVE = 'fe80::32e1:71ff:fe68:ba78'
# Ov_Build_sha = '/ov/5.00/ddimage/HPEOneView-Composer-SSH-5.00.00-0382153.zip.sha256'
# OV_Build = '/ov/5.00/ddimage/HPEOneView-Composer-SSH-5.00.00-0382153.zip'
# I3S_Build_sha = '/i3s/5.00/ddimage/HPEImageStreamer-SSH-5.00.00-0381654-withsig.zip.sha256'
# I3S_Build = '/i3s/5.00/ddimage/HPEImageStreamer-SSH-5.00.00-0381654-withsig.zip'
...
fusion_IP = '15.212.164.70'

network = {"type": "ApplianceNetworkConfiguration",
           "applianceNetworks": [{"activeNode": 1,
                                  "unconfigure": False,
                                  "app1Ipv4Addr": "15.212.164.71", "app1Ipv6Addr": "",
                                  "app2Ipv4Addr": "15.212.164.72", "app2Ipv6Addr": "",
                                  "virtIpv4Addr": "15.212.164.70", "virtIpv6Addr": None,
...
mgmt_ipv4ranges = {'type': 'Range', 'networkId': '15.212.164.0',
                   'startAddress': '15.212.164.73', 'endAddress': '15.212.164.101',
...
les_3enc1 = {'name': 'LE-3encprimay',
             'enclosureUris': ['ENC:MXQ646057F', 'ENC:MXQ646057L', 'ENC:MXQ646057N'],
             'enclosureGroupUri': 'EG:EG-3encprimay', 'firmwareBaselineUri': None,
             'forceInstallFirmware': False}
les_3enc2 = {'name': 'LE-3encsecondary',
             'enclosureUris': ['ENC:MXQ646057H', 'ENC:MXQ646057K', 'MXQ646057D'],
...
osdeploymentserver = {'name': 'OSDS-3enc', 'description': 'os deployment server',
                      'applianceUri': 'MXQ646057N, appliance 1', 'mgmtNetworkUri': ['mgmt_nw'],
