...
ov_appliances = ['fe80::1602:ecff:fe46:e4b0', 'fe80::32e1:71ff:fe68:2b40']
MAC = '14:02:ec:46:e4:b0'
i3s_appliances = ['fe80::9eb6:54ff:fe98:d2a8', 'fe80::1602:ecff:fe46:d768']
...
OV_ACTIVE = 'fe80::1602:ecff:fe46:e4b0'
# Ov_Build_sha = '/ov/5.00/ddimage/HPEOneView-Composer-SSH-5.00.00-0381787_PASS61.zip.sha256'
# OV_Build = '/ov/5.00/ddimage/HPEOneView-Composer-SSH-5.00.00-0381787_PASS61.zip'
# I3S_Build_sha = '/i3s/5.00/ddimage/HPEImageStreamer-SSH-5.00.00-0382017-withsig_PASS6.zip.sha256'
# I3S_Build = '/i3s/5.00/ddimage/HPEImageStreamer-SSH-5.00.00-0382017-withsig_PASS6.zip'
...
network = {"type": "ApplianceNetworkConfiguration",
           "applianceNetworks": [{"activeNode": 1,
                                  "unconfigure": False,
                                  "app1Ipv4Addr": "15.212.164.151", "app1Ipv6Addr": "",
                                  "app2Ipv4Addr": "15.212.164.152", "app2Ipv6Addr": "",
                                  "virtIpv4Addr": "15.212.164.150", "virtIpv6Addr": None,
                                  "app1Ipv4Alias": None, "app1Ipv6Alias": None,
                                  "app2Ipv4Alias": None, "app2Ipv6Alias": None,
                                  "hostname": "EB2405.test.local",
                                  "confOneNode": True, "interfaceName": "",
                                  "macAddress": "14:02:ec:46:e4:b0",
...
iscsi_ipv4ranges = {'type': 'Range', 'networkId': '192.168.0.0',
                    'startAddress': '192.168.20.10', 'endAddress': '192.168.30.254',
                    'name': 'iscsi_nw', 'subnetUri': ' '}

mgmt_ipv4ranges = {'type': 'Range', 'networkId': '15.212.164.0',
                   'startAddress': '15.212.164.153', 'endAddress': '15.212.164.165',
...
les_3enc = {'name': 'LE-3enc',
            'enclosureUris': ['ENC:SGH708YL3D', 'ENC:SGH708YL3J', 'ENC:SGH724SLP0', ],
...
osdeploymentserver = {'name': 'OSDS-3enc', 'description': 'os deployment server',
                      'applianceUri': 'SGH708YL3J, appliance 1', 'mgmtNetworkUri': ['mgmt_nw'],
