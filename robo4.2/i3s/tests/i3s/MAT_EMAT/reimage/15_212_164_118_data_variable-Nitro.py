''' Data variable file of 164.118 with nitro '''
...
lig_tbird_3enc = {'type': 'logical-interconnect-groupV4',
                  ...
                  'interconnectMapTemplate': [{'bay': 3, 'enclosure': 1, 'type': 'Virtual Connect SE 100Gb F32 Module for Synergy', 'enclosureIndex': 1},
                                              ...
                                              {'bay': 6, 'enclosure': 1, 'type': 'HPE Synergy 50Gb Satellite Link Module', 'enclosureIndex': 1},
                                              {'bay': 3, 'enclosure': 2, 'type': 'HPE Synergy 50Gb Satellite Link Module', 'enclosureIndex': 2},
                                              {'bay': 6, 'enclosure': 3, 'type': 'HPE Synergy 50Gb Satellite Link Module', 'enclosureIndex': 3},
                                              {'bay': 3, 'enclosure': 3, 'type': 'HPE Synergy 50Gb Satellite Link Module', 'enclosureIndex': 3}],
